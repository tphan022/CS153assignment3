...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
   ...
   f:	c7 44 24 04 3d 09 00 	movl   $0x93d,0x4(%esp)
  16:	00 
  ...
  5a:	c7 44 24 04 51 09 00 	movl   $0x951,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3fa:	0f b6 80 0c 0a 00 00 	movzbl 0xa0c(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 558:	75 27                	jne    581 <printf+0x120>
          s = "(null)";
 55a:	c7 45 e4 6a 09 00 00 	movl   $0x96a,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 627:	a1 28 0a 00 00       	mov    0xa28,%eax
...
free(void *ap)
{
 ...
 6e8:	a3 28 0a 00 00       	mov    %eax,0xa28
}
 6ed:	c9                   	leave  
 6ee:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 73b:	e8 d8 fe ff ff       	call   618 <free>
  return freep;
 740:	a1 28 0a 00 00       	mov    0xa28,%eax
}
 745:	c9                   	leave  
 746:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 759:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 75c:	a1 28 0a 00 00       	mov    0xa28,%eax
 761:	89 45 f0             	mov    %eax,-0x10(%ebp)
 764:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 768:	75 23                	jne    78d <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 76a:	c7 45 f0 20 0a 00 00 	movl   $0xa20,-0x10(%ebp)
 771:	8b 45 f0             	mov    -0x10(%ebp),%eax
 774:	a3 28 0a 00 00       	mov    %eax,0xa28
 779:	a1 28 0a 00 00       	mov    0xa28,%eax
 77e:	a3 20 0a 00 00       	mov    %eax,0xa20
    base.s.size = 0;
 783:	c7 05 24 0a 00 00 00 	movl   $0x0,0xa24
 78a:	00 00 00 
  }
 ...
 7e0:	a3 28 0a 00 00       	mov    %eax,0xa28
      return (void*)(p + 1);
 ...
 7eb:	eb 38                	jmp    825 <malloc+0xde>
    ...
    if(p == freep)
 7ed:	a1 28 0a 00 00       	mov    0xa28,%eax
...
void create_queue(struct queue* qu) {
 ...
 82e:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
  qu->bot = 0;
 835:	8b 45 08             	mov    0x8(%ebp),%eax
 838:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
  qu->sz = 0;
 83f:	8b 45 08             	mov    0x8(%ebp),%eax
 842:	c7 00 00 00 00 00    	movl   $0x0,(%eax)

}
 848:	5d                   	pop    %ebp
 849:	c3                   	ret    

0000084a <addto_queue>:
...
void addto_queue(int num, struct queue* qu) {
 ...
 850:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
 857:	e8 eb fe ff ff       	call   747 <malloc>
...
int popoff_queue(struct queue* qu) {
 ...
 8b6:	e8 68 00 00 00       	call   923 <is_empty>
 8bb:	85 c0                	test   %eax,%eax
 8bd:	75 5d                	jne    91c <popoff_queue+0x72>
    temp = qu->top->number;
 ...
 8f5:	e8 1e fd ff ff       	call   618 <free>
    if(qu->sz == 0) {
 8fa:	8b 45 08             	mov    0x8(%ebp),%eax
 8fd:	8b 00                	mov    (%eax),%eax
 8ff:	85 c0                	test   %eax,%eax
 901:	75 14                	jne    917 <popoff_queue+0x6d>
      qu->bot = 0;
 903:	8b 45 08             	mov    0x8(%ebp),%eax
 906:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
      qu->top = 0;
 90d:	8b 45 08             	mov    0x8(%ebp),%eax
 910:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    }
    return temp;
 917:	8b 45 f4             	mov    -0xc(%ebp),%eax
 91a:	eb 05                	jmp    921 <popoff_queue+0x77>
  }
  return -1;
 91c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 921:	c9                   	leave  
 922:	c3                   	ret    
...
int is_empty(struct queue* qu) {
 ...
 92d:	74 07                	je     936 <is_empty+0x13>
    return 0;
 92f:	b8 00 00 00 00       	mov    $0x0,%eax
 934:	eb 05                	jmp    93b <is_empty+0x18>
  }
  else {
    return 1;
 936:	b8 01 00 00 00       	mov    $0x1,%eax
  }
}
 93b:	5d                   	pop    %ebp
 93c:	c3                   	ret    
