...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
   ...
   f:	c7 44 24 04 aa 08 00 	movl   $0x8aa,0x4(%esp)
  16:	00 
  ...
  5a:	c7 44 24 04 be 08 00 	movl   $0x8be,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3fa:	0f b6 80 e0 08 00 00 	movzbl 0x8e0(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 558:	75 27                	jne    581 <printf+0x120>
          s = "(null)";
 55a:	c7 45 e4 d7 08 00 00 	movl   $0x8d7,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 627:	a1 fc 08 00 00       	mov    0x8fc,%eax
...
free(void *ap)
{
 ...
 6e8:	a3 fc 08 00 00       	mov    %eax,0x8fc
}
 6ed:	c9                   	leave  
 6ee:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 73b:	e8 d8 fe ff ff       	call   618 <free>
  return freep;
 740:	a1 fc 08 00 00       	mov    0x8fc,%eax
}
 745:	c9                   	leave  
 746:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 759:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 75c:	a1 fc 08 00 00       	mov    0x8fc,%eax
 761:	89 45 f0             	mov    %eax,-0x10(%ebp)
 764:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 768:	75 23                	jne    78d <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 76a:	c7 45 f0 f4 08 00 00 	movl   $0x8f4,-0x10(%ebp)
 771:	8b 45 f0             	mov    -0x10(%ebp),%eax
 774:	a3 fc 08 00 00       	mov    %eax,0x8fc
 779:	a1 fc 08 00 00       	mov    0x8fc,%eax
 77e:	a3 f4 08 00 00       	mov    %eax,0x8f4
    base.s.size = 0;
 783:	c7 05 f8 08 00 00 00 	movl   $0x0,0x8f8
 78a:	00 00 00 
  }
 ...
 7e0:	a3 fc 08 00 00       	mov    %eax,0x8fc
      return (void*)(p + 1);
 ...
 7eb:	eb 38                	jmp    825 <malloc+0xde>
    ...
    if(p == freep)
 7ed:	a1 fc 08 00 00       	mov    0x8fc,%eax
