...
void create_queue(struct queue* qu) {
 ...
 818:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
  qu->sz = 0;
 81f:	8b 45 08             	mov    0x8(%ebp),%eax
 822:	c7 00 00 00 00 00    	movl   $0x0,(%eax)

}
 828:	5d                   	pop    %ebp
 829:	c3                   	ret    

0000082a <addto_queue>:
...
void addto_queue(int num, struct queue* qu) {
 ...
 830:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
 837:	e8 eb fe ff ff       	call   727 <malloc>
 ...
 882:	8b 55 f4             	mov    -0xc(%ebp),%edx
 885:	89 50 08             	mov    %edx,0x8(%eax)
