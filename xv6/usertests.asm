...
void create_queue(struct queue* qu) {
    415c:	55                   	push   %ebp
    415d:	89 e5                	mov    %esp,%ebp
  qu->top = 0;
    415f:	8b 45 08             	mov    0x8(%ebp),%eax
    4162:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
  qu->bot = 0;
    4169:	8b 45 08             	mov    0x8(%ebp),%eax
    416c:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
  qu->sz = 0;
    4173:	8b 45 08             	mov    0x8(%ebp),%eax
    4176:	c7 00 00 00 00 00    	movl   $0x0,(%eax)

}
    417c:	5d                   	pop    %ebp
    417d:	c3                   	ret    

0000417e <addto_queue>:

void addto_queue(int num, struct queue* qu) {
    417e:	55                   	push   %ebp
    417f:	89 e5                	mov    %esp,%ebp
    4181:	83 ec 28             	sub    $0x28,%esp
  struct node* temp = malloc(sizeof(struct node));
    4184:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
    418b:	e8 eb fe ff ff       	call   407b <malloc>
    4190:	89 45 f4             	mov    %eax,-0xc(%ebp)

  temp->number = num;
    4193:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4196:	8b 55 08             	mov    0x8(%ebp),%edx
    4199:	89 10                	mov    %edx,(%eax)
  temp->next = 0;
    419b:	8b 45 f4             	mov    -0xc(%ebp),%eax
    419e:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
  
  if(qu->top != 0) {
    41a5:	8b 45 0c             	mov    0xc(%ebp),%eax
    41a8:	8b 40 04             	mov    0x4(%eax),%eax
    41ab:	85 c0                	test   %eax,%eax
    41ad:	74 0e                	je     41bd <addto_queue+0x3f>
    qu->bot->next = temp;
    41af:	8b 45 0c             	mov    0xc(%ebp),%eax
    41b2:	8b 40 08             	mov    0x8(%eax),%eax
    41b5:	8b 55 f4             	mov    -0xc(%ebp),%edx
    41b8:	89 50 04             	mov    %edx,0x4(%eax)
    41bb:	eb 09                	jmp    41c6 <addto_queue+0x48>
  }
  else {
    qu->top = temp;
    41bd:	8b 45 0c             	mov    0xc(%ebp),%eax
    41c0:	8b 55 f4             	mov    -0xc(%ebp),%edx
    41c3:	89 50 04             	mov    %edx,0x4(%eax)
  }
  
  qu->sz = qu->sz + 1;
    41c6:	8b 45 0c             	mov    0xc(%ebp),%eax
    41c9:	8b 00                	mov    (%eax),%eax
    41cb:	8d 50 01             	lea    0x1(%eax),%edx
    41ce:	8b 45 0c             	mov    0xc(%ebp),%eax
    41d1:	89 10                	mov    %edx,(%eax)
  qu->bot = temp;
    41d3:	8b 45 0c             	mov    0xc(%ebp),%eax
    41d6:	8b 55 f4             	mov    -0xc(%ebp),%edx
    41d9:	89 50 08             	mov    %edx,0x8(%eax)
