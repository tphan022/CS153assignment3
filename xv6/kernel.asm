...
8010003a:	c7 44 24 04 58 80 10 	movl   $0x80108058,0x4(%esp)
80100041:	80 
80100042:	c7 04 24 60 c6 10 80 	movl   $0x8010c660,(%esp)
80100049:	e8 40 4a 00 00       	call   80104a8e <initlock>
...
801000be:	e8 ec 49 00 00       	call   80104aaf <acquire>
...
80100105:	e8 06 4a 00 00       	call   80104b10 <release>
        return b;
...
80100120:	e8 b8 46 00 00       	call   801047dd <sleep>
      goto loop;
...
8010017d:	e8 8e 49 00 00       	call   80104b10 <release>
      return b;
...
80100199:	c7 04 24 5f 80 10 80 	movl   $0x8010805f,(%esp)
...
801001ee:	75 0c                	jne    801001fc <bwrite+0x1e>
    panic("bwrite");
801001f0:	c7 04 24 70 80 10 80 	movl   $0x80108070,(%esp)
...
80100228:	75 0c                	jne    80100236 <brelse+0x1e>
    panic("brelse");
8010022a:	c7 04 24 77 80 10 80 	movl   $0x80108077,(%esp)
80100231:	e8 04 03 00 00       	call   8010053a <panic>

  acquire(&bcache.lock);
80100236:	c7 04 24 60 c6 10 80 	movl   $0x8010c660,(%esp)
8010023d:	e8 6d 48 00 00       	call   80104aaf <acquire>
...
8010029e:	e8 14 46 00 00       	call   801048b7 <wakeup>

  release(&bcache.lock);
801002a3:	c7 04 24 60 c6 10 80 	movl   $0x8010c660,(%esp)
801002aa:	e8 61 48 00 00       	call   80104b10 <release>
}
801002af:	c9                   	leave  
801002b0:	c3                   	ret    
...
801003b5:	e8 f5 46 00 00       	call   80104aaf <acquire>
...
801003bf:	75 0c                	jne    801003cd <cprintf+0x33>
    panic("null fmt");
801003c1:	c7 04 24 7e 80 10 80 	movl   $0x8010807e,(%esp)
...
801004aa:	74 20                	je     801004cc <cprintf+0x132>
        s = "(null)";
801004ac:	c7 45 f4 87 80 10 80 	movl   $0x80108087,-0xc(%ebp)
      for(; *s; s++)
...
80100533:	e8 d8 45 00 00       	call   80104b10 <release>
}
80100538:	c9                   	leave  
80100539:	c3                   	ret    
...
8010055f:	c7 04 24 8e 80 10 80 	movl   $0x8010808e,(%esp)
...
80100571:	e8 24 fe ff ff       	call   8010039a <cprintf>
  cprintf("\n");
80100576:	c7 04 24 9d 80 10 80 	movl   $0x8010809d,(%esp)
...
8010058f:	e8 cb 45 00 00       	call   80104b5f <getcallerpcs>
  for(i=0; i<10; i++)
...
801005a8:	c7 04 24 9f 80 10 80 	movl   $0x8010809f,(%esp)
...
801006b0:	e8 1c 47 00 00       	call   80104dd1 <memmove>
    pos -= 80;
...
801006df:	e8 1a 46 00 00       	call   80104cfe <memset>
  }
...
801007b8:	e8 f2 42 00 00       	call   80104aaf <acquire>
  while((c = getc()) >= 0){
...
801007e3:	e9 85 00 00 00       	jmp    8010086d <consoleintr+0xc2>
    case C('P'):  // Process listing.
      procdump();
801007e8:	e8 6e 41 00 00       	call   8010495b <procdump>
      break;
...
801008f5:	e8 bd 3f 00 00       	call   801048b7 <wakeup>
...
80100919:	e8 f2 41 00 00       	call   80104b10 <release>
}
8010091e:	c9                   	leave  
8010091f:	c3                   	ret    
...
8010093e:	e8 6c 41 00 00       	call   80104aaf <acquire>
  while(n > 0){
...
8010095c:	e8 af 41 00 00       	call   80104b10 <release>
        ilock(ip);
...
80100985:	e8 53 3e 00 00       	call   801047dd <sleep>
...
80100a03:	e8 08 41 00 00       	call   80104b10 <release>
  ilock(ip);
...
80100a39:	e8 71 40 00 00       	call   80104aaf <acquire>
  for(i = 0; i < n; i++)
...
80100a73:	e8 98 40 00 00       	call   80104b10 <release>
  ilock(ip);
...
80100a8e:	c7 44 24 04 a3 80 10 	movl   $0x801080a3,0x4(%esp)
80100a95:	80 
80100a96:	c7 04 24 c0 b5 10 80 	movl   $0x8010b5c0,(%esp)
80100a9d:	e8 ec 3f 00 00       	call   80104a8e <initlock>
  initlock(&input.lock, "input");
80100aa2:	c7 44 24 04 ab 80 10 	movl   $0x801080ab,0x4(%esp)
80100aa9:	80 
80100aaa:	c7 04 24 a0 dd 10 80 	movl   $0x8010dda0,(%esp)
80100ab1:	e8 d8 3f 00 00       	call   80104a8e <initlock>
...
80100b6a:	0f 85 44 03 00 00    	jne    80100eb4 <exec+0x3bc>
  ...
  if((pgdir = setupkvm()) == 0)
80100b70:	e8 78 6c 00 00       	call   801077ed <setupkvm>
...
80100c0e:	e8 ae 6f 00 00       	call   80107bc1 <allocuvm>
...
80100c4b:	e8 81 6e 00 00       	call   80107ad1 <loaduvm>
...
80100cb6:	e8 06 6f 00 00       	call   80107bc1 <allocuvm>
...
80100cda:	e8 06 71 00 00       	call   80107de5 <clearpteu>
  sp = sz;
...
80100d09:	e8 71 42 00 00       	call   80104f7f <strlen>
...
80100d27:	e8 53 42 00 00       	call   80104f7f <strlen>
...
80100d51:	e8 54 72 00 00       	call   80107faa <copyout>
...
80100df1:	e8 b4 71 00 00       	call   80107faa <copyout>
...
80100e48:	e8 e4 40 00 00       	call   80104f31 <safestrcpy>
...
80100e9a:	e8 40 6a 00 00       	call   801078df <switchuvm>
  freevm(oldpgdir);
80100e9f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80100ea2:	89 04 24             	mov    %eax,(%esp)
80100ea5:	e8 ad 6e 00 00       	call   80107d57 <freevm>
  return 0;
...
80100edc:	e8 76 6e 00 00       	call   80107d57 <freevm>
  if(ip)
...
80100f02:	c7 44 24 04 b1 80 10 	movl   $0x801080b1,0x4(%esp)
80100f09:	80 
80100f0a:	c7 04 24 60 de 10 80 	movl   $0x8010de60,(%esp)
80100f11:	e8 78 3b 00 00       	call   80104a8e <initlock>
}
80100f16:	c9                   	leave  
80100f17:	c3                   	ret    
...
80100f25:	e8 85 3b 00 00       	call   80104aaf <acquire>
...
80100f4e:	e8 bd 3b 00 00       	call   80104b10 <release>
      return f;
...
80100f6d:	e8 9e 3b 00 00       	call   80104b10 <release>
  return 0;
...
80100f86:	e8 24 3b 00 00       	call   80104aaf <acquire>
  if(f->ref < 1)
...
80100f93:	7f 0c                	jg     80100fa1 <filedup+0x28>
    panic("filedup");
80100f95:	c7 04 24 b8 80 10 80 	movl   $0x801080b8,(%esp)
...
80100fb7:	e8 54 3b 00 00       	call   80104b10 <release>
  return f;
...
80100fce:	e8 dc 3a 00 00       	call   80104aaf <acquire>
  if(f->ref < 1)
...
80100fdb:	7f 0c                	jg     80100fe9 <fileclose+0x28>
    panic("fileclose");
80100fdd:	c7 04 24 c0 80 10 80 	movl   $0x801080c0,(%esp)
...
80101009:	e8 02 3b 00 00       	call   80104b10 <release>
    return;
...
80101053:	e8 b8 3a 00 00       	call   80104b10 <release>
...
80101192:	eb 0c                	jmp    801011a0 <fileread+0xba>
  ...
  panic("fileread");
80101194:	c7 04 24 ca 80 10 80 	movl   $0x801080ca,(%esp)
...
801012a0:	c7 04 24 d3 80 10 80 	movl   $0x801080d3,(%esp)
...
801012d3:	eb 0c                	jmp    801012e1 <filewrite+0x13f>
  ...
  panic("filewrite");
801012d5:	c7 04 24 e3 80 10 80 	movl   $0x801080e3,(%esp)
...
8010131c:	e8 b0 3a 00 00       	call   80104dd1 <memmove>
  brelse(bp);
...
80101362:	e8 97 39 00 00       	call   80104cfe <memset>
  log_write(bp);
...
801014c8:	0f 82 dd fe ff ff    	jb     801013ab <balloc+0x2c>
  ...
  panic("balloc: out of blocks");
801014ce:	c7 04 24 ed 80 10 80 	movl   $0x801080ed,(%esp)
...
80101566:	c7 04 24 03 81 10 80 	movl   $0x80108103,(%esp)
...
801015bc:	c7 44 24 04 16 81 10 	movl   $0x80108116,0x4(%esp)
801015c3:	80 
801015c4:	c7 04 24 60 e8 10 80 	movl   $0x8010e860,(%esp)
801015cb:	e8 be 34 00 00       	call   80104a8e <initlock>
}
801015d0:	c9                   	leave  
801015d1:	c3                   	ret    
...
8010164d:	e8 ac 36 00 00       	call   80104cfe <memset>
      dip->type = type;
...
8010169d:	0f 82 5a ff ff ff    	jb     801015fd <ialloc+0x2b>
  ...
  panic("ialloc: no inodes");
801016a3:	c7 04 24 1d 81 10 80 	movl   $0x8010811d,(%esp)
...
8010174d:	e8 7f 36 00 00       	call   80104dd1 <memmove>
  log_write(bp);
...
80101777:	e8 33 33 00 00       	call   80104aaf <acquire>
...
801017c1:	e8 4a 33 00 00       	call   80104b10 <release>
      return ip;
...
801017f5:	c7 04 24 2f 81 10 80 	movl   $0x8010812f,(%esp)
...
80101833:	e8 d8 32 00 00       	call   80104b10 <release>
...
8010184a:	e8 60 32 00 00       	call   80104aaf <acquire>
  ip->ref++;
...
80101865:	e8 a6 32 00 00       	call   80104b10 <release>
  return ip;
...
80101883:	7f 0c                	jg     80101891 <ilock+0x22>
    panic("ilock");
80101885:	c7 04 24 3f 81 10 80 	movl   $0x8010813f,(%esp)
8010188c:	e8 a9 ec ff ff       	call   8010053a <panic>

  acquire(&icache.lock);
80101891:	c7 04 24 60 e8 10 80 	movl   $0x8010e860,(%esp)
80101898:	e8 12 32 00 00       	call   80104aaf <acquire>
...
801018ad:	e8 2b 2f 00 00       	call   801047dd <sleep>
...
801018d7:	e8 34 32 00 00       	call   80104b10 <release>
...
80101985:	e8 47 34 00 00       	call   80104dd1 <memmove>
    brelse(bp);
...
801019b0:	75 0c                	jne    801019be <ilock+0x14f>
      panic("ilock: no type");
801019b2:	c7 04 24 45 81 10 80 	movl   $0x80108145,(%esp)
...
801019e1:	7f 0c                	jg     801019ef <iunlock+0x2f>
    panic("iunlock");
801019e3:	c7 04 24 54 81 10 80 	movl   $0x80108154,(%esp)
801019ea:	e8 4b eb ff ff       	call   8010053a <panic>

  acquire(&icache.lock);
801019ef:	c7 04 24 60 e8 10 80 	movl   $0x8010e860,(%esp)
801019f6:	e8 b4 30 00 00       	call   80104aaf <acquire>
  ip->flags &= ~I_BUSY;
...
80101a12:	e8 a0 2e 00 00       	call   801048b7 <wakeup>
  release(&icache.lock);
80101a17:	c7 04 24 60 e8 10 80 	movl   $0x8010e860,(%esp)
80101a1e:	e8 ed 30 00 00       	call   80104b10 <release>
}
80101a23:	c9                   	leave  
80101a24:	c3                   	ret    
...
80101a32:	e8 78 30 00 00       	call   80104aaf <acquire>
...
80101a6e:	74 0c                	je     80101a7c <iput+0x57>
      panic("iput busy");
80101a70:	c7 04 24 5c 81 10 80 	movl   $0x8010815c,(%esp)
...
80101a94:	e8 77 30 00 00       	call   80104b10 <release>
    itrunc(ip);
...
80101abf:	e8 eb 2f 00 00       	call   80104aaf <acquire>
    ip->flags = 0;
...
80101ad4:	e8 de 2d 00 00       	call   801048b7 <wakeup>
  }
  ip->ref--;
...
80101aef:	e8 1c 30 00 00       	call   80104b10 <release>
}
80101af4:	c9                   	leave  
80101af5:	c3                   	ret    
...
80101c04:	c7 04 24 66 81 10 80 	movl   $0x80108166,(%esp)
...
80101e9d:	e8 2f 2f 00 00       	call   80104dd1 <memmove>
    brelse(bp);
...
80102005:	e8 c7 2d 00 00       	call   80104dd1 <memmove>
    log_write(bp);
...
80102087:	e8 ed 2d 00 00       	call   80104e79 <strncmp>
}
8010208c:	c9                   	leave  
8010208d:	c3                   	ret    
...
801020a1:	c7 04 24 79 81 10 80 	movl   $0x80108179,(%esp)
...
801020dd:	74 0c                	je     801020eb <dirlookup+0x5d>
      panic("dirlink read");
801020df:	c7 04 24 8b 81 10 80 	movl   $0x8010818b,(%esp)
...
801021c1:	74 0c                	je     801021cf <dirlink+0x79>
      panic("dirlink read");
801021c3:	c7 04 24 8b 81 10 80 	movl   $0x8010818b,(%esp)
...
80102209:	e8 c3 2c 00 00       	call   80104ed1 <strncpy>
  de.inum = inum;
...
80102239:	74 0c                	je     80102247 <dirlink+0xf1>
    panic("dirlink");
8010223b:	c7 04 24 98 81 10 80 	movl   $0x80108198,(%esp)
...
801022c2:	e8 0a 2b 00 00       	call   80104dd1 <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
801022dd:	e8 ef 2a 00 00       	call   80104dd1 <memmove>
    name[len] = 0;
...
8010252a:	c7 44 24 04 a0 81 10 	movl   $0x801081a0,0x4(%esp)
80102531:	80 
80102532:	c7 04 24 00 b6 10 80 	movl   $0x8010b600,(%esp)
80102539:	e8 50 25 00 00       	call   80104a8e <initlock>
  picenable(IRQ_IDE);
...
801025d4:	75 0c                	jne    801025e2 <idestart+0x18>
    panic("idestart");
801025d6:	c7 04 24 a4 81 10 80 	movl   $0x801081a4,(%esp)
...
801026fc:	e8 ae 23 00 00       	call   80104aaf <acquire>
  if((b = idequeue) == 0){
...
80102716:	e8 f5 23 00 00       	call   80104b10 <release>
...
80102789:	e8 29 21 00 00       	call   801048b7 <wakeup>
...
801027ab:	e8 60 23 00 00       	call   80104b10 <release>
}
801027b0:	c9                   	leave  
801027b1:	c3                   	ret    
...
801027c4:	c7 04 24 ad 81 10 80 	movl   $0x801081ad,(%esp)
...
801027dd:	c7 04 24 c1 81 10 80 	movl   $0x801081c1,(%esp)
...
80102868:	e8 70 1f 00 00       	call   801047dd <sleep>
...
80102884:	e8 87 22 00 00       	call   80104b10 <release>
}
80102889:	c9                   	leave  
8010288a:	c3                   	ret    
	...
...
80102912:	c7 04 24 f4 81 10 80 	movl   $0x801081f4,(%esp)
...
801029d3:	c7 44 24 04 26 82 10 	movl   $0x80108226,0x4(%esp)
801029da:	80 
801029db:	c7 04 24 40 f8 10 80 	movl   $0x8010f840,(%esp)
801029e2:	e8 a7 20 00 00       	call   80104a8e <initlock>
  kmem.use_lock = 0;
...
80102a77:	81 7d 08 fc 26 11 80 	cmpl   $0x801126fc,0x8(%ebp)
...
80102a90:	76 0c                	jbe    80102a9e <kfree+0x39>
    panic("kfree");
80102a92:	c7 04 24 2b 82 10 80 	movl   $0x8010822b,(%esp)
...
80102ab4:	e8 45 22 00 00       	call   80104cfe <memset>
...
80102ac9:	e8 e1 1f 00 00       	call   80104aaf <acquire>
  r = (struct run*)v;
...
80102af7:	e8 14 20 00 00       	call   80104b10 <release>
}
80102afc:	c9                   	leave  
80102afd:	c3                   	ret    
...
80102b14:	e8 96 1f 00 00       	call   80104aaf <acquire>
  r = kmem.freelist;
...
80102b41:	e8 ca 1f 00 00       	call   80104b10 <release>
  return (char*)r;
...
80102ea9:	c7 04 24 34 82 10 80 	movl   $0x80108234,(%esp)
...
80102fff:	c7 44 24 04 60 82 10 	movl   $0x80108260,0x4(%esp)
80103006:	80 
80103007:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
8010300e:	e8 7b 1a 00 00       	call   80104a8e <initlock>
  readsb(ROOTDEV, &sb);
...
801030c1:	e8 0b 1d 00 00       	call   80104dd1 <memmove>
...
80103213:	e8 97 18 00 00       	call   80104aaf <acquire>
  while (log.busy) {
...
80103229:	e8 af 15 00 00       	call   801047dd <sleep>
...
80103248:	e8 c3 18 00 00       	call   80104b10 <release>
}
8010324d:	c9                   	leave  
8010324e:	c3                   	ret    
...
801032c9:	c7 04 24 64 82 10 80 	movl   $0x80108264,(%esp)
...
801032de:	c7 04 24 7a 82 10 80 	movl   $0x8010827a,(%esp)
...
8010336d:	e8 5f 1a 00 00       	call   80104dd1 <memmove>
  bwrite(lbuf);
...
80103425:	c7 04 24 91 82 10 80 	movl   $0x80108291,(%esp)
...
80103440:	e8 52 31 00 00       	call   80106597 <uartinit>
  pinit();         // process table
80103445:	e8 7c 0b 00 00       	call   80103fc6 <pinit>
  tvinit();        // trap vectors
8010344a:	e8 fb 2c 00 00       	call   8010614a <tvinit>
  binit();         // buffer cache
...
8010346c:	e8 21 2c 00 00       	call   80106092 <timerinit>
...
8010348a:	e8 53 0c 00 00       	call   801040e2 <userinit>
...
80103497:	83 ec 08             	sub    $0x8,%esp
  switchkvm(); 
8010349a:	e8 23 44 00 00       	call   801078c2 <switchkvm>
  seginit();
8010349f:	e8 a9 3d 00 00       	call   8010724d <seginit>
  lapicinit();
...
801034c4:	c7 04 24 a8 82 10 80 	movl   $0x801082a8,(%esp)
801034cb:	e8 ca ce ff ff       	call   8010039a <cprintf>
  idtinit();       // load idt register
801034d0:	e8 e5 2d 00 00       	call   801062ba <idtinit>
...
801034f0:	e8 3e 11 00 00       	call   80104633 <scheduler>
...
80103522:	e8 aa 18 00 00       	call   80104dd1 <memmove>
...
801036a2:	00 
801036a3:	c7 44 24 04 bc 82 10 	movl   $0x801082bc,0x4(%esp)
801036aa:	80 
801036ab:	8b 45 f0             	mov    -0x10(%ebp),%eax
801036ae:	89 04 24             	mov    %eax,(%esp)
801036b1:	e8 bf 16 00 00       	call   80104d75 <memcmp>
...
801037e3:	00 
801037e4:	c7 44 24 04 c1 82 10 	movl   $0x801082c1,0x4(%esp)
801037eb:	80 
801037ec:	8b 45 f0             	mov    -0x10(%ebp),%eax
801037ef:	89 04 24             	mov    %eax,(%esp)
801037f2:	e8 7e 15 00 00       	call   80104d75 <memcmp>
...
801038c0:	8b 04 85 04 83 10 80 	mov    -0x7fef7cfc(,%eax,4),%eax
...
801038f9:	c7 04 24 c6 82 10 80 	movl   $0x801082c6,(%esp)
...
8010398a:	c7 04 24 e4 82 10 80 	movl   $0x801082e4,(%esp)
...
80103c8f:	c7 44 24 04 18 83 10 	movl   $0x80108318,0x4(%esp)
80103c96:	80 
80103c97:	89 04 24             	mov    %eax,(%esp)
80103c9a:	e8 ef 0d 00 00       	call   80104a8e <initlock>
  (*f0)->type = FD_PIPE;
...
80103d47:	e8 63 0d 00 00       	call   80104aaf <acquire>
  if(writable){
...
80103d6a:	e8 48 0b 00 00       	call   801048b7 <wakeup>
...
80103d89:	e8 29 0b 00 00       	call   801048b7 <wakeup>
  }
...
80103dae:	e8 5d 0d 00 00       	call   80104b10 <release>
    kfree((char*)p);
...
80103dc6:	e8 45 0d 00 00       	call   80104b10 <release>
}
80103dcb:	c9                   	leave  
80103dcc:	c3                   	ret    
...
80103dda:	e8 d0 0c 00 00       	call   80104aaf <acquire>
  for(i = 0; i < n; i++){
...
80103e0b:	e8 00 0d 00 00       	call   80104b10 <release>
        return -1;
...
80103e25:	e8 8d 0a 00 00       	call   801048b7 <wakeup>
...
80103e3d:	e8 9b 09 00 00       	call   801047dd <sleep>
...
80103ea4:	e8 0e 0a 00 00       	call   801048b7 <wakeup>
  release(&p->lock);
80103ea9:	8b 45 08             	mov    0x8(%ebp),%eax
80103eac:	89 04 24             	mov    %eax,(%esp)
80103eaf:	e8 5c 0c 00 00       	call   80104b10 <release>
  return n;
...
80103eca:	e8 e0 0b 00 00       	call   80104aaf <acquire>
...
80103ee4:	e8 27 0c 00 00       	call   80104b10 <release>
      return -1;
...
80103f06:	e8 d2 08 00 00       	call   801047dd <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
80103f96:	e8 1c 09 00 00       	call   801048b7 <wakeup>
  release(&p->lock);
80103f9b:	8b 45 08             	mov    0x8(%ebp),%eax
80103f9e:	89 04 24             	mov    %eax,(%esp)
80103fa1:	e8 6a 0b 00 00       	call   80104b10 <release>
  return i;
...
80103fcc:	c7 44 24 04 1d 83 10 	movl   $0x8010831d,0x4(%esp)
80103fd3:	80 
80103fd4:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80103fdb:	e8 ae 0a 00 00       	call   80104a8e <initlock>
}
80103fe0:	c9                   	leave  
80103fe1:	c3                   	ret    
...
80103fe5:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
80103fe8:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80103fef:	e8 bb 0a 00 00       	call   80104aaf <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103ff4:	c7 45 f0 54 ff 10 80 	movl   $0x8010ff54,-0x10(%ebp)
80103ffb:	eb 0e                	jmp    8010400b <allocproc+0x29>
    if(p->state == UNUSED)
80103ffd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104000:	8b 40 0c             	mov    0xc(%eax),%eax
80104003:	85 c0                	test   %eax,%eax
80104005:	74 24                	je     8010402b <allocproc+0x49>
{
  struct proc *p;
  char *sp;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104007:	83 45 f0 7c          	addl   $0x7c,-0x10(%ebp)
8010400b:	b8 54 1e 11 80       	mov    $0x80111e54,%eax
80104010:	39 45 f0             	cmp    %eax,-0x10(%ebp)
80104013:	72 e8                	jb     80103ffd <allocproc+0x1b>
    if(p->state == UNUSED)
      goto found;
  release(&ptable.lock);
80104015:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
8010401c:	e8 ef 0a 00 00       	call   80104b10 <release>
  return 0;
80104021:	b8 00 00 00 00       	mov    $0x0,%eax
80104026:	e9 b5 00 00 00       	jmp    801040e0 <allocproc+0xfe>
  char *sp;
...
8010402f:	c7 40 0c 01 00 00 00 	movl   $0x1,0xc(%eax)
  p->pid = nextpid++;
80104036:	a1 04 b0 10 80       	mov    0x8010b004,%eax
8010403b:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010403e:	89 42 10             	mov    %eax,0x10(%edx)
80104041:	83 c0 01             	add    $0x1,%eax
80104044:	a3 04 b0 10 80       	mov    %eax,0x8010b004
  release(&ptable.lock);
80104049:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104050:	e8 bb 0a 00 00       	call   80104b10 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
80104055:	e8 a4 ea ff ff       	call   80102afe <kalloc>
8010405a:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010405d:	89 42 08             	mov    %eax,0x8(%edx)
80104060:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104063:	8b 40 08             	mov    0x8(%eax),%eax
80104066:	85 c0                	test   %eax,%eax
80104068:	75 11                	jne    8010407b <allocproc+0x99>
    p->state = UNUSED;
8010406a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010406d:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
    return 0;
80104074:	b8 00 00 00 00       	mov    $0x0,%eax
80104079:	eb 65                	jmp    801040e0 <allocproc+0xfe>
  }
  sp = p->kstack + KSTACKSIZE;
8010407b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010407e:	8b 40 08             	mov    0x8(%eax),%eax
80104081:	05 00 10 00 00       	add    $0x1000,%eax
80104086:	89 45 f4             	mov    %eax,-0xc(%ebp)
  
  // Leave room for trap frame.
  sp -= sizeof *p->tf;
80104089:	83 6d f4 4c          	subl   $0x4c,-0xc(%ebp)
  p->tf = (struct trapframe*)sp;
8010408d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104090:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104093:	89 50 18             	mov    %edx,0x18(%eax)
  
  // Set up new context to start executing at forkret,
  // which returns to trapret.
  sp -= 4;
80104096:	83 6d f4 04          	subl   $0x4,-0xc(%ebp)
  *(uint*)sp = (uint)trapret;
8010409a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010409d:	ba 04 61 10 80       	mov    $0x80106104,%edx
801040a2:	89 10                	mov    %edx,(%eax)

  sp -= sizeof *p->context;
801040a4:	83 6d f4 14          	subl   $0x14,-0xc(%ebp)
  p->context = (struct context*)sp;
801040a8:	8b 55 f4             	mov    -0xc(%ebp),%edx
801040ab:	8b 45 f0             	mov    -0x10(%ebp),%eax
801040ae:	89 50 1c             	mov    %edx,0x1c(%eax)
  memset(p->context, 0, sizeof *p->context);
801040b1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801040b4:	8b 40 1c             	mov    0x1c(%eax),%eax
801040b7:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
801040be:	00 
801040bf:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801040c6:	00 
801040c7:	89 04 24             	mov    %eax,(%esp)
801040ca:	e8 2f 0c 00 00       	call   80104cfe <memset>
  p->context->eip = (uint)forkret;
801040cf:	8b 45 f0             	mov    -0x10(%ebp),%eax
801040d2:	8b 40 1c             	mov    0x1c(%eax),%eax
801040d5:	ba b1 47 10 80       	mov    $0x801047b1,%edx
801040da:	89 50 10             	mov    %edx,0x10(%eax)
...
801040e5:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  extern char _binary_initcode_start[], _binary_initcode_size[];
  
  p = allocproc();
801040e8:	e8 f5 fe ff ff       	call   80103fe2 <allocproc>
801040ed:	89 45 f4             	mov    %eax,-0xc(%ebp)
  initproc = p;
801040f0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801040f3:	a3 48 b6 10 80       	mov    %eax,0x8010b648
  if((p->pgdir = setupkvm()) == 0)
801040f8:	e8 f0 36 00 00       	call   801077ed <setupkvm>
801040fd:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104100:	89 42 04             	mov    %eax,0x4(%edx)
80104103:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104106:	8b 40 04             	mov    0x4(%eax),%eax
80104109:	85 c0                	test   %eax,%eax
8010410b:	75 0c                	jne    80104119 <userinit+0x37>
    panic("userinit: out of memory?");
8010410d:	c7 04 24 24 83 10 80 	movl   $0x80108324,(%esp)
80104114:	e8 21 c4 ff ff       	call   8010053a <panic>
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
80104119:	ba 2c 00 00 00       	mov    $0x2c,%edx
8010411e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104121:	8b 40 04             	mov    0x4(%eax),%eax
80104124:	89 54 24 08          	mov    %edx,0x8(%esp)
80104128:	c7 44 24 04 e0 b4 10 	movl   $0x8010b4e0,0x4(%esp)
8010412f:	80 
80104130:	89 04 24             	mov    %eax,(%esp)
80104133:	e8 0e 39 00 00       	call   80107a46 <inituvm>
  p->sz = PGSIZE;
80104138:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010413b:	c7 00 00 10 00 00    	movl   $0x1000,(%eax)
  memset(p->tf, 0, sizeof(*p->tf));
80104141:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104144:	8b 40 18             	mov    0x18(%eax),%eax
80104147:	c7 44 24 08 4c 00 00 	movl   $0x4c,0x8(%esp)
8010414e:	00 
8010414f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104156:	00 
80104157:	89 04 24             	mov    %eax,(%esp)
8010415a:	e8 9f 0b 00 00       	call   80104cfe <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
8010415f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104162:	8b 40 18             	mov    0x18(%eax),%eax
80104165:	66 c7 40 3c 23 00    	movw   $0x23,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
8010416b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010416e:	8b 40 18             	mov    0x18(%eax),%eax
80104171:	66 c7 40 2c 2b 00    	movw   $0x2b,0x2c(%eax)
  p->tf->es = p->tf->ds;
80104177:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010417a:	8b 40 18             	mov    0x18(%eax),%eax
8010417d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104180:	8b 52 18             	mov    0x18(%edx),%edx
80104183:	0f b7 52 2c          	movzwl 0x2c(%edx),%edx
80104187:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
8010418b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010418e:	8b 40 18             	mov    0x18(%eax),%eax
80104191:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104194:	8b 52 18             	mov    0x18(%edx),%edx
80104197:	0f b7 52 2c          	movzwl 0x2c(%edx),%edx
8010419b:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
8010419f:	8b 45 f4             	mov    -0xc(%ebp),%eax
801041a2:	8b 40 18             	mov    0x18(%eax),%eax
801041a5:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
801041ac:	8b 45 f4             	mov    -0xc(%ebp),%eax
801041af:	8b 40 18             	mov    0x18(%eax),%eax
801041b2:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
801041b9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801041bc:	8b 40 18             	mov    0x18(%eax),%eax
801041bf:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)

  safestrcpy(p->name, "initcode", sizeof(p->name));
801041c6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801041c9:	83 c0 6c             	add    $0x6c,%eax
801041cc:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
801041d3:	00 
801041d4:	c7 44 24 04 3d 83 10 	movl   $0x8010833d,0x4(%esp)
801041db:	80 
801041dc:	89 04 24             	mov    %eax,(%esp)
801041df:	e8 4d 0d 00 00       	call   80104f31 <safestrcpy>
  p->cwd = namei("/");
801041e4:	c7 04 24 46 83 10 80 	movl   $0x80108346,(%esp)
801041eb:	e8 27 e2 ff ff       	call   80102417 <namei>
801041f0:	8b 55 f4             	mov    -0xc(%ebp),%edx
801041f3:	89 42 68             	mov    %eax,0x68(%edx)

  p->state = RUNNABLE;
801041f6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801041f9:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
}
80104200:	c9                   	leave  
80104201:	c3                   	ret    
...
80104205:	83 ec 28             	sub    $0x28,%esp
  uint sz;
  
  sz = proc->sz;
80104208:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010420e:	8b 00                	mov    (%eax),%eax
80104210:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(n > 0){
80104213:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80104217:	7e 34                	jle    8010424d <growproc+0x4b>
    if((sz = allocuvm(proc->pgdir, sz, sz + n)) == 0)
80104219:	8b 45 08             	mov    0x8(%ebp),%eax
8010421c:	89 c2                	mov    %eax,%edx
8010421e:	03 55 f4             	add    -0xc(%ebp),%edx
80104221:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104227:	8b 40 04             	mov    0x4(%eax),%eax
8010422a:	89 54 24 08          	mov    %edx,0x8(%esp)
8010422e:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104231:	89 54 24 04          	mov    %edx,0x4(%esp)
80104235:	89 04 24             	mov    %eax,(%esp)
80104238:	e8 84 39 00 00       	call   80107bc1 <allocuvm>
8010423d:	89 45 f4             	mov    %eax,-0xc(%ebp)
80104240:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80104244:	75 41                	jne    80104287 <growproc+0x85>
      return -1;
80104246:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010424b:	eb 58                	jmp    801042a5 <growproc+0xa3>
  } else if(n < 0){
8010424d:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80104251:	79 34                	jns    80104287 <growproc+0x85>
    if((sz = deallocuvm(proc->pgdir, sz, sz + n)) == 0)
80104253:	8b 45 08             	mov    0x8(%ebp),%eax
80104256:	89 c2                	mov    %eax,%edx
80104258:	03 55 f4             	add    -0xc(%ebp),%edx
8010425b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104261:	8b 40 04             	mov    0x4(%eax),%eax
80104264:	89 54 24 08          	mov    %edx,0x8(%esp)
80104268:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010426b:	89 54 24 04          	mov    %edx,0x4(%esp)
8010426f:	89 04 24             	mov    %eax,(%esp)
80104272:	e8 24 3a 00 00       	call   80107c9b <deallocuvm>
80104277:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010427a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010427e:	75 07                	jne    80104287 <growproc+0x85>
      return -1;
80104280:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104285:	eb 1e                	jmp    801042a5 <growproc+0xa3>
  }
  proc->sz = sz;
80104287:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010428d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104290:	89 10                	mov    %edx,(%eax)
  switchuvm(proc);
80104292:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104298:	89 04 24             	mov    %eax,(%esp)
8010429b:	e8 3f 36 00 00       	call   801078df <switchuvm>
  return 0;
...
801042ad:	83 ec 2c             	sub    $0x2c,%esp
  int i, pid;
  struct proc *np;

  // Allocate process.
  if((np = allocproc()) == 0)
801042b0:	e8 2d fd ff ff       	call   80103fe2 <allocproc>
801042b5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801042b8:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
801042bc:	75 0a                	jne    801042c8 <fork+0x21>
    return -1;
801042be:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801042c3:	e9 3a 01 00 00       	jmp    80104402 <fork+0x15b>

  // Copy process state from p.
  if((np->pgdir = copyuvm(proc->pgdir, proc->sz)) == 0){
801042c8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801042ce:	8b 10                	mov    (%eax),%edx
801042d0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801042d6:	8b 40 04             	mov    0x4(%eax),%eax
801042d9:	89 54 24 04          	mov    %edx,0x4(%esp)
801042dd:	89 04 24             	mov    %eax,(%esp)
801042e0:	e8 46 3b 00 00       	call   80107e2b <copyuvm>
801042e5:	8b 55 e4             	mov    -0x1c(%ebp),%edx
...
801042f3:	75 2c                	jne    80104321 <fork+0x7a>
    kfree(np->kstack);
801042f5:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801042f8:	8b 40 08             	mov    0x8(%eax),%eax
801042fb:	89 04 24             	mov    %eax,(%esp)
801042fe:	e8 62 e7 ff ff       	call   80102a65 <kfree>
    np->kstack = 0;
80104303:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104306:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
    np->state = UNUSED;
8010430d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104310:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
    return -1;
80104317:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010431c:	e9 e1 00 00 00       	jmp    80104402 <fork+0x15b>
  }
  np->sz = proc->sz;
80104321:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104327:	8b 10                	mov    (%eax),%edx
80104329:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010432c:	89 10                	mov    %edx,(%eax)
  np->parent = proc;
8010432e:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104335:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104338:	89 50 14             	mov    %edx,0x14(%eax)
  *np->tf = *proc->tf;
8010433b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010433e:	8b 50 18             	mov    0x18(%eax),%edx
80104341:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104347:	8b 40 18             	mov    0x18(%eax),%eax
8010434a:	89 c3                	mov    %eax,%ebx
8010434c:	b8 13 00 00 00       	mov    $0x13,%eax
80104351:	89 d7                	mov    %edx,%edi
80104353:	89 de                	mov    %ebx,%esi
80104355:	89 c1                	mov    %eax,%ecx
80104357:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)

  // Clear %eax so that fork returns 0 in the child.
  np->tf->eax = 0;
80104359:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010435c:	8b 40 18             	mov    0x18(%eax),%eax
8010435f:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)

  for(i = 0; i < NOFILE; i++)
80104366:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%ebp)
8010436d:	eb 3d                	jmp    801043ac <fork+0x105>
    if(proc->ofile[i])
8010436f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104375:	8b 55 dc             	mov    -0x24(%ebp),%edx
80104378:	83 c2 08             	add    $0x8,%edx
8010437b:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
8010437f:	85 c0                	test   %eax,%eax
80104381:	74 25                	je     801043a8 <fork+0x101>
      np->ofile[i] = filedup(proc->ofile[i]);
80104383:	8b 5d dc             	mov    -0x24(%ebp),%ebx
80104386:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010438c:	8b 55 dc             	mov    -0x24(%ebp),%edx
8010438f:	83 c2 08             	add    $0x8,%edx
80104392:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80104396:	89 04 24             	mov    %eax,(%esp)
80104399:	e8 db cb ff ff       	call   80100f79 <filedup>
8010439e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801043a1:	8d 4b 08             	lea    0x8(%ebx),%ecx
801043a4:	89 44 8a 08          	mov    %eax,0x8(%edx,%ecx,4)
  *np->tf = *proc->tf;
  ...
  for(i = 0; i < NOFILE; i++)
801043a8:	83 45 dc 01          	addl   $0x1,-0x24(%ebp)
801043ac:	83 7d dc 0f          	cmpl   $0xf,-0x24(%ebp)
801043b0:	7e bd                	jle    8010436f <fork+0xc8>
    if(proc->ofile[i])
      np->ofile[i] = filedup(proc->ofile[i]);
  np->cwd = idup(proc->cwd);
801043b2:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801043b8:	8b 40 68             	mov    0x68(%eax),%eax
801043bb:	89 04 24             	mov    %eax,(%esp)
801043be:	e8 7a d4 ff ff       	call   8010183d <idup>
801043c3:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801043c6:	89 42 68             	mov    %eax,0x68(%edx)
 
  pid = np->pid;
801043c9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801043cc:	8b 40 10             	mov    0x10(%eax),%eax
801043cf:	89 45 e0             	mov    %eax,-0x20(%ebp)
  np->state = RUNNABLE;
801043d2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801043d5:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  safestrcpy(np->name, proc->name, sizeof(proc->name));
801043dc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801043e2:	8d 50 6c             	lea    0x6c(%eax),%edx
801043e5:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801043e8:	83 c0 6c             	add    $0x6c,%eax
801043eb:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
801043f2:	00 
801043f3:	89 54 24 04          	mov    %edx,0x4(%esp)
801043f7:	89 04 24             	mov    %eax,(%esp)
801043fa:	e8 32 0b 00 00       	call   80104f31 <safestrcpy>
  return pid;
801043ff:	8b 45 e0             	mov    -0x20(%ebp),%eax
}
80104402:	83 c4 2c             	add    $0x2c,%esp
80104405:	5b                   	pop    %ebx
80104406:	5e                   	pop    %esi
80104407:	5f                   	pop    %edi
80104408:	5d                   	pop    %ebp
...
8010440d:	83 ec 28             	sub    $0x28,%esp
  ...
  if(proc == initproc)
80104410:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104417:	a1 48 b6 10 80       	mov    0x8010b648,%eax
8010441c:	39 c2                	cmp    %eax,%edx
8010441e:	75 0c                	jne    8010442c <exit+0x22>
    panic("init exiting");
80104420:	c7 04 24 48 83 10 80 	movl   $0x80108348,(%esp)
80104427:	e8 0e c1 ff ff       	call   8010053a <panic>

  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
8010442c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80104433:	eb 44                	jmp    80104479 <exit+0x6f>
    if(proc->ofile[fd]){
80104435:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010443b:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010443e:	83 c2 08             	add    $0x8,%edx
80104441:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80104445:	85 c0                	test   %eax,%eax
80104447:	74 2c                	je     80104475 <exit+0x6b>
      fileclose(proc->ofile[fd]);
80104449:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010444f:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104452:	83 c2 08             	add    $0x8,%edx
80104455:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80104459:	89 04 24             	mov    %eax,(%esp)
8010445c:	e8 60 cb ff ff       	call   80100fc1 <fileclose>
      proc->ofile[fd] = 0;
80104461:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104467:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010446a:	83 c2 08             	add    $0x8,%edx
8010446d:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80104474:	00 
  ...
  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
80104475:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80104479:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
8010447d:	7e b6                	jle    80104435 <exit+0x2b>
      fileclose(proc->ofile[fd]);
      proc->ofile[fd] = 0;
    }
  }
...
80104485:	8b 40 68             	mov    0x68(%eax),%eax
80104488:	89 04 24             	mov    %eax,(%esp)
8010448b:	e8 95 d5 ff ff       	call   80101a25 <iput>
  proc->cwd = 0;
80104490:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104496:	c7 40 68 00 00 00 00 	movl   $0x0,0x68(%eax)

  acquire(&ptable.lock);
8010449d:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
801044a4:	e8 06 06 00 00       	call   80104aaf <acquire>
...
801044b5:	e8 be 03 00 00       	call   80104878 <wakeup1>

  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801044ba:	c7 45 f0 54 ff 10 80 	movl   $0x8010ff54,-0x10(%ebp)
801044c1:	eb 38                	jmp    801044fb <exit+0xf1>
    if(p->parent == proc){
801044c3:	8b 45 f0             	mov    -0x10(%ebp),%eax
801044c6:	8b 50 14             	mov    0x14(%eax),%edx
801044c9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801044cf:	39 c2                	cmp    %eax,%edx
801044d1:	75 24                	jne    801044f7 <exit+0xed>
      p->parent = initproc;
801044d3:	8b 15 48 b6 10 80    	mov    0x8010b648,%edx
801044d9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801044dc:	89 50 14             	mov    %edx,0x14(%eax)
      if(p->state == ZOMBIE)
801044df:	8b 45 f0             	mov    -0x10(%ebp),%eax
801044e2:	8b 40 0c             	mov    0xc(%eax),%eax
801044e5:	83 f8 05             	cmp    $0x5,%eax
801044e8:	75 0d                	jne    801044f7 <exit+0xed>
        wakeup1(initproc);
801044ea:	a1 48 b6 10 80       	mov    0x8010b648,%eax
801044ef:	89 04 24             	mov    %eax,(%esp)
801044f2:	e8 81 03 00 00       	call   80104878 <wakeup1>
  ...
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801044f7:	83 45 f0 7c          	addl   $0x7c,-0x10(%ebp)
801044fb:	b8 54 1e 11 80       	mov    $0x80111e54,%eax
80104500:	39 45 f0             	cmp    %eax,-0x10(%ebp)
80104503:	72 be                	jb     801044c3 <exit+0xb9>
        wakeup1(initproc);
    }
  }
...
8010450b:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  sched();
80104512:	e8 b6 01 00 00       	call   801046cd <sched>
  panic("zombie exit");
80104517:	c7 04 24 55 83 10 80 	movl   $0x80108355,(%esp)
8010451e:	e8 17 c0 ff ff       	call   8010053a <panic>
...
80104530:	e8 7a 05 00 00       	call   80104aaf <acquire>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
80104535:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010453c:	c7 45 ec 54 ff 10 80 	movl   $0x8010ff54,-0x14(%ebp)
80104543:	e9 9a 00 00 00       	jmp    801045e2 <wait+0xbf>
      if(p->parent != proc)
80104548:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010454b:	8b 50 14             	mov    0x14(%eax),%edx
8010454e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104554:	39 c2                	cmp    %eax,%edx
80104556:	0f 85 81 00 00 00    	jne    801045dd <wait+0xba>
        continue;
      havekids = 1;
8010455c:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
      if(p->state == ZOMBIE){
80104563:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104566:	8b 40 0c             	mov    0xc(%eax),%eax
80104569:	83 f8 05             	cmp    $0x5,%eax
8010456c:	75 70                	jne    801045de <wait+0xbb>
        // Found one.
        pid = p->pid;
8010456e:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104571:	8b 40 10             	mov    0x10(%eax),%eax
80104574:	89 45 f4             	mov    %eax,-0xc(%ebp)
        kfree(p->kstack);
80104577:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010457a:	8b 40 08             	mov    0x8(%eax),%eax
8010457d:	89 04 24             	mov    %eax,(%esp)
80104580:	e8 e0 e4 ff ff       	call   80102a65 <kfree>
        p->kstack = 0;
80104585:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104588:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
        freevm(p->pgdir);
8010458f:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104592:	8b 40 04             	mov    0x4(%eax),%eax
80104595:	89 04 24             	mov    %eax,(%esp)
80104598:	e8 ba 37 00 00       	call   80107d57 <freevm>
        p->state = UNUSED;
8010459d:	8b 45 ec             	mov    -0x14(%ebp),%eax
801045a0:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
        p->pid = 0;
801045a7:	8b 45 ec             	mov    -0x14(%ebp),%eax
801045aa:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
        p->parent = 0;
801045b1:	8b 45 ec             	mov    -0x14(%ebp),%eax
801045b4:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
        p->name[0] = 0;
801045bb:	8b 45 ec             	mov    -0x14(%ebp),%eax
801045be:	c6 40 6c 00          	movb   $0x0,0x6c(%eax)
        p->killed = 0;
801045c2:	8b 45 ec             	mov    -0x14(%ebp),%eax
801045c5:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
        release(&ptable.lock);
801045cc:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
801045d3:	e8 38 05 00 00       	call   80104b10 <release>
        return pid;
801045d8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045db:	eb 54                	jmp    80104631 <wait+0x10e>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
801045dd:	90                   	nop
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801045de:	83 45 ec 7c          	addl   $0x7c,-0x14(%ebp)
801045e2:	b8 54 1e 11 80       	mov    $0x80111e54,%eax
801045e7:	39 45 ec             	cmp    %eax,-0x14(%ebp)
801045ea:	0f 82 58 ff ff ff    	jb     80104548 <wait+0x25>
        return pid;
      }
    }
...
801045f0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801045f4:	74 0d                	je     80104603 <wait+0xe0>
801045f6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801045fc:	8b 40 24             	mov    0x24(%eax),%eax
801045ff:	85 c0                	test   %eax,%eax
80104601:	74 13                	je     80104616 <wait+0xf3>
      release(&ptable.lock);
80104603:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
8010460a:	e8 01 05 00 00       	call   80104b10 <release>
      return -1;
8010460f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104614:	eb 1b                	jmp    80104631 <wait+0x10e>
    }

    // Wait for children to exit.  (See wakeup1 call in proc_exit.)
    sleep(proc, &ptable.lock);  //DOC: wait-sleep
80104616:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010461c:	c7 44 24 04 20 ff 10 	movl   $0x8010ff20,0x4(%esp)
80104623:	80 
80104624:	89 04 24             	mov    %eax,(%esp)
80104627:	e8 b1 01 00 00       	call   801047dd <sleep>
  }
8010462c:	e9 04 ff ff ff       	jmp    80104535 <wait+0x12>
}
80104631:	c9                   	leave  
80104632:	c3                   	ret    
...
80104636:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;

  for(;;){
    // Enable interrupts on this processor.
    sti();
80104639:	e8 82 f9 ff ff       	call   80103fc0 <sti>

    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
8010463e:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104645:	e8 65 04 00 00       	call   80104aaf <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010464a:	c7 45 f4 54 ff 10 80 	movl   $0x8010ff54,-0xc(%ebp)
80104651:	eb 5f                	jmp    801046b2 <scheduler+0x7f>
      if(p->state != RUNNABLE)
80104653:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104656:	8b 40 0c             	mov    0xc(%eax),%eax
80104659:	83 f8 03             	cmp    $0x3,%eax
8010465c:	75 4f                	jne    801046ad <scheduler+0x7a>
        continue;
...
80104661:	65 a3 04 00 00 00    	mov    %eax,%gs:0x4
      switchuvm(p);
80104667:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010466a:	89 04 24             	mov    %eax,(%esp)
8010466d:	e8 6d 32 00 00       	call   801078df <switchuvm>
      p->state = RUNNING;
80104672:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104675:	c7 40 0c 04 00 00 00 	movl   $0x4,0xc(%eax)
      swtch(&cpu->scheduler, proc->context);
8010467c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104682:	8b 40 1c             	mov    0x1c(%eax),%eax
80104685:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010468c:	83 c2 04             	add    $0x4,%edx
8010468f:	89 44 24 04          	mov    %eax,0x4(%esp)
80104693:	89 14 24             	mov    %edx,(%esp)
80104696:	e8 09 09 00 00       	call   80104fa4 <swtch>
      switchkvm();
8010469b:	e8 22 32 00 00       	call   801078c2 <switchkvm>

      // Process is done running for now.
      // It should have changed its p->state before coming back.
      proc = 0;
801046a0:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
801046a7:	00 00 00 00 
801046ab:	eb 01                	jmp    801046ae <scheduler+0x7b>
...
801046ad:	90                   	nop
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801046ae:	83 45 f4 7c          	addl   $0x7c,-0xc(%ebp)
801046b2:	b8 54 1e 11 80       	mov    $0x80111e54,%eax
801046b7:	39 45 f4             	cmp    %eax,-0xc(%ebp)
801046ba:	72 97                	jb     80104653 <scheduler+0x20>
...
801046c3:	e8 48 04 00 00       	call   80104b10 <release>

  }
801046c8:	e9 6c ff ff ff       	jmp    80104639 <scheduler+0x6>
...
801046d0:	83 ec 28             	sub    $0x28,%esp
  int intena;

  if(!holding(&ptable.lock))
801046d3:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
801046da:	e8 ef 04 00 00       	call   80104bce <holding>
801046df:	85 c0                	test   %eax,%eax
801046e1:	75 0c                	jne    801046ef <sched+0x22>
    panic("sched ptable.lock");
801046e3:	c7 04 24 61 83 10 80 	movl   $0x80108361,(%esp)
801046ea:	e8 4b be ff ff       	call   8010053a <panic>
  if(cpu->ncli != 1)
801046ef:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801046f5:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
801046fb:	83 f8 01             	cmp    $0x1,%eax
801046fe:	74 0c                	je     8010470c <sched+0x3f>
    panic("sched locks");
80104700:	c7 04 24 73 83 10 80 	movl   $0x80108373,(%esp)
80104707:	e8 2e be ff ff       	call   8010053a <panic>
  if(proc->state == RUNNING)
8010470c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104712:	8b 40 0c             	mov    0xc(%eax),%eax
80104715:	83 f8 04             	cmp    $0x4,%eax
80104718:	75 0c                	jne    80104726 <sched+0x59>
    panic("sched running");
8010471a:	c7 04 24 7f 83 10 80 	movl   $0x8010837f,(%esp)
80104721:	e8 14 be ff ff       	call   8010053a <panic>
  if(readeflags()&FL_IF)
80104726:	e8 85 f8 ff ff       	call   80103fb0 <readeflags>
8010472b:	25 00 02 00 00       	and    $0x200,%eax
80104730:	85 c0                	test   %eax,%eax
80104732:	74 0c                	je     80104740 <sched+0x73>
    panic("sched interruptible");
80104734:	c7 04 24 8d 83 10 80 	movl   $0x8010838d,(%esp)
8010473b:	e8 fa bd ff ff       	call   8010053a <panic>
  intena = cpu->intena;
80104740:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104746:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
8010474c:	89 45 f4             	mov    %eax,-0xc(%ebp)
  swtch(&proc->context, cpu->scheduler);
8010474f:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104755:	8b 40 04             	mov    0x4(%eax),%eax
80104758:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010475f:	83 c2 1c             	add    $0x1c,%edx
80104762:	89 44 24 04          	mov    %eax,0x4(%esp)
80104766:	89 14 24             	mov    %edx,(%esp)
80104769:	e8 36 08 00 00       	call   80104fa4 <swtch>
  cpu->intena = intena;
8010476e:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104774:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104777:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
8010477d:	c9                   	leave  
8010477e:	c3                   	ret    
...
801047b4:	83 ec 18             	sub    $0x18,%esp
  ...
  release(&ptable.lock);
801047b7:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
801047be:	e8 4d 03 00 00       	call   80104b10 <release>

  if (first) {
801047c3:	a1 20 b0 10 80       	mov    0x8010b020,%eax
801047c8:	85 c0                	test   %eax,%eax
801047ca:	74 0f                	je     801047db <forkret+0x2a>
    // Some initialization functions must be run in the context
    // of a regular process (e.g., they call sleep), and thus cannot 
    // be run from main().
    first = 0;
801047cc:	c7 05 20 b0 10 80 00 	movl   $0x0,0x8010b020
801047d3:	00 00 00 
    initlog();
801047d6:	e8 1d e8 ff ff       	call   80102ff8 <initlog>
  }
...
801047e0:	83 ec 18             	sub    $0x18,%esp
  if(proc == 0)
801047e3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801047e9:	85 c0                	test   %eax,%eax
801047eb:	75 0c                	jne    801047f9 <sleep+0x1c>
    panic("sleep");
801047ed:	c7 04 24 a1 83 10 80 	movl   $0x801083a1,(%esp)
801047f4:	e8 41 bd ff ff       	call   8010053a <panic>

  if(lk == 0)
801047f9:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
801047fd:	75 0c                	jne    8010480b <sleep+0x2e>
    panic("sleep without lk");
801047ff:	c7 04 24 a7 83 10 80 	movl   $0x801083a7,(%esp)
80104806:	e8 2f bd ff ff       	call   8010053a <panic>
...
8010480b:	81 7d 0c 20 ff 10 80 	cmpl   $0x8010ff20,0xc(%ebp)
80104812:	74 17                	je     8010482b <sleep+0x4e>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104814:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
8010481b:	e8 8f 02 00 00       	call   80104aaf <acquire>
    release(lk);
80104820:	8b 45 0c             	mov    0xc(%ebp),%eax
80104823:	89 04 24             	mov    %eax,(%esp)
80104826:	e8 e5 02 00 00       	call   80104b10 <release>
  }

  // Go to sleep.
  proc->chan = chan;
8010482b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104831:	8b 55 08             	mov    0x8(%ebp),%edx
80104834:	89 50 20             	mov    %edx,0x20(%eax)
  proc->state = SLEEPING;
80104837:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010483d:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  sched();
80104844:	e8 84 fe ff ff       	call   801046cd <sched>

  // Tidy up.
  proc->chan = 0;
80104849:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010484f:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)

  // Reacquire original lock.
  if(lk != &ptable.lock){  //DOC: sleeplock2
80104856:	81 7d 0c 20 ff 10 80 	cmpl   $0x8010ff20,0xc(%ebp)
8010485d:	74 17                	je     80104876 <sleep+0x99>
    release(&ptable.lock);
8010485f:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104866:	e8 a5 02 00 00       	call   80104b10 <release>
    acquire(lk);
8010486b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010486e:	89 04 24             	mov    %eax,(%esp)
80104871:	e8 39 02 00 00       	call   80104aaf <acquire>
  }
}
80104876:	c9                   	leave  
80104877:	c3                   	ret    
...
8010487b:	83 ec 10             	sub    $0x10,%esp
  struct proc *p;

  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010487e:	c7 45 fc 54 ff 10 80 	movl   $0x8010ff54,-0x4(%ebp)
80104885:	eb 24                	jmp    801048ab <wakeup1+0x33>
    if(p->state == SLEEPING && p->chan == chan)
80104887:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010488a:	8b 40 0c             	mov    0xc(%eax),%eax
8010488d:	83 f8 02             	cmp    $0x2,%eax
80104890:	75 15                	jne    801048a7 <wakeup1+0x2f>
80104892:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104895:	8b 40 20             	mov    0x20(%eax),%eax
80104898:	3b 45 08             	cmp    0x8(%ebp),%eax
8010489b:	75 0a                	jne    801048a7 <wakeup1+0x2f>
      p->state = RUNNABLE;
8010489d:	8b 45 fc             	mov    -0x4(%ebp),%eax
801048a0:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
static void
wakeup1(void *chan)
{
  struct proc *p;
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801048a7:	83 45 fc 7c          	addl   $0x7c,-0x4(%ebp)
801048ab:	b8 54 1e 11 80       	mov    $0x80111e54,%eax
801048b0:	39 45 fc             	cmp    %eax,-0x4(%ebp)
801048b3:	72 d2                	jb     80104887 <wakeup1+0xf>
    if(p->state == SLEEPING && p->chan == chan)
      p->state = RUNNABLE;
}
801048b5:	c9                   	leave  
...
801048ba:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);
801048bd:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
801048c4:	e8 e6 01 00 00       	call   80104aaf <acquire>
  wakeup1(chan);
801048c9:	8b 45 08             	mov    0x8(%ebp),%eax
801048cc:	89 04 24             	mov    %eax,(%esp)
801048cf:	e8 a4 ff ff ff       	call   80104878 <wakeup1>
  release(&ptable.lock);
801048d4:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
801048db:	e8 30 02 00 00       	call   80104b10 <release>
}
801048e0:	c9                   	leave  
801048e1:	c3                   	ret    
...
801048ef:	e8 bb 01 00 00       	call   80104aaf <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801048f4:	c7 45 f4 54 ff 10 80 	movl   $0x8010ff54,-0xc(%ebp)
801048fb:	eb 41                	jmp    8010493e <kill+0x5c>
    if(p->pid == pid){
801048fd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104900:	8b 40 10             	mov    0x10(%eax),%eax
80104903:	3b 45 08             	cmp    0x8(%ebp),%eax
80104906:	75 32                	jne    8010493a <kill+0x58>
      p->killed = 1;
80104908:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010490b:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
80104912:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104915:	8b 40 0c             	mov    0xc(%eax),%eax
80104918:	83 f8 02             	cmp    $0x2,%eax
8010491b:	75 0a                	jne    80104927 <kill+0x45>
        p->state = RUNNABLE;
8010491d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104920:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&ptable.lock);
80104927:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
8010492e:	e8 dd 01 00 00       	call   80104b10 <release>
      return 0;
80104933:	b8 00 00 00 00       	mov    $0x0,%eax
80104938:	eb 1f                	jmp    80104959 <kill+0x77>
kill(int pid)
{
  struct proc *p;
...
8010493e:	b8 54 1e 11 80       	mov    $0x80111e54,%eax
80104943:	39 45 f4             	cmp    %eax,-0xc(%ebp)
80104946:	72 b5                	jb     801048fd <kill+0x1b>
        p->state = RUNNABLE;
      release(&ptable.lock);
      return 0;
    }
...
8010494f:	e8 bc 01 00 00       	call   80104b10 <release>
  return -1;
...
8010495e:	83 ec 58             	sub    $0x58,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104961:	c7 45 f0 54 ff 10 80 	movl   $0x8010ff54,-0x10(%ebp)
80104968:	e9 d8 00 00 00       	jmp    80104a45 <procdump+0xea>
    if(p->state == UNUSED)
8010496d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104970:	8b 40 0c             	mov    0xc(%eax),%eax
80104973:	85 c0                	test   %eax,%eax
80104975:	0f 84 c5 00 00 00    	je     80104a40 <procdump+0xe5>
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
8010497b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010497e:	8b 40 0c             	mov    0xc(%eax),%eax
80104981:	83 f8 05             	cmp    $0x5,%eax
80104984:	77 23                	ja     801049a9 <procdump+0x4e>
80104986:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104989:	8b 40 0c             	mov    0xc(%eax),%eax
8010498c:	8b 04 85 08 b0 10 80 	mov    -0x7fef4ff8(,%eax,4),%eax
80104993:	85 c0                	test   %eax,%eax
80104995:	74 12                	je     801049a9 <procdump+0x4e>
...
801049a4:	89 45 f4             	mov    %eax,-0xc(%ebp)
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->state == UNUSED)
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801049a7:	eb 07                	jmp    801049b0 <procdump+0x55>
      state = states[p->state];
    else
      state = "???";
801049a9:	c7 45 f4 b8 83 10 80 	movl   $0x801083b8,-0xc(%ebp)
    cprintf("%d %s %s", p->pid, state, p->name);
801049b0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801049b3:	8d 50 6c             	lea    0x6c(%eax),%edx
801049b6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801049b9:	8b 40 10             	mov    0x10(%eax),%eax
801049bc:	89 54 24 0c          	mov    %edx,0xc(%esp)
801049c0:	8b 55 f4             	mov    -0xc(%ebp),%edx
801049c3:	89 54 24 08          	mov    %edx,0x8(%esp)
801049c7:	89 44 24 04          	mov    %eax,0x4(%esp)
801049cb:	c7 04 24 bc 83 10 80 	movl   $0x801083bc,(%esp)
801049d2:	e8 c3 b9 ff ff       	call   8010039a <cprintf>
    if(p->state == SLEEPING){
801049d7:	8b 45 f0             	mov    -0x10(%ebp),%eax
801049da:	8b 40 0c             	mov    0xc(%eax),%eax
801049dd:	83 f8 02             	cmp    $0x2,%eax
801049e0:	75 50                	jne    80104a32 <procdump+0xd7>
      getcallerpcs((uint*)p->context->ebp+2, pc);
801049e2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801049e5:	8b 40 1c             	mov    0x1c(%eax),%eax
801049e8:	8b 40 0c             	mov    0xc(%eax),%eax
801049eb:	83 c0 08             	add    $0x8,%eax
801049ee:	8d 55 c4             	lea    -0x3c(%ebp),%edx
801049f1:	89 54 24 04          	mov    %edx,0x4(%esp)
801049f5:	89 04 24             	mov    %eax,(%esp)
801049f8:	e8 62 01 00 00       	call   80104b5f <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
801049fd:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
80104a04:	eb 1b                	jmp    80104a21 <procdump+0xc6>
        cprintf(" %p", pc[i]);
80104a06:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104a09:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104a0d:	89 44 24 04          	mov    %eax,0x4(%esp)
80104a11:	c7 04 24 c5 83 10 80 	movl   $0x801083c5,(%esp)
80104a18:	e8 7d b9 ff ff       	call   8010039a <cprintf>
    else
      state = "???";
    cprintf("%d %s %s", p->pid, state, p->name);
    if(p->state == SLEEPING){
      getcallerpcs((uint*)p->context->ebp+2, pc);
      for(i=0; i<10 && pc[i] != 0; i++)
80104a1d:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
80104a21:	83 7d ec 09          	cmpl   $0x9,-0x14(%ebp)
80104a25:	7f 0b                	jg     80104a32 <procdump+0xd7>
80104a27:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104a2a:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104a2e:	85 c0                	test   %eax,%eax
80104a30:	75 d4                	jne    80104a06 <procdump+0xab>
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
80104a32:	c7 04 24 c9 83 10 80 	movl   $0x801083c9,(%esp)
80104a39:	e8 5c b9 ff ff       	call   8010039a <cprintf>
80104a3e:	eb 01                	jmp    80104a41 <procdump+0xe6>
  char *state;
  uint pc[10];
...
80104a40:	90                   	nop
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104a41:	83 45 f0 7c          	addl   $0x7c,-0x10(%ebp)
80104a45:	b8 54 1e 11 80       	mov    $0x80111e54,%eax
80104a4a:	39 45 f0             	cmp    %eax,-0x10(%ebp)
80104a4d:	0f 82 1a ff ff ff    	jb     8010496d <procdump+0x12>
      for(i=0; i<10 && pc[i] != 0; i++)
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
...
80104a5b:	83 ec 10             	sub    $0x10,%esp
  uint eflags;
  asm volatile("pushfl; popl %0" : "=r" (eflags));
80104a5e:	9c                   	pushf  
80104a5f:	58                   	pop    %eax
80104a60:	89 45 fc             	mov    %eax,-0x4(%ebp)
  return eflags;
...
80104a77:	83 ec 10             	sub    $0x10,%esp
  uint result;
...
80104a80:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104a83:	f0 87 02             	lock xchg %eax,(%edx)
...
80104a97:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
...
80104ab5:	e8 3e 01 00 00       	call   80104bf8 <pushcli>
  if(holding(lk))
80104aba:	8b 45 08             	mov    0x8(%ebp),%eax
80104abd:	89 04 24             	mov    %eax,(%esp)
80104ac0:	e8 09 01 00 00       	call   80104bce <holding>
80104ac5:	85 c0                	test   %eax,%eax
80104ac7:	74 0c                	je     80104ad5 <acquire+0x26>
    panic("acquire");
80104ac9:	c7 04 24 f5 83 10 80 	movl   $0x801083f5,(%esp)
80104ad0:	e8 65 ba ff ff       	call   8010053a <panic>
...
80104ad8:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80104adf:	00 
80104ae0:	89 04 24             	mov    %eax,(%esp)
80104ae3:	e8 8c ff ff ff       	call   80104a74 <xchg>
80104ae8:	85 c0                	test   %eax,%eax
80104aea:	75 e9                	jne    80104ad5 <acquire+0x26>
    ;
...
80104af6:	89 50 08             	mov    %edx,0x8(%eax)
  getcallerpcs(&lk, lk->pcs);
80104af9:	8b 45 08             	mov    0x8(%ebp),%eax
80104afc:	83 c0 0c             	add    $0xc,%eax
80104aff:	89 44 24 04          	mov    %eax,0x4(%esp)
80104b03:	8d 45 08             	lea    0x8(%ebp),%eax
80104b06:	89 04 24             	mov    %eax,(%esp)
80104b09:	e8 51 00 00 00       	call   80104b5f <getcallerpcs>
}
80104b0e:	c9                   	leave  
80104b0f:	c3                   	ret    
...
80104b1c:	e8 ad 00 00 00       	call   80104bce <holding>
80104b21:	85 c0                	test   %eax,%eax
80104b23:	75 0c                	jne    80104b31 <release+0x21>
    panic("release");
80104b25:	c7 04 24 fd 83 10 80 	movl   $0x801083fd,(%esp)
80104b2c:	e8 09 ba ff ff       	call   8010053a <panic>

  lk->pcs[0] = 0;
80104b31:	8b 45 08             	mov    0x8(%ebp),%eax
80104b34:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  lk->cpu = 0;
80104b3b:	8b 45 08             	mov    0x8(%ebp),%eax
80104b3e:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
...
80104b48:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104b4f:	00 
80104b50:	89 04 24             	mov    %eax,(%esp)
80104b53:	e8 1c ff ff ff       	call   80104a74 <xchg>

  popcli();
80104b58:	e8 e3 00 00 00       	call   80104c40 <popcli>
}
80104b5d:	c9                   	leave  
80104b5e:	c3                   	ret    

80104b5f <getcallerpcs>:
...
80104b62:	83 ec 10             	sub    $0x10,%esp
  uint *ebp;
  int i;
  
  ebp = (uint*)v - 2;
80104b65:	8b 45 08             	mov    0x8(%ebp),%eax
80104b68:	83 e8 08             	sub    $0x8,%eax
80104b6b:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(i = 0; i < 10; i++){
80104b6e:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80104b75:	eb 34                	jmp    80104bab <getcallerpcs+0x4c>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104b77:	83 7d f8 00          	cmpl   $0x0,-0x8(%ebp)
80104b7b:	74 49                	je     80104bc6 <getcallerpcs+0x67>
80104b7d:	81 7d f8 ff ff ff 7f 	cmpl   $0x7fffffff,-0x8(%ebp)
80104b84:	76 40                	jbe    80104bc6 <getcallerpcs+0x67>
80104b86:	83 7d f8 ff          	cmpl   $0xffffffff,-0x8(%ebp)
80104b8a:	74 3a                	je     80104bc6 <getcallerpcs+0x67>
      break;
    pcs[i] = ebp[1];     // saved %eip
80104b8c:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104b8f:	c1 e0 02             	shl    $0x2,%eax
80104b92:	03 45 0c             	add    0xc(%ebp),%eax
80104b95:	8b 55 f8             	mov    -0x8(%ebp),%edx
80104b98:	83 c2 04             	add    $0x4,%edx
80104b9b:	8b 12                	mov    (%edx),%edx
80104b9d:	89 10                	mov    %edx,(%eax)
    ebp = (uint*)ebp[0]; // saved %ebp
80104b9f:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104ba2:	8b 00                	mov    (%eax),%eax
80104ba4:	89 45 f8             	mov    %eax,-0x8(%ebp)
{
  uint *ebp;
  int i;
  ...
  ebp = (uint*)v - 2;
  for(i = 0; i < 10; i++){
80104ba7:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80104bab:	83 7d fc 09          	cmpl   $0x9,-0x4(%ebp)
80104baf:	7e c6                	jle    80104b77 <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80104bb1:	eb 13                	jmp    80104bc6 <getcallerpcs+0x67>
    pcs[i] = 0;
80104bb3:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104bb6:	c1 e0 02             	shl    $0x2,%eax
80104bb9:	03 45 0c             	add    0xc(%ebp),%eax
80104bbc:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80104bc2:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80104bc6:	83 7d fc 09          	cmpl   $0x9,-0x4(%ebp)
80104bca:	7e e7                	jle    80104bb3 <getcallerpcs+0x54>
    pcs[i] = 0;
}
80104bcc:	c9                   	leave  
80104bcd:	c3                   	ret    
...
80104bd8:	74 17                	je     80104bf1 <holding+0x23>
80104bda:	8b 45 08             	mov    0x8(%ebp),%eax
80104bdd:	8b 50 08             	mov    0x8(%eax),%edx
80104be0:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104be6:	39 c2                	cmp    %eax,%edx
80104be8:	75 07                	jne    80104bf1 <holding+0x23>
80104bea:	b8 01 00 00 00       	mov    $0x1,%eax
80104bef:	eb 05                	jmp    80104bf6 <holding+0x28>
80104bf1:	b8 00 00 00 00       	mov    $0x0,%eax
}
80104bf6:	5d                   	pop    %ebp
80104bf7:	c3                   	ret    
...
80104bfb:	83 ec 10             	sub    $0x10,%esp
  int eflags;
  
  eflags = readeflags();
80104bfe:	e8 55 fe ff ff       	call   80104a58 <readeflags>
80104c03:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
80104c06:	e8 5d fe ff ff       	call   80104a68 <cli>
  if(cpu->ncli++ == 0)
80104c0b:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104c11:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80104c17:	85 d2                	test   %edx,%edx
80104c19:	0f 94 c1             	sete   %cl
80104c1c:	83 c2 01             	add    $0x1,%edx
80104c1f:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80104c25:	84 c9                	test   %cl,%cl
80104c27:	74 15                	je     80104c3e <pushcli+0x46>
    cpu->intena = eflags & FL_IF;
80104c29:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104c2f:	8b 55 fc             	mov    -0x4(%ebp),%edx
80104c32:	81 e2 00 02 00 00    	and    $0x200,%edx
...
80104c43:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
80104c46:	e8 0d fe ff ff       	call   80104a58 <readeflags>
80104c4b:	25 00 02 00 00       	and    $0x200,%eax
80104c50:	85 c0                	test   %eax,%eax
80104c52:	74 0c                	je     80104c60 <popcli+0x20>
    panic("popcli - interruptible");
80104c54:	c7 04 24 05 84 10 80 	movl   $0x80108405,(%esp)
80104c5b:	e8 da b8 ff ff       	call   8010053a <panic>
  if(--cpu->ncli < 0)
80104c60:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104c66:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80104c6c:	83 ea 01             	sub    $0x1,%edx
80104c6f:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80104c75:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104c7b:	85 c0                	test   %eax,%eax
80104c7d:	79 0c                	jns    80104c8b <popcli+0x4b>
    panic("popcli");
80104c7f:	c7 04 24 1c 84 10 80 	movl   $0x8010841c,(%esp)
...
80104c99:	75 15                	jne    80104cb0 <popcli+0x70>
80104c9b:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104ca1:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80104ca7:	85 c0                	test   %eax,%eax
80104ca9:	74 05                	je     80104cb0 <popcli+0x70>
    sti();
80104cab:	e8 be fd ff ff       	call   80104a6e <sti>
}
80104cb0:	c9                   	leave  
80104cb1:	c3                   	ret    
	...
...
80104cbc:	8b 55 10             	mov    0x10(%ebp),%edx
80104cbf:	8b 45 0c             	mov    0xc(%ebp),%eax
80104cc2:	89 cb                	mov    %ecx,%ebx
80104cc4:	89 df                	mov    %ebx,%edi
80104cc6:	89 d1                	mov    %edx,%ecx
80104cc8:	fc                   	cld    
80104cc9:	f3 aa                	rep stos %al,%es:(%edi)
80104ccb:	89 ca                	mov    %ecx,%edx
80104ccd:	89 fb                	mov    %edi,%ebx
80104ccf:	89 5d 08             	mov    %ebx,0x8(%ebp)
...
80104cde:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104ce1:	8b 55 10             	mov    0x10(%ebp),%edx
80104ce4:	8b 45 0c             	mov    0xc(%ebp),%eax
80104ce7:	89 cb                	mov    %ecx,%ebx
80104ce9:	89 df                	mov    %ebx,%edi
80104ceb:	89 d1                	mov    %edx,%ecx
80104ced:	fc                   	cld    
80104cee:	f3 ab                	rep stos %eax,%es:(%edi)
80104cf0:	89 ca                	mov    %ecx,%edx
80104cf2:	89 fb                	mov    %edi,%ebx
80104cf4:	89 5d 08             	mov    %ebx,0x8(%ebp)
80104cf7:	89 55 10             	mov    %edx,0x10(%ebp)
               "=D" (addr), "=c" (cnt) :
               "0" (addr), "1" (cnt), "a" (data) :
               "memory", "cc");
}
...
80104d07:	83 e0 03             	and    $0x3,%eax
80104d0a:	85 c0                	test   %eax,%eax
80104d0c:	75 49                	jne    80104d57 <memset+0x59>
80104d0e:	8b 45 10             	mov    0x10(%ebp),%eax
80104d11:	83 e0 03             	and    $0x3,%eax
80104d14:	85 c0                	test   %eax,%eax
80104d16:	75 3f                	jne    80104d57 <memset+0x59>
    c &= 0xFF;
80104d18:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80104d1f:	8b 45 10             	mov    0x10(%ebp),%eax
80104d22:	c1 e8 02             	shr    $0x2,%eax
80104d25:	89 c2                	mov    %eax,%edx
80104d27:	8b 45 0c             	mov    0xc(%ebp),%eax
80104d2a:	89 c1                	mov    %eax,%ecx
80104d2c:	c1 e1 18             	shl    $0x18,%ecx
80104d2f:	8b 45 0c             	mov    0xc(%ebp),%eax
80104d32:	c1 e0 10             	shl    $0x10,%eax
80104d35:	09 c1                	or     %eax,%ecx
80104d37:	8b 45 0c             	mov    0xc(%ebp),%eax
80104d3a:	c1 e0 08             	shl    $0x8,%eax
80104d3d:	09 c8                	or     %ecx,%eax
80104d3f:	0b 45 0c             	or     0xc(%ebp),%eax
80104d42:	89 54 24 08          	mov    %edx,0x8(%esp)
80104d46:	89 44 24 04          	mov    %eax,0x4(%esp)
80104d4a:	8b 45 08             	mov    0x8(%ebp),%eax
80104d4d:	89 04 24             	mov    %eax,(%esp)
80104d50:	e8 84 ff ff ff       	call   80104cd9 <stosl>
#include "x86.h"
...
{
  if ((int)dst%4 == 0 && n%4 == 0){
80104d55:	eb 19                	jmp    80104d70 <memset+0x72>
    c &= 0xFF;
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
  } else
    stosb(dst, c, n);
80104d57:	8b 45 10             	mov    0x10(%ebp),%eax
80104d5a:	89 44 24 08          	mov    %eax,0x8(%esp)
80104d5e:	8b 45 0c             	mov    0xc(%ebp),%eax
80104d61:	89 44 24 04          	mov    %eax,0x4(%esp)
80104d65:	8b 45 08             	mov    0x8(%ebp),%eax
80104d68:	89 04 24             	mov    %eax,(%esp)
80104d6b:	e8 44 ff ff ff       	call   80104cb4 <stosb>
  return dst;
...
80104d7e:	89 45 f8             	mov    %eax,-0x8(%ebp)
  s2 = v2;
80104d81:	8b 45 0c             	mov    0xc(%ebp),%eax
80104d84:	89 45 fc             	mov    %eax,-0x4(%ebp)
  while(n-- > 0){
80104d87:	eb 32                	jmp    80104dbb <memcmp+0x46>
    if(*s1 != *s2)
...
80104d97:	74 1a                	je     80104db3 <memcmp+0x3e>
      return *s1 - *s2;
80104d99:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104d9c:	0f b6 00             	movzbl (%eax),%eax
80104d9f:	0f b6 d0             	movzbl %al,%edx
80104da2:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104da5:	0f b6 00             	movzbl (%eax),%eax
80104da8:	0f b6 c0             	movzbl %al,%eax
80104dab:	89 d1                	mov    %edx,%ecx
80104dad:	29 c1                	sub    %eax,%ecx
80104daf:	89 c8                	mov    %ecx,%eax
80104db1:	eb 1c                	jmp    80104dcf <memcmp+0x5a>
    s1++, s2++;
80104db3:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80104db7:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
{
  const uchar *s1, *s2;
  ...
  s2 = v2;
  while(n-- > 0){
80104dbb:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80104dbf:	0f 95 c0             	setne  %al
80104dc2:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80104dc6:	84 c0                	test   %al,%al
80104dc8:	75 bf                	jne    80104d89 <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
  ...
  return 0;
80104dca:	b8 00 00 00 00       	mov    $0x0,%eax
}
80104dcf:	c9                   	leave  
80104dd0:	c3                   	ret    
...
80104dda:	89 45 f8             	mov    %eax,-0x8(%ebp)
  d = dst;
80104ddd:	8b 45 08             	mov    0x8(%ebp),%eax
80104de0:	89 45 fc             	mov    %eax,-0x4(%ebp)
  if(s < d && s + n > d){
80104de3:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104de6:	3b 45 fc             	cmp    -0x4(%ebp),%eax
80104de9:	73 55                	jae    80104e40 <memmove+0x6f>
80104deb:	8b 45 10             	mov    0x10(%ebp),%eax
80104dee:	8b 55 f8             	mov    -0x8(%ebp),%edx
80104df1:	8d 04 02             	lea    (%edx,%eax,1),%eax
80104df4:	3b 45 fc             	cmp    -0x4(%ebp),%eax
80104df7:	76 4a                	jbe    80104e43 <memmove+0x72>
    s += n;
80104df9:	8b 45 10             	mov    0x10(%ebp),%eax
80104dfc:	01 45 f8             	add    %eax,-0x8(%ebp)
    d += n;
80104dff:	8b 45 10             	mov    0x10(%ebp),%eax
80104e02:	01 45 fc             	add    %eax,-0x4(%ebp)
    while(n-- > 0)
80104e05:	eb 13                	jmp    80104e1a <memmove+0x49>
      *--d = *--s;
80104e07:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
80104e0b:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
...
80104e18:	88 10                	mov    %dl,(%eax)
  ...
  if(s < d && s + n > d){
    ...
    d += n;
    while(n-- > 0)
80104e1a:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80104e1e:	0f 95 c0             	setne  %al
80104e21:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80104e25:	84 c0                	test   %al,%al
80104e27:	75 de                	jne    80104e07 <memmove+0x36>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80104e29:	eb 28                	jmp    80104e53 <memmove+0x82>
    d += n;
    while(n-- > 0)
      *--d = *--s;
  } else
    while(n-- > 0)
      *d++ = *s++;
80104e2b:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104e2e:	0f b6 10             	movzbl (%eax),%edx
80104e31:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104e34:	88 10                	mov    %dl,(%eax)
80104e36:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80104e3a:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80104e3e:	eb 04                	jmp    80104e44 <memmove+0x73>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
    ...
    while(n-- > 0)
80104e40:	90                   	nop
80104e41:	eb 01                	jmp    80104e44 <memmove+0x73>
80104e43:	90                   	nop
80104e44:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80104e48:	0f 95 c0             	setne  %al
80104e4b:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80104e4f:	84 c0                	test   %al,%al
80104e51:	75 d8                	jne    80104e2b <memmove+0x5a>
      *d++ = *s++;
...
80104e5e:	8b 45 10             	mov    0x10(%ebp),%eax
80104e61:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80104e72:	e8 5a ff ff ff       	call   80104dd1 <memmove>
}
80104e77:	c9                   	leave  
80104e78:	c3                   	ret    
...
80104e7a:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
80104e7c:	eb 0c                	jmp    80104e8a <strncmp+0x11>
    n--, p++, q++;
80104e7e:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80104e82:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80104e86:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
}
...
{
  while(n > 0 && *p && *p == *q)
80104e8a:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80104e8e:	74 1a                	je     80104eaa <strncmp+0x31>
80104e90:	8b 45 08             	mov    0x8(%ebp),%eax
80104e93:	0f b6 00             	movzbl (%eax),%eax
80104e96:	84 c0                	test   %al,%al
80104e98:	74 10                	je     80104eaa <strncmp+0x31>
...
80104ea6:	38 c2                	cmp    %al,%dl
80104ea8:	74 d4                	je     80104e7e <strncmp+0x5>
    n--, p++, q++;
  if(n == 0)
80104eaa:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80104eae:	75 07                	jne    80104eb7 <strncmp+0x3e>
    return 0;
80104eb0:	b8 00 00 00 00       	mov    $0x0,%eax
80104eb5:	eb 18                	jmp    80104ecf <strncmp+0x56>
  return (uchar)*p - (uchar)*q;
80104eb7:	8b 45 08             	mov    0x8(%ebp),%eax
80104eba:	0f b6 00             	movzbl (%eax),%eax
80104ebd:	0f b6 d0             	movzbl %al,%edx
80104ec0:	8b 45 0c             	mov    0xc(%ebp),%eax
80104ec3:	0f b6 00             	movzbl (%eax),%eax
80104ec6:	0f b6 c0             	movzbl %al,%eax
80104ec9:	89 d1                	mov    %edx,%ecx
80104ecb:	29 c1                	sub    %eax,%ecx
80104ecd:	89 c8                	mov    %ecx,%eax
}
80104ecf:	5d                   	pop    %ebp
80104ed0:	c3                   	ret    
...
80104eda:	89 45 fc             	mov    %eax,-0x4(%ebp)
  while(n-- > 0 && (*s++ = *t++) != 0)
80104edd:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80104ee1:	0f 9f c0             	setg   %al
80104ee4:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80104ee8:	84 c0                	test   %al,%al
80104eea:	74 30                	je     80104f1c <strncpy+0x4b>
80104eec:	8b 45 0c             	mov    0xc(%ebp),%eax
80104eef:	0f b6 10             	movzbl (%eax),%edx
80104ef2:	8b 45 08             	mov    0x8(%ebp),%eax
80104ef5:	88 10                	mov    %dl,(%eax)
80104ef7:	8b 45 08             	mov    0x8(%ebp),%eax
80104efa:	0f b6 00             	movzbl (%eax),%eax
80104efd:	84 c0                	test   %al,%al
80104eff:	0f 95 c0             	setne  %al
80104f02:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80104f06:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80104f0a:	84 c0                	test   %al,%al
80104f0c:	75 cf                	jne    80104edd <strncpy+0xc>
    ;
  while(n-- > 0)
80104f0e:	eb 0d                	jmp    80104f1d <strncpy+0x4c>
    *s++ = 0;
80104f10:	8b 45 08             	mov    0x8(%ebp),%eax
80104f13:	c6 00 00             	movb   $0x0,(%eax)
80104f16:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80104f1a:	eb 01                	jmp    80104f1d <strncpy+0x4c>
  char *os;
...
80104f21:	0f 9f c0             	setg   %al
80104f24:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80104f28:	84 c0                	test   %al,%al
80104f2a:	75 e4                	jne    80104f10 <strncpy+0x3f>
    *s++ = 0;
  return os;
80104f2c:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
80104f2f:	c9                   	leave  
80104f30:	c3                   	ret    
...
80104f3a:	89 45 fc             	mov    %eax,-0x4(%ebp)
  if(n <= 0)
80104f3d:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80104f41:	7f 05                	jg     80104f48 <safestrcpy+0x17>
    return os;
80104f43:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104f46:	eb 35                	jmp    80104f7d <safestrcpy+0x4c>
  while(--n > 0 && (*s++ = *t++) != 0)
80104f48:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80104f4c:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80104f50:	7e 22                	jle    80104f74 <safestrcpy+0x43>
...
80104f60:	0f b6 00             	movzbl (%eax),%eax
80104f63:	84 c0                	test   %al,%al
80104f65:	0f 95 c0             	setne  %al
80104f68:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80104f6c:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80104f70:	84 c0                	test   %al,%al
80104f72:	75 d4                	jne    80104f48 <safestrcpy+0x17>
    ;
  *s = 0;
80104f74:	8b 45 08             	mov    0x8(%ebp),%eax
80104f77:	c6 00 00             	movb   $0x0,(%eax)
  return os;
...
80104f82:	83 ec 10             	sub    $0x10,%esp
  ...
  for(n = 0; s[n]; n++)
80104f85:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80104f8c:	eb 04                	jmp    80104f92 <strlen+0x13>
80104f8e:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80104f92:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104f95:	03 45 08             	add    0x8(%ebp),%eax
80104f98:	0f b6 00             	movzbl (%eax),%eax
80104f9b:	84 c0                	test   %al,%al
80104f9d:	75 ef                	jne    80104f8e <strlen+0xf>
    ;
  return n;
...
swtch:
  movl 4(%esp), %eax
80104fa4:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80104fa8:	8b 54 24 08          	mov    0x8(%esp),%edx
...
80104faf:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
80104fb0:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80104fb2:	89 d4                	mov    %edx,%esp
...
80104fc7:	3b 45 08             	cmp    0x8(%ebp),%eax
80104fca:	76 12                	jbe    80104fde <fetchint+0x22>
80104fcc:	8b 45 08             	mov    0x8(%ebp),%eax
80104fcf:	8d 50 04             	lea    0x4(%eax),%edx
80104fd2:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104fd8:	8b 00                	mov    (%eax),%eax
80104fda:	39 c2                	cmp    %eax,%edx
80104fdc:	76 07                	jbe    80104fe5 <fetchint+0x29>
    return -1;
80104fde:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104fe3:	eb 0f                	jmp    80104ff4 <fetchint+0x38>
  *ip = *(int*)(addr);
80104fe5:	8b 45 08             	mov    0x8(%ebp),%eax
80104fe8:	8b 10                	mov    (%eax),%edx
80104fea:	8b 45 0c             	mov    0xc(%ebp),%eax
80104fed:	89 10                	mov    %edx,(%eax)
  return 0;
...
80105004:	3b 45 08             	cmp    0x8(%ebp),%eax
80105007:	77 07                	ja     80105010 <fetchstr+0x1a>
    return -1;
80105009:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010500e:	eb 48                	jmp    80105058 <fetchstr+0x62>
  *pp = (char*)addr;
...
80105026:	8b 00                	mov    (%eax),%eax
80105028:	89 45 f8             	mov    %eax,-0x8(%ebp)
8010502b:	eb 1e                	jmp    8010504b <fetchstr+0x55>
    if(*s == 0)
8010502d:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105030:	0f b6 00             	movzbl (%eax),%eax
80105033:	84 c0                	test   %al,%al
80105035:	75 10                	jne    80105047 <fetchstr+0x51>
      return s - *pp;
80105037:	8b 55 f8             	mov    -0x8(%ebp),%edx
8010503a:	8b 45 0c             	mov    0xc(%ebp),%eax
8010503d:	8b 00                	mov    (%eax),%eax
8010503f:	89 d1                	mov    %edx,%ecx
80105041:	29 c1                	sub    %eax,%ecx
80105043:	89 c8                	mov    %ecx,%eax
80105045:	eb 11                	jmp    80105058 <fetchstr+0x62>
  ...
  *pp = (char*)addr;
  ep = (char*)proc->sz;
  for(s = *pp; s < ep; s++)
80105047:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
8010504b:	8b 45 f8             	mov    -0x8(%ebp),%eax
8010504e:	3b 45 fc             	cmp    -0x4(%ebp),%eax
80105051:	72 da                	jb     8010502d <fetchstr+0x37>
    if(*s == 0)
      return s - *pp;
  return -1;
...
80105066:	8b 40 18             	mov    0x18(%eax),%eax
80105069:	8b 50 44             	mov    0x44(%eax),%edx
8010506c:	8b 45 08             	mov    0x8(%ebp),%eax
8010506f:	c1 e0 02             	shl    $0x2,%eax
80105072:	8d 04 02             	lea    (%edx,%eax,1),%eax
80105075:	8d 50 04             	lea    0x4(%eax),%edx
80105078:	8b 45 0c             	mov    0xc(%ebp),%eax
8010507b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010507f:	89 14 24             	mov    %edx,(%esp)
80105082:	e8 35 ff ff ff       	call   80104fbc <fetchint>
}
80105087:	c9                   	leave  
80105088:	c3                   	ret    
...
801050ee:	83 ec 18             	sub    $0x18,%esp
  int addr;
  if(argint(n, &addr) < 0)
801050f1:	8d 45 fc             	lea    -0x4(%ebp),%eax
801050f4:	89 44 24 04          	mov    %eax,0x4(%esp)
801050f8:	8b 45 08             	mov    0x8(%ebp),%eax
801050fb:	89 04 24             	mov    %eax,(%esp)
801050fe:	e8 57 ff ff ff       	call   8010505a <argint>
80105103:	85 c0                	test   %eax,%eax
80105105:	79 07                	jns    8010510e <argstr+0x23>
    return -1;
80105107:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010510c:	eb 12                	jmp    80105120 <argstr+0x35>
  return fetchstr(addr, pp);
8010510e:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105111:	8b 55 0c             	mov    0xc(%ebp),%edx
80105114:	89 54 24 04          	mov    %edx,0x4(%esp)
80105118:	89 04 24             	mov    %eax,(%esp)
8010511b:	e8 d6 fe ff ff       	call   80104ff6 <fetchstr>
}
80105120:	c9                   	leave  
80105121:	c3                   	ret    
...
80105126:	83 ec 24             	sub    $0x24,%esp
  int num;

  num = proc->tf->eax;
80105129:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010512f:	8b 40 18             	mov    0x18(%eax),%eax
80105132:	8b 40 1c             	mov    0x1c(%eax),%eax
80105135:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80105138:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010513c:	7e 30                	jle    8010516e <syscall+0x4c>
8010513e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105141:	83 f8 15             	cmp    $0x15,%eax
80105144:	77 28                	ja     8010516e <syscall+0x4c>
80105146:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105149:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
80105150:	85 c0                	test   %eax,%eax
80105152:	74 1a                	je     8010516e <syscall+0x4c>
...
syscall(void)
{
  ...
  num = proc->tf->eax;
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
8010516c:	eb 3d                	jmp    801051ab <syscall+0x89>
    proc->tf->eax = syscalls[num]();
  } else {
...
8010518f:	c7 04 24 23 84 10 80 	movl   $0x80108423,(%esp)
80105196:	e8 ff b1 ff ff       	call   8010039a <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
...
801051c7:	e8 8e fe ff ff       	call   8010505a <argint>
801051cc:	85 c0                	test   %eax,%eax
801051ce:	79 07                	jns    801051d7 <argfd+0x23>
    return -1;
801051d0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801051d5:	eb 50                	jmp    80105227 <argfd+0x73>
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
801051d7:	8b 45 f0             	mov    -0x10(%ebp),%eax
801051da:	85 c0                	test   %eax,%eax
801051dc:	78 21                	js     801051ff <argfd+0x4b>
801051de:	8b 45 f0             	mov    -0x10(%ebp),%eax
801051e1:	83 f8 0f             	cmp    $0xf,%eax
801051e4:	7f 19                	jg     801051ff <argfd+0x4b>
801051e6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801051ec:	8b 55 f0             	mov    -0x10(%ebp),%edx
801051ef:	83 c2 08             	add    $0x8,%edx
801051f2:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801051f6:	89 45 f4             	mov    %eax,-0xc(%ebp)
801051f9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801051fd:	75 07                	jne    80105206 <argfd+0x52>
    return -1;
801051ff:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105204:	eb 21                	jmp    80105227 <argfd+0x73>
  if(pfd)
80105206:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
8010520a:	74 08                	je     80105214 <argfd+0x60>
    *pfd = fd;
8010520c:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010520f:	8b 45 0c             	mov    0xc(%ebp),%eax
80105212:	89 10                	mov    %edx,(%eax)
  if(pf)
80105214:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105218:	74 08                	je     80105222 <argfd+0x6e>
    *pf = f;
8010521a:	8b 45 10             	mov    0x10(%ebp),%eax
8010521d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105220:	89 10                	mov    %edx,(%eax)
  return 0;
...
8010522c:	83 ec 10             	sub    $0x10,%esp
  ...
  for(fd = 0; fd < NOFILE; fd++){
8010522f:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80105236:	eb 30                	jmp    80105268 <fdalloc+0x3f>
    if(proc->ofile[fd] == 0){
80105238:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010523e:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105241:	83 c2 08             	add    $0x8,%edx
80105244:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105248:	85 c0                	test   %eax,%eax
8010524a:	75 18                	jne    80105264 <fdalloc+0x3b>
      proc->ofile[fd] = f;
8010524c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105252:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105255:	8d 4a 08             	lea    0x8(%edx),%ecx
80105258:	8b 55 08             	mov    0x8(%ebp),%edx
8010525b:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
      return fd;
8010525f:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105262:	eb 0f                	jmp    80105273 <fdalloc+0x4a>
static int
fdalloc(struct file *f)
{
  int fd;
  ...
  for(fd = 0; fd < NOFILE; fd++){
80105264:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105268:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
8010526c:	7e ca                	jle    80105238 <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
80105278:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int fd;
  
  if(argfd(0, 0, &f) < 0)
8010527b:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010527e:	89 44 24 08          	mov    %eax,0x8(%esp)
80105282:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105289:	00 
8010528a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105291:	e8 1e ff ff ff       	call   801051b4 <argfd>
80105296:	85 c0                	test   %eax,%eax
80105298:	79 07                	jns    801052a1 <sys_dup+0x2c>
    return -1;
8010529a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010529f:	eb 29                	jmp    801052ca <sys_dup+0x55>
  if((fd=fdalloc(f)) < 0)
801052a1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801052a4:	89 04 24             	mov    %eax,(%esp)
801052a7:	e8 7d ff ff ff       	call   80105229 <fdalloc>
801052ac:	89 45 f4             	mov    %eax,-0xc(%ebp)
801052af:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801052b3:	79 07                	jns    801052bc <sys_dup+0x47>
    return -1;
801052b5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801052ba:	eb 0e                	jmp    801052ca <sys_dup+0x55>
  filedup(f);
801052bc:	8b 45 f0             	mov    -0x10(%ebp),%eax
801052bf:	89 04 24             	mov    %eax,(%esp)
801052c2:	e8 b2 bc ff ff       	call   80100f79 <filedup>
  return fd;
...
801052cf:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int n;
  char *p;
...
801052d5:	89 44 24 08          	mov    %eax,0x8(%esp)
801052d9:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801052e0:	00 
801052e1:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801052e8:	e8 c7 fe ff ff       	call   801051b4 <argfd>
801052ed:	85 c0                	test   %eax,%eax
801052ef:	78 35                	js     80105326 <sys_read+0x5a>
801052f1:	8d 45 f0             	lea    -0x10(%ebp),%eax
801052f4:	89 44 24 04          	mov    %eax,0x4(%esp)
801052f8:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801052ff:	e8 56 fd ff ff       	call   8010505a <argint>
80105304:	85 c0                	test   %eax,%eax
80105306:	78 1e                	js     80105326 <sys_read+0x5a>
80105308:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010530b:	89 44 24 08          	mov    %eax,0x8(%esp)
8010530f:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105312:	89 44 24 04          	mov    %eax,0x4(%esp)
80105316:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010531d:	e8 67 fd ff ff       	call   80105089 <argptr>
80105322:	85 c0                	test   %eax,%eax
80105324:	79 07                	jns    8010532d <sys_read+0x61>
    return -1;
80105326:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010532b:	eb 19                	jmp    80105346 <sys_read+0x7a>
  return fileread(f, p, n);
8010532d:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105330:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105333:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105336:	89 4c 24 08          	mov    %ecx,0x8(%esp)
8010533a:	89 54 24 04          	mov    %edx,0x4(%esp)
8010533e:	89 04 24             	mov    %eax,(%esp)
80105341:	e8 a0 bd ff ff       	call   801010e6 <fileread>
}
80105346:	c9                   	leave  
80105347:	c3                   	ret    
...
8010534b:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int n;
  char *p;
...
80105351:	89 44 24 08          	mov    %eax,0x8(%esp)
80105355:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010535c:	00 
8010535d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105364:	e8 4b fe ff ff       	call   801051b4 <argfd>
80105369:	85 c0                	test   %eax,%eax
8010536b:	78 35                	js     801053a2 <sys_write+0x5a>
8010536d:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105370:	89 44 24 04          	mov    %eax,0x4(%esp)
80105374:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
8010537b:	e8 da fc ff ff       	call   8010505a <argint>
80105380:	85 c0                	test   %eax,%eax
80105382:	78 1e                	js     801053a2 <sys_write+0x5a>
80105384:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105387:	89 44 24 08          	mov    %eax,0x8(%esp)
8010538b:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010538e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105392:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105399:	e8 eb fc ff ff       	call   80105089 <argptr>
8010539e:	85 c0                	test   %eax,%eax
801053a0:	79 07                	jns    801053a9 <sys_write+0x61>
    return -1;
801053a2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801053a7:	eb 19                	jmp    801053c2 <sys_write+0x7a>
  return filewrite(f, p, n);
801053a9:	8b 4d f0             	mov    -0x10(%ebp),%ecx
801053ac:	8b 55 ec             	mov    -0x14(%ebp),%edx
801053af:	8b 45 f4             	mov    -0xc(%ebp),%eax
801053b2:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801053b6:	89 54 24 04          	mov    %edx,0x4(%esp)
801053ba:	89 04 24             	mov    %eax,(%esp)
801053bd:	e8 e0 bd ff ff       	call   801011a2 <filewrite>
}
801053c2:	c9                   	leave  
801053c3:	c3                   	ret    
...
801053c7:	83 ec 28             	sub    $0x28,%esp
  int fd;
  struct file *f;
  
  if(argfd(0, &fd, &f) < 0)
801053ca:	8d 45 f0             	lea    -0x10(%ebp),%eax
801053cd:	89 44 24 08          	mov    %eax,0x8(%esp)
801053d1:	8d 45 f4             	lea    -0xc(%ebp),%eax
801053d4:	89 44 24 04          	mov    %eax,0x4(%esp)
801053d8:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801053df:	e8 d0 fd ff ff       	call   801051b4 <argfd>
801053e4:	85 c0                	test   %eax,%eax
801053e6:	79 07                	jns    801053ef <sys_close+0x2b>
    return -1;
801053e8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801053ed:	eb 24                	jmp    80105413 <sys_close+0x4f>
  proc->ofile[fd] = 0;
801053ef:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801053f5:	8b 55 f4             	mov    -0xc(%ebp),%edx
801053f8:	83 c2 08             	add    $0x8,%edx
801053fb:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80105402:	00 
  fileclose(f);
80105403:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105406:	89 04 24             	mov    %eax,(%esp)
80105409:	e8 b3 bb ff ff       	call   80100fc1 <fileclose>
  return 0;
...
80105431:	e8 7e fd ff ff       	call   801051b4 <argfd>
80105436:	85 c0                	test   %eax,%eax
80105438:	78 1f                	js     80105459 <sys_fstat+0x44>
8010543a:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010543d:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80105444:	00 
80105445:	89 44 24 04          	mov    %eax,0x4(%esp)
80105449:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105450:	e8 34 fc ff ff       	call   80105089 <argptr>
80105455:	85 c0                	test   %eax,%eax
80105457:	79 07                	jns    80105460 <sys_fstat+0x4b>
    return -1;
80105459:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010545e:	eb 12                	jmp    80105472 <sys_fstat+0x5d>
  return filestat(f, st);
80105460:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105463:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105466:	89 54 24 04          	mov    %edx,0x4(%esp)
8010546a:	89 04 24             	mov    %eax,(%esp)
8010546d:	e8 25 bc ff ff       	call   80101097 <filestat>
}
80105472:	c9                   	leave  
80105473:	c3                   	ret    
...
80105477:	83 ec 38             	sub    $0x38,%esp
  char name[DIRSIZ], *new, *old;
  struct inode *dp, *ip;

  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
8010547a:	8d 45 d8             	lea    -0x28(%ebp),%eax
8010547d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105481:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105488:	e8 5e fc ff ff       	call   801050eb <argstr>
8010548d:	85 c0                	test   %eax,%eax
8010548f:	78 17                	js     801054a8 <sys_link+0x34>
80105491:	8d 45 dc             	lea    -0x24(%ebp),%eax
80105494:	89 44 24 04          	mov    %eax,0x4(%esp)
80105498:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010549f:	e8 47 fc ff ff       	call   801050eb <argstr>
801054a4:	85 c0                	test   %eax,%eax
801054a6:	79 0a                	jns    801054b2 <sys_link+0x3e>
    return -1;
801054a8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801054ad:	e9 3c 01 00 00       	jmp    801055ee <sys_link+0x17a>
  if((ip = namei(old)) == 0)
801054b2:	8b 45 d8             	mov    -0x28(%ebp),%eax
801054b5:	89 04 24             	mov    %eax,(%esp)
801054b8:	e8 5a cf ff ff       	call   80102417 <namei>
801054bd:	89 45 f4             	mov    %eax,-0xc(%ebp)
801054c0:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801054c4:	75 0a                	jne    801054d0 <sys_link+0x5c>
    return -1;
801054c6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801054cb:	e9 1e 01 00 00       	jmp    801055ee <sys_link+0x17a>

  begin_trans();
801054d0:	e8 31 dd ff ff       	call   80103206 <begin_trans>

  ilock(ip);
801054d5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054d8:	89 04 24             	mov    %eax,(%esp)
801054db:	e8 8f c3 ff ff       	call   8010186f <ilock>
  if(ip->type == T_DIR){
801054e0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054e3:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801054e7:	66 83 f8 01          	cmp    $0x1,%ax
801054eb:	75 1a                	jne    80105507 <sys_link+0x93>
    iunlockput(ip);
801054ed:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054f0:	89 04 24             	mov    %eax,(%esp)
801054f3:	e8 fe c5 ff ff       	call   80101af6 <iunlockput>
    commit_trans();
801054f8:	e8 52 dd ff ff       	call   8010324f <commit_trans>
    return -1;
801054fd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105502:	e9 e7 00 00 00       	jmp    801055ee <sys_link+0x17a>
  }

  ip->nlink++;
80105507:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010550a:	0f b7 40 16          	movzwl 0x16(%eax),%eax
8010550e:	8d 50 01             	lea    0x1(%eax),%edx
80105511:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105514:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80105518:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010551b:	89 04 24             	mov    %eax,(%esp)
8010551e:	e8 8c c1 ff ff       	call   801016af <iupdate>
  iunlock(ip);
80105523:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105526:	89 04 24             	mov    %eax,(%esp)
80105529:	e8 92 c4 ff ff       	call   801019c0 <iunlock>

  if((dp = nameiparent(new, name)) == 0)
8010552e:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105531:	8d 55 e2             	lea    -0x1e(%ebp),%edx
80105534:	89 54 24 04          	mov    %edx,0x4(%esp)
80105538:	89 04 24             	mov    %eax,(%esp)
8010553b:	e8 f9 ce ff ff       	call   80102439 <nameiparent>
80105540:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105543:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105547:	74 68                	je     801055b1 <sys_link+0x13d>
    goto bad;
  ilock(dp);
80105549:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010554c:	89 04 24             	mov    %eax,(%esp)
8010554f:	e8 1b c3 ff ff       	call   8010186f <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80105554:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105557:	8b 10                	mov    (%eax),%edx
80105559:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010555c:	8b 00                	mov    (%eax),%eax
8010555e:	39 c2                	cmp    %eax,%edx
80105560:	75 20                	jne    80105582 <sys_link+0x10e>
80105562:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105565:	8b 40 04             	mov    0x4(%eax),%eax
80105568:	89 44 24 08          	mov    %eax,0x8(%esp)
8010556c:	8d 45 e2             	lea    -0x1e(%ebp),%eax
8010556f:	89 44 24 04          	mov    %eax,0x4(%esp)
80105573:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105576:	89 04 24             	mov    %eax,(%esp)
80105579:	e8 d8 cb ff ff       	call   80102156 <dirlink>
8010557e:	85 c0                	test   %eax,%eax
80105580:	79 0d                	jns    8010558f <sys_link+0x11b>
    iunlockput(dp);
80105582:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105585:	89 04 24             	mov    %eax,(%esp)
80105588:	e8 69 c5 ff ff       	call   80101af6 <iunlockput>
    goto bad;
8010558d:	eb 23                	jmp    801055b2 <sys_link+0x13e>
  }
  iunlockput(dp);
8010558f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105592:	89 04 24             	mov    %eax,(%esp)
80105595:	e8 5c c5 ff ff       	call   80101af6 <iunlockput>
  iput(ip);
8010559a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010559d:	89 04 24             	mov    %eax,(%esp)
801055a0:	e8 80 c4 ff ff       	call   80101a25 <iput>

  commit_trans();
801055a5:	e8 a5 dc ff ff       	call   8010324f <commit_trans>

  return 0;
801055aa:	b8 00 00 00 00       	mov    $0x0,%eax
801055af:	eb 3d                	jmp    801055ee <sys_link+0x17a>
  ip->nlink++;
  iupdate(ip);
  iunlock(ip);
...
801055b8:	e8 b2 c2 ff ff       	call   8010186f <ilock>
  ip->nlink--;
801055bd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801055c0:	0f b7 40 16          	movzwl 0x16(%eax),%eax
801055c4:	8d 50 ff             	lea    -0x1(%eax),%edx
801055c7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801055ca:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
801055ce:	8b 45 f4             	mov    -0xc(%ebp),%eax
801055d1:	89 04 24             	mov    %eax,(%esp)
801055d4:	e8 d6 c0 ff ff       	call   801016af <iupdate>
  iunlockput(ip);
801055d9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801055dc:	89 04 24             	mov    %eax,(%esp)
801055df:	e8 12 c5 ff ff       	call   80101af6 <iunlockput>
  commit_trans();
801055e4:	e8 66 dc ff ff       	call   8010324f <commit_trans>
  return -1;
...
801055f3:	83 ec 38             	sub    $0x38,%esp
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
801055f6:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
801055fd:	eb 4b                	jmp    8010564a <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801055ff:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105602:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105605:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
8010560c:	00 
8010560d:	89 54 24 08          	mov    %edx,0x8(%esp)
80105611:	89 44 24 04          	mov    %eax,0x4(%esp)
80105615:	8b 45 08             	mov    0x8(%ebp),%eax
80105618:	89 04 24             	mov    %eax,(%esp)
8010561b:	e8 48 c7 ff ff       	call   80101d68 <readi>
80105620:	83 f8 10             	cmp    $0x10,%eax
80105623:	74 0c                	je     80105631 <isdirempty+0x41>
      panic("isdirempty: readi");
80105625:	c7 04 24 3f 84 10 80 	movl   $0x8010843f,(%esp)
8010562c:	e8 09 af ff ff       	call   8010053a <panic>
    if(de.inum != 0)
80105631:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
80105635:	66 85 c0             	test   %ax,%ax
80105638:	74 07                	je     80105641 <isdirempty+0x51>
      return 0;
8010563a:	b8 00 00 00 00       	mov    $0x0,%eax
8010563f:	eb 1b                	jmp    8010565c <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
80105661:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
80105664:	8d 45 cc             	lea    -0x34(%ebp),%eax
80105667:	89 44 24 04          	mov    %eax,0x4(%esp)
8010566b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105672:	e8 74 fa ff ff       	call   801050eb <argstr>
80105677:	85 c0                	test   %eax,%eax
80105679:	79 0a                	jns    80105685 <sys_unlink+0x27>
    return -1;
8010567b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105680:	e9 aa 01 00 00       	jmp    8010582f <sys_unlink+0x1d1>
  if((dp = nameiparent(path, name)) == 0)
80105685:	8b 45 cc             	mov    -0x34(%ebp),%eax
80105688:	8d 55 d2             	lea    -0x2e(%ebp),%edx
8010568b:	89 54 24 04          	mov    %edx,0x4(%esp)
8010568f:	89 04 24             	mov    %eax,(%esp)
80105692:	e8 a2 cd ff ff       	call   80102439 <nameiparent>
80105697:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010569a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010569e:	75 0a                	jne    801056aa <sys_unlink+0x4c>
    return -1;
801056a0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801056a5:	e9 85 01 00 00       	jmp    8010582f <sys_unlink+0x1d1>

  begin_trans();
801056aa:	e8 57 db ff ff       	call   80103206 <begin_trans>

  ilock(dp);
801056af:	8b 45 f4             	mov    -0xc(%ebp),%eax
801056b2:	89 04 24             	mov    %eax,(%esp)
801056b5:	e8 b5 c1 ff ff       	call   8010186f <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
801056ba:	c7 44 24 04 51 84 10 	movl   $0x80108451,0x4(%esp)
801056c1:	80 
801056c2:	8d 45 d2             	lea    -0x2e(%ebp),%eax
801056c5:	89 04 24             	mov    %eax,(%esp)
801056c8:	e8 9f c9 ff ff       	call   8010206c <namecmp>
801056cd:	85 c0                	test   %eax,%eax
801056cf:	0f 84 45 01 00 00    	je     8010581a <sys_unlink+0x1bc>
801056d5:	c7 44 24 04 53 84 10 	movl   $0x80108453,0x4(%esp)
801056dc:	80 
801056dd:	8d 45 d2             	lea    -0x2e(%ebp),%eax
801056e0:	89 04 24             	mov    %eax,(%esp)
801056e3:	e8 84 c9 ff ff       	call   8010206c <namecmp>
801056e8:	85 c0                	test   %eax,%eax
801056ea:	0f 84 2a 01 00 00    	je     8010581a <sys_unlink+0x1bc>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
801056f0:	8d 45 c8             	lea    -0x38(%ebp),%eax
801056f3:	89 44 24 08          	mov    %eax,0x8(%esp)
801056f7:	8d 45 d2             	lea    -0x2e(%ebp),%eax
801056fa:	89 44 24 04          	mov    %eax,0x4(%esp)
801056fe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105701:	89 04 24             	mov    %eax,(%esp)
80105704:	e8 85 c9 ff ff       	call   8010208e <dirlookup>
80105709:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010570c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105710:	0f 84 03 01 00 00    	je     80105819 <sys_unlink+0x1bb>
    goto bad;
  ilock(ip);
80105716:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105719:	89 04 24             	mov    %eax,(%esp)
8010571c:	e8 4e c1 ff ff       	call   8010186f <ilock>

  if(ip->nlink < 1)
80105721:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105724:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105728:	66 85 c0             	test   %ax,%ax
8010572b:	7f 0c                	jg     80105739 <sys_unlink+0xdb>
    panic("unlink: nlink < 1");
8010572d:	c7 04 24 56 84 10 80 	movl   $0x80108456,(%esp)
80105734:	e8 01 ae ff ff       	call   8010053a <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80105739:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010573c:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105740:	66 83 f8 01          	cmp    $0x1,%ax
80105744:	75 1f                	jne    80105765 <sys_unlink+0x107>
80105746:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105749:	89 04 24             	mov    %eax,(%esp)
8010574c:	e8 9f fe ff ff       	call   801055f0 <isdirempty>
80105751:	85 c0                	test   %eax,%eax
80105753:	75 10                	jne    80105765 <sys_unlink+0x107>
    iunlockput(ip);
80105755:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105758:	89 04 24             	mov    %eax,(%esp)
8010575b:	e8 96 c3 ff ff       	call   80101af6 <iunlockput>
    goto bad;
80105760:	e9 b5 00 00 00       	jmp    8010581a <sys_unlink+0x1bc>
  }

  memset(&de, 0, sizeof(de));
80105765:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
8010576c:	00 
8010576d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105774:	00 
80105775:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105778:	89 04 24             	mov    %eax,(%esp)
8010577b:	e8 7e f5 ff ff       	call   80104cfe <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105780:	8b 55 c8             	mov    -0x38(%ebp),%edx
80105783:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105786:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
8010578d:	00 
...
8010579c:	e8 33 c7 ff ff       	call   80101ed4 <writei>
801057a1:	83 f8 10             	cmp    $0x10,%eax
801057a4:	74 0c                	je     801057b2 <sys_unlink+0x154>
    panic("unlink: writei");
801057a6:	c7 04 24 68 84 10 80 	movl   $0x80108468,(%esp)
801057ad:	e8 88 ad ff ff       	call   8010053a <panic>
  if(ip->type == T_DIR){
801057b2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801057b5:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801057b9:	66 83 f8 01          	cmp    $0x1,%ax
801057bd:	75 1c                	jne    801057db <sys_unlink+0x17d>
    dp->nlink--;
801057bf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801057c2:	0f b7 40 16          	movzwl 0x16(%eax),%eax
801057c6:	8d 50 ff             	lea    -0x1(%eax),%edx
...
801057d6:	e8 d4 be ff ff       	call   801016af <iupdate>
  }
  iunlockput(dp);
801057db:	8b 45 f4             	mov    -0xc(%ebp),%eax
801057de:	89 04 24             	mov    %eax,(%esp)
801057e1:	e8 10 c3 ff ff       	call   80101af6 <iunlockput>
...
801057fd:	e8 ad be ff ff       	call   801016af <iupdate>
  iunlockput(ip);
80105802:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105805:	89 04 24             	mov    %eax,(%esp)
80105808:	e8 e9 c2 ff ff       	call   80101af6 <iunlockput>

  commit_trans();
8010580d:	e8 3d da ff ff       	call   8010324f <commit_trans>

  return 0;
80105812:	b8 00 00 00 00       	mov    $0x0,%eax
80105817:	eb 16                	jmp    8010582f <sys_unlink+0x1d1>
  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    goto bad;
...
80105820:	e8 d1 c2 ff ff       	call   80101af6 <iunlockput>
  commit_trans();
80105825:	e8 25 da ff ff       	call   8010324f <commit_trans>
  return -1;
...
80105834:	83 ec 48             	sub    $0x48,%esp
80105837:	8b 4d 0c             	mov    0xc(%ebp),%ecx
8010583a:	8b 55 10             	mov    0x10(%ebp),%edx
8010583d:	8b 45 14             	mov    0x14(%ebp),%eax
80105840:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
80105844:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
80105848:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
8010584c:	8d 45 de             	lea    -0x22(%ebp),%eax
8010584f:	89 44 24 04          	mov    %eax,0x4(%esp)
80105853:	8b 45 08             	mov    0x8(%ebp),%eax
80105856:	89 04 24             	mov    %eax,(%esp)
80105859:	e8 db cb ff ff       	call   80102439 <nameiparent>
8010585e:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105861:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105865:	75 0a                	jne    80105871 <create+0x40>
    return 0;
80105867:	b8 00 00 00 00       	mov    $0x0,%eax
8010586c:	e9 7e 01 00 00       	jmp    801059ef <create+0x1be>
  ilock(dp);
80105871:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105874:	89 04 24             	mov    %eax,(%esp)
80105877:	e8 f3 bf ff ff       	call   8010186f <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
8010587c:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010587f:	89 44 24 08          	mov    %eax,0x8(%esp)
80105883:	8d 45 de             	lea    -0x22(%ebp),%eax
80105886:	89 44 24 04          	mov    %eax,0x4(%esp)
8010588a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010588d:	89 04 24             	mov    %eax,(%esp)
80105890:	e8 f9 c7 ff ff       	call   8010208e <dirlookup>
80105895:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105898:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010589c:	74 47                	je     801058e5 <create+0xb4>
    iunlockput(dp);
8010589e:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058a1:	89 04 24             	mov    %eax,(%esp)
801058a4:	e8 4d c2 ff ff       	call   80101af6 <iunlockput>
    ilock(ip);
801058a9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801058ac:	89 04 24             	mov    %eax,(%esp)
801058af:	e8 bb bf ff ff       	call   8010186f <ilock>
    if(type == T_FILE && ip->type == T_FILE)
801058b4:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
801058b9:	75 15                	jne    801058d0 <create+0x9f>
801058bb:	8b 45 f0             	mov    -0x10(%ebp),%eax
801058be:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801058c2:	66 83 f8 02          	cmp    $0x2,%ax
801058c6:	75 08                	jne    801058d0 <create+0x9f>
      return ip;
801058c8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801058cb:	e9 1f 01 00 00       	jmp    801059ef <create+0x1be>
    iunlockput(ip);
801058d0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801058d3:	89 04 24             	mov    %eax,(%esp)
801058d6:	e8 1b c2 ff ff       	call   80101af6 <iunlockput>
    return 0;
801058db:	b8 00 00 00 00       	mov    $0x0,%eax
801058e0:	e9 0a 01 00 00       	jmp    801059ef <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
801058e5:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
801058e9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058ec:	8b 00                	mov    (%eax),%eax
801058ee:	89 54 24 04          	mov    %edx,0x4(%esp)
801058f2:	89 04 24             	mov    %eax,(%esp)
801058f5:	e8 d8 bc ff ff       	call   801015d2 <ialloc>
801058fa:	89 45 f0             	mov    %eax,-0x10(%ebp)
801058fd:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105901:	75 0c                	jne    8010590f <create+0xde>
    panic("create: ialloc");
80105903:	c7 04 24 77 84 10 80 	movl   $0x80108477,(%esp)
8010590a:	e8 2b ac ff ff       	call   8010053a <panic>

  ilock(ip);
8010590f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105912:	89 04 24             	mov    %eax,(%esp)
80105915:	e8 55 bf ff ff       	call   8010186f <ilock>
  ip->major = major;
8010591a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010591d:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
80105921:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
80105925:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105928:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
8010592c:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
80105930:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105933:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
80105939:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010593c:	89 04 24             	mov    %eax,(%esp)
8010593f:	e8 6b bd ff ff       	call   801016af <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80105944:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80105949:	75 6a                	jne    801059b5 <create+0x184>
    dp->nlink++;  // for ".."
...
80105962:	e8 48 bd ff ff       	call   801016af <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80105967:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010596a:	8b 40 04             	mov    0x4(%eax),%eax
8010596d:	89 44 24 08          	mov    %eax,0x8(%esp)
80105971:	c7 44 24 04 51 84 10 	movl   $0x80108451,0x4(%esp)
80105978:	80 
80105979:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010597c:	89 04 24             	mov    %eax,(%esp)
8010597f:	e8 d2 c7 ff ff       	call   80102156 <dirlink>
80105984:	85 c0                	test   %eax,%eax
80105986:	78 21                	js     801059a9 <create+0x178>
80105988:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010598b:	8b 40 04             	mov    0x4(%eax),%eax
8010598e:	89 44 24 08          	mov    %eax,0x8(%esp)
80105992:	c7 44 24 04 53 84 10 	movl   $0x80108453,0x4(%esp)
80105999:	80 
8010599a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010599d:	89 04 24             	mov    %eax,(%esp)
801059a0:	e8 b1 c7 ff ff       	call   80102156 <dirlink>
801059a5:	85 c0                	test   %eax,%eax
801059a7:	79 0c                	jns    801059b5 <create+0x184>
      panic("create dots");
801059a9:	c7 04 24 86 84 10 80 	movl   $0x80108486,(%esp)
801059b0:	e8 85 ab ff ff       	call   8010053a <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
801059b5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801059b8:	8b 40 04             	mov    0x4(%eax),%eax
801059bb:	89 44 24 08          	mov    %eax,0x8(%esp)
801059bf:	8d 45 de             	lea    -0x22(%ebp),%eax
801059c2:	89 44 24 04          	mov    %eax,0x4(%esp)
801059c6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059c9:	89 04 24             	mov    %eax,(%esp)
801059cc:	e8 85 c7 ff ff       	call   80102156 <dirlink>
801059d1:	85 c0                	test   %eax,%eax
801059d3:	79 0c                	jns    801059e1 <create+0x1b0>
    panic("create: dirlink");
801059d5:	c7 04 24 92 84 10 80 	movl   $0x80108492,(%esp)
801059dc:	e8 59 ab ff ff       	call   8010053a <panic>

  iunlockput(dp);
801059e1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059e4:	89 04 24             	mov    %eax,(%esp)
801059e7:	e8 0a c1 ff ff       	call   80101af6 <iunlockput>
...
801059f4:	83 ec 38             	sub    $0x38,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
801059f7:	8d 45 e8             	lea    -0x18(%ebp),%eax
801059fa:	89 44 24 04          	mov    %eax,0x4(%esp)
801059fe:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105a05:	e8 e1 f6 ff ff       	call   801050eb <argstr>
80105a0a:	85 c0                	test   %eax,%eax
80105a0c:	78 17                	js     80105a25 <sys_open+0x34>
80105a0e:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105a11:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a15:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105a1c:	e8 39 f6 ff ff       	call   8010505a <argint>
80105a21:	85 c0                	test   %eax,%eax
80105a23:	79 0a                	jns    80105a2f <sys_open+0x3e>
    return -1;
80105a25:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a2a:	e9 46 01 00 00       	jmp    80105b75 <sys_open+0x184>
  if(omode & O_CREATE){
80105a2f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105a32:	25 00 02 00 00       	and    $0x200,%eax
80105a37:	85 c0                	test   %eax,%eax
80105a39:	74 40                	je     80105a7b <sys_open+0x8a>
    begin_trans();
80105a3b:	e8 c6 d7 ff ff       	call   80103206 <begin_trans>
    ip = create(path, T_FILE, 0, 0);
80105a40:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105a43:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80105a4a:	00 
80105a4b:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80105a52:	00 
80105a53:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
80105a5a:	00 
80105a5b:	89 04 24             	mov    %eax,(%esp)
80105a5e:	e8 ce fd ff ff       	call   80105831 <create>
80105a63:	89 45 f4             	mov    %eax,-0xc(%ebp)
    commit_trans();
80105a66:	e8 e4 d7 ff ff       	call   8010324f <commit_trans>
    if(ip == 0)
80105a6b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105a6f:	75 5c                	jne    80105acd <sys_open+0xdc>
      return -1;
80105a71:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a76:	e9 fa 00 00 00       	jmp    80105b75 <sys_open+0x184>
  } else {
    if((ip = namei(path)) == 0)
80105a7b:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105a7e:	89 04 24             	mov    %eax,(%esp)
80105a81:	e8 91 c9 ff ff       	call   80102417 <namei>
80105a86:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105a89:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105a8d:	75 0a                	jne    80105a99 <sys_open+0xa8>
      return -1;
80105a8f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a94:	e9 dc 00 00 00       	jmp    80105b75 <sys_open+0x184>
    ilock(ip);
80105a99:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a9c:	89 04 24             	mov    %eax,(%esp)
80105a9f:	e8 cb bd ff ff       	call   8010186f <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80105aa4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105aa7:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105aab:	66 83 f8 01          	cmp    $0x1,%ax
80105aaf:	75 1c                	jne    80105acd <sys_open+0xdc>
80105ab1:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105ab4:	85 c0                	test   %eax,%eax
80105ab6:	74 15                	je     80105acd <sys_open+0xdc>
      iunlockput(ip);
80105ab8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105abb:	89 04 24             	mov    %eax,(%esp)
80105abe:	e8 33 c0 ff ff       	call   80101af6 <iunlockput>
      return -1;
80105ac3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ac8:	e9 a8 00 00 00       	jmp    80105b75 <sys_open+0x184>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80105acd:	e8 46 b4 ff ff       	call   80100f18 <filealloc>
80105ad2:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105ad5:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105ad9:	74 14                	je     80105aef <sys_open+0xfe>
80105adb:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ade:	89 04 24             	mov    %eax,(%esp)
80105ae1:	e8 43 f7 ff ff       	call   80105229 <fdalloc>
80105ae6:	89 45 ec             	mov    %eax,-0x14(%ebp)
80105ae9:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80105aed:	79 23                	jns    80105b12 <sys_open+0x121>
    if(f)
80105aef:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105af3:	74 0b                	je     80105b00 <sys_open+0x10f>
      fileclose(f);
80105af5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105af8:	89 04 24             	mov    %eax,(%esp)
80105afb:	e8 c1 b4 ff ff       	call   80100fc1 <fileclose>
    iunlockput(ip);
80105b00:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b03:	89 04 24             	mov    %eax,(%esp)
80105b06:	e8 eb bf ff ff       	call   80101af6 <iunlockput>
    return -1;
80105b0b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b10:	eb 63                	jmp    80105b75 <sys_open+0x184>
  }
  iunlock(ip);
80105b12:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b15:	89 04 24             	mov    %eax,(%esp)
80105b18:	e8 a3 be ff ff       	call   801019c0 <iunlock>

  f->type = FD_INODE;
80105b1d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b20:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
80105b26:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b29:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105b2c:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
80105b2f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b32:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
80105b39:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105b3c:	83 e0 01             	and    $0x1,%eax
80105b3f:	85 c0                	test   %eax,%eax
80105b41:	0f 94 c2             	sete   %dl
...
80105b52:	75 0a                	jne    80105b5e <sys_open+0x16d>
80105b54:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105b57:	83 e0 02             	and    $0x2,%eax
80105b5a:	85 c0                	test   %eax,%eax
80105b5c:	74 07                	je     80105b65 <sys_open+0x174>
80105b5e:	b8 01 00 00 00       	mov    $0x1,%eax
80105b63:	eb 05                	jmp    80105b6a <sys_open+0x179>
...
80105b7a:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_trans();
80105b7d:	e8 84 d6 ff ff       	call   80103206 <begin_trans>
...
80105b90:	e8 56 f5 ff ff       	call   801050eb <argstr>
...
80105bd7:	e8 1a bf ff ff       	call   80101af6 <iunlockput>
  commit_trans();
80105bdc:	e8 6e d6 ff ff       	call   8010324f <commit_trans>
  return 0;
...
80105c1d:	e8 38 f4 ff ff       	call   8010505a <argint>
  char *path;
  int len;
  int major, minor;
...
80105c34:	e8 21 f4 ff ff       	call   8010505a <argint>
  char *path;
  int len;
  int major, minor;
...
80105c5f:	e8 cd fb ff ff       	call   80105831 <create>
  char *path;
  int len;
  int major, minor;
...
80105c6b:	75 0c                	jne    80105c79 <sys_mknod+0x91>
     ...
     (ip = create(path, T_DEV, major, minor)) == 0){
    commit_trans();
80105c6d:	e8 dd d5 ff ff       	call   8010324f <commit_trans>
    return -1;
...
80105c7f:	e8 72 be ff ff       	call   80101af6 <iunlockput>
  commit_trans();
80105c84:	e8 c6 d5 ff ff       	call   8010324f <commit_trans>
  return 0;
...
80105ca4:	e8 42 f4 ff ff       	call   801050eb <argstr>
...
80105cb3:	e8 5f c7 ff ff       	call   80102417 <namei>
...
80105cce:	e8 9c bb ff ff       	call   8010186f <ilock>
  if(ip->type != T_DIR){
...
80105ce6:	e8 0b be ff ff       	call   80101af6 <iunlockput>
    return -1;
...
80105d38:	e8 ae f3 ff ff       	call   801050eb <argstr>
...
80105d7e:	e8 7b ef ff ff       	call   80104cfe <memset>
  for(i=0;; i++){
...
80105d97:	e9 96 00 00 00       	jmp    80105e32 <sys_exec+0x111>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80105d9c:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
80105da2:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105da5:	c1 e2 02             	shl    $0x2,%edx
80105da8:	89 d1                	mov    %edx,%ecx
80105daa:	8b 95 6c ff ff ff    	mov    -0x94(%ebp),%edx
80105db0:	8d 14 11             	lea    (%ecx,%edx,1),%edx
80105db3:	89 44 24 04          	mov    %eax,0x4(%esp)
80105db7:	89 14 24             	mov    %edx,(%esp)
80105dba:	e8 fd f1 ff ff       	call   80104fbc <fetchint>
80105dbf:	85 c0                	test   %eax,%eax
80105dc1:	79 07                	jns    80105dca <sys_exec+0xa9>
      return -1;
80105dc3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105dc8:	eb 68                	jmp    80105e32 <sys_exec+0x111>
    if(uarg == 0){
80105dca:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80105dd0:	85 c0                	test   %eax,%eax
80105dd2:	75 26                	jne    80105dfa <sys_exec+0xd9>
      argv[i] = 0;
80105dd4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105dd7:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
80105dde:	00 00 00 00 
      break;
80105de2:	90                   	nop
    }
...
80105de6:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
80105dec:	89 54 24 04          	mov    %edx,0x4(%esp)
80105df0:	89 04 24             	mov    %eax,(%esp)
80105df3:	e8 00 ad ff ff       	call   80100af8 <exec>
80105df8:	eb 38                	jmp    80105e32 <sys_exec+0x111>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
...
80105dfd:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80105e04:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80105e0a:	01 d0                	add    %edx,%eax
80105e0c:	8b 95 68 ff ff ff    	mov    -0x98(%ebp),%edx
80105e12:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e16:	89 14 24             	mov    %edx,(%esp)
80105e19:	e8 d8 f1 ff ff       	call   80104ff6 <fetchstr>
80105e1e:	85 c0                	test   %eax,%eax
80105e20:	79 07                	jns    80105e29 <sys_exec+0x108>
      return -1;
80105e22:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e27:	eb 09                	jmp    80105e32 <sys_exec+0x111>
  ...
  memset(argv, 0, sizeof(argv));
  for(i=0;; i++){
80105e29:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
...
80105e2d:	e9 58 ff ff ff       	jmp    80105d8a <sys_exec+0x69>
  return exec(path, argv);
}
80105e32:	c9                   	leave  
80105e33:	c3                   	ret    
...
80105e3d:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
80105e44:	00 
80105e45:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e49:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105e50:	e8 34 f2 ff ff       	call   80105089 <argptr>
80105e55:	85 c0                	test   %eax,%eax
80105e57:	79 0a                	jns    80105e63 <sys_pipe+0x2f>
    return -1;
80105e59:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e5e:	e9 9b 00 00 00       	jmp    80105efe <sys_pipe+0xca>
  if(pipealloc(&rf, &wf) < 0)
80105e63:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105e66:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e6a:	8d 45 e8             	lea    -0x18(%ebp),%eax
80105e6d:	89 04 24             	mov    %eax,(%esp)
80105e70:	e8 83 dd ff ff       	call   80103bf8 <pipealloc>
80105e75:	85 c0                	test   %eax,%eax
80105e77:	79 07                	jns    80105e80 <sys_pipe+0x4c>
    return -1;
80105e79:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e7e:	eb 7e                	jmp    80105efe <sys_pipe+0xca>
  fd0 = -1;
80105e80:	c7 45 f0 ff ff ff ff 	movl   $0xffffffff,-0x10(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80105e87:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105e8a:	89 04 24             	mov    %eax,(%esp)
80105e8d:	e8 97 f3 ff ff       	call   80105229 <fdalloc>
80105e92:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105e95:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105e99:	78 14                	js     80105eaf <sys_pipe+0x7b>
80105e9b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105e9e:	89 04 24             	mov    %eax,(%esp)
80105ea1:	e8 83 f3 ff ff       	call   80105229 <fdalloc>
80105ea6:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105ea9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105ead:	79 37                	jns    80105ee6 <sys_pipe+0xb2>
    if(fd0 >= 0)
80105eaf:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105eb3:	78 14                	js     80105ec9 <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
80105eb5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105ebb:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105ebe:	83 c2 08             	add    $0x8,%edx
80105ec1:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80105ec8:	00 
    fileclose(rf);
80105ec9:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105ecc:	89 04 24             	mov    %eax,(%esp)
80105ecf:	e8 ed b0 ff ff       	call   80100fc1 <fileclose>
    fileclose(wf);
80105ed4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105ed7:	89 04 24             	mov    %eax,(%esp)
80105eda:	e8 e2 b0 ff ff       	call   80100fc1 <fileclose>
    return -1;
80105edf:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ee4:	eb 18                	jmp    80105efe <sys_pipe+0xca>
  }
  fd[0] = fd0;
80105ee6:	8b 45 ec             	mov    -0x14(%ebp),%eax
80105ee9:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105eec:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
80105eee:	8b 45 ec             	mov    -0x14(%ebp),%eax
80105ef1:	8d 50 04             	lea    0x4(%eax),%edx
80105ef4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ef7:	89 02                	mov    %eax,(%edx)
  return 0;
...
80105f03:	83 ec 08             	sub    $0x8,%esp
  return fork();
80105f06:	e8 9c e3 ff ff       	call   801042a7 <fork>
}
80105f0b:	c9                   	leave  
80105f0c:	c3                   	ret    
...
80105f10:	83 ec 08             	sub    $0x8,%esp
  exit();
80105f13:	e8 f2 e4 ff ff       	call   8010440a <exit>
...
80105f22:	83 ec 08             	sub    $0x8,%esp
  return wait();
80105f25:	e8 f9 e5 ff ff       	call   80104523 <wait>
}
80105f2a:	c9                   	leave  
80105f2b:	c3                   	ret    
...
80105f2f:	83 ec 28             	sub    $0x28,%esp
  int pid;

  if(argint(0, &pid) < 0)
80105f32:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105f35:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f39:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105f40:	e8 15 f1 ff ff       	call   8010505a <argint>
80105f45:	85 c0                	test   %eax,%eax
80105f47:	79 07                	jns    80105f50 <sys_kill+0x24>
    return -1;
80105f49:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f4e:	eb 0b                	jmp    80105f5b <sys_kill+0x2f>
  return kill(pid);
80105f50:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f53:	89 04 24             	mov    %eax,(%esp)
80105f56:	e8 87 e9 ff ff       	call   801048e2 <kill>
}
80105f5b:	c9                   	leave  
80105f5c:	c3                   	ret    
...
80105f5e:	89 e5                	mov    %esp,%ebp
  return proc->pid;
80105f60:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
...
80105f74:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f78:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105f7f:	e8 d6 f0 ff ff       	call   8010505a <argint>
80105f84:	85 c0                	test   %eax,%eax
80105f86:	79 07                	jns    80105f8f <sys_sbrk+0x24>
    return -1;
80105f88:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f8d:	eb 24                	jmp    80105fb3 <sys_sbrk+0x48>
  addr = proc->sz;
...
80105fa0:	e8 5d e2 ff ff       	call   80104202 <growproc>
80105fa5:	85 c0                	test   %eax,%eax
80105fa7:	79 07                	jns    80105fb0 <sys_sbrk+0x45>
    return -1;
80105fa9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105fae:	eb 03                	jmp    80105fb3 <sys_sbrk+0x48>
  return addr;
...
80105fc9:	e8 8c f0 ff ff       	call   8010505a <argint>
80105fce:	85 c0                	test   %eax,%eax
80105fd0:	79 07                	jns    80105fd9 <sys_sleep+0x24>
    return -1;
80105fd2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105fd7:	eb 6c                	jmp    80106045 <sys_sleep+0x90>
  acquire(&tickslock);
80105fd9:	c7 04 24 60 1e 11 80 	movl   $0x80111e60,(%esp)
80105fe0:	e8 ca ea ff ff       	call   80104aaf <acquire>
  ticks0 = ticks;
80105fe5:	a1 a0 26 11 80       	mov    0x801126a0,%eax
80105fea:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
80105fed:	eb 34                	jmp    80106023 <sys_sleep+0x6e>
    if(proc->killed){
80105fef:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105ff5:	8b 40 24             	mov    0x24(%eax),%eax
80105ff8:	85 c0                	test   %eax,%eax
80105ffa:	74 13                	je     8010600f <sys_sleep+0x5a>
      release(&tickslock);
80105ffc:	c7 04 24 60 1e 11 80 	movl   $0x80111e60,(%esp)
80106003:	e8 08 eb ff ff       	call   80104b10 <release>
      return -1;
80106008:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010600d:	eb 36                	jmp    80106045 <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
8010600f:	c7 44 24 04 60 1e 11 	movl   $0x80111e60,0x4(%esp)
80106016:	80 
80106017:	c7 04 24 a0 26 11 80 	movl   $0x801126a0,(%esp)
8010601e:	e8 ba e7 ff ff       	call   801047dd <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80106023:	a1 a0 26 11 80       	mov    0x801126a0,%eax
80106028:	89 c2                	mov    %eax,%edx
8010602a:	2b 55 f4             	sub    -0xc(%ebp),%edx
8010602d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106030:	39 c2                	cmp    %eax,%edx
80106032:	72 bb                	jb     80105fef <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
80106034:	c7 04 24 60 1e 11 80 	movl   $0x80111e60,(%esp)
8010603b:	e8 d0 ea ff ff       	call   80104b10 <release>
  return 0;
...
8010604a:	83 ec 28             	sub    $0x28,%esp
  uint xticks;
  
  acquire(&tickslock);
8010604d:	c7 04 24 60 1e 11 80 	movl   $0x80111e60,(%esp)
80106054:	e8 56 ea ff ff       	call   80104aaf <acquire>
  xticks = ticks;
80106059:	a1 a0 26 11 80       	mov    0x801126a0,%eax
8010605e:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
80106061:	c7 04 24 60 1e 11 80 	movl   $0x80111e60,(%esp)
80106068:	e8 a3 ea ff ff       	call   80104b10 <release>
  return xticks;
...
8010607a:	8b 55 08             	mov    0x8(%ebp),%edx
8010607d:	8b 45 0c             	mov    0xc(%ebp),%eax
80106080:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106084:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106087:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
8010608b:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
8010608f:	ee                   	out    %al,(%dx)
}
80106090:	c9                   	leave  
80106091:	c3                   	ret    
...
80106095:	83 ec 18             	sub    $0x18,%esp
  // Interrupt 100 times/sec.
  outb(TIMER_MODE, TIMER_SEL0 | TIMER_RATEGEN | TIMER_16BIT);
80106098:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
8010609f:	00 
801060a0:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
801060a7:	e8 c8 ff ff ff       	call   80106074 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
801060ac:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
801060b3:	00 
801060b4:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
801060bb:	e8 b4 ff ff ff       	call   80106074 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
801060c0:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
801060c7:	00 
801060c8:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
801060cf:	e8 a0 ff ff ff       	call   80106074 <outb>
  picenable(IRQ_TIMER);
801060d4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801060db:	e8 a1 d9 ff ff       	call   80103a81 <picenable>
}
801060e0:	c9                   	leave  
801060e1:	c3                   	ret    
	...
...
801060e5:	06                   	push   %es
  pushl %fs
801060e6:	0f a0                	push   %fs
  pushl %gs
801060e8:	0f a8                	push   %gs
  pushal
801060ea:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
801060eb:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801060ef:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801060f1:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
801060f3:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
801060f7:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
801060f9:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
801060fb:	54                   	push   %esp
  call trap
801060fc:	e8 d5 01 00 00       	call   801062d6 <trap>
  addl $4, %esp
80106101:	83 c4 04             	add    $0x4,%esp
...
80106104:	61                   	popa   
  popl %gs
80106105:	0f a9                	pop    %gs
  popl %fs
80106107:	0f a1                	pop    %fs
  popl %es
80106109:	07                   	pop    %es
  popl %ds
8010610a:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
8010610b:	83 c4 08             	add    $0x8,%esp
  iret
8010610e:	cf                   	iret   
	...
...
80106113:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
80106116:	8b 45 0c             	mov    0xc(%ebp),%eax
80106119:	83 e8 01             	sub    $0x1,%eax
8010611c:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80106120:	8b 45 08             	mov    0x8(%ebp),%eax
80106123:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80106127:	8b 45 08             	mov    0x8(%ebp),%eax
8010612a:	c1 e8 10             	shr    $0x10,%eax
8010612d:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lidt (%0)" : : "r" (pd));
80106131:	8d 45 fa             	lea    -0x6(%ebp),%eax
80106134:	0f 01 18             	lidtl  (%eax)
}
80106137:	c9                   	leave  
80106138:	c3                   	ret    
...
8010613f:	0f 20 d0             	mov    %cr2,%eax
80106142:	89 45 fc             	mov    %eax,-0x4(%ebp)
  return val;
80106145:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
80106148:	c9                   	leave  
80106149:	c3                   	ret    
...
8010614d:	83 ec 28             	sub    $0x28,%esp
  ...
  for(i = 0; i < 256; i++)
80106150:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106157:	e9 bf 00 00 00       	jmp    8010621b <tvinit+0xd1>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
8010615c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010615f:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106162:	8b 14 95 98 b0 10 80 	mov    -0x7fef4f68(,%edx,4),%edx
80106169:	66 89 14 c5 a0 1e 11 	mov    %dx,-0x7feee160(,%eax,8)
80106170:	80 
80106171:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106174:	66 c7 04 c5 a2 1e 11 	movw   $0x8,-0x7feee15e(,%eax,8)
8010617b:	80 08 00 
8010617e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106181:	0f b6 14 c5 a4 1e 11 	movzbl -0x7feee15c(,%eax,8),%edx
80106188:	80 
80106189:	83 e2 e0             	and    $0xffffffe0,%edx
8010618c:	88 14 c5 a4 1e 11 80 	mov    %dl,-0x7feee15c(,%eax,8)
80106193:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106196:	0f b6 14 c5 a4 1e 11 	movzbl -0x7feee15c(,%eax,8),%edx
8010619d:	80 
8010619e:	83 e2 1f             	and    $0x1f,%edx
801061a1:	88 14 c5 a4 1e 11 80 	mov    %dl,-0x7feee15c(,%eax,8)
801061a8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061ab:	0f b6 14 c5 a5 1e 11 	movzbl -0x7feee15b(,%eax,8),%edx
801061b2:	80 
801061b3:	83 e2 f0             	and    $0xfffffff0,%edx
801061b6:	83 ca 0e             	or     $0xe,%edx
801061b9:	88 14 c5 a5 1e 11 80 	mov    %dl,-0x7feee15b(,%eax,8)
801061c0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061c3:	0f b6 14 c5 a5 1e 11 	movzbl -0x7feee15b(,%eax,8),%edx
801061ca:	80 
801061cb:	83 e2 ef             	and    $0xffffffef,%edx
801061ce:	88 14 c5 a5 1e 11 80 	mov    %dl,-0x7feee15b(,%eax,8)
801061d5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061d8:	0f b6 14 c5 a5 1e 11 	movzbl -0x7feee15b(,%eax,8),%edx
801061df:	80 
801061e0:	83 e2 9f             	and    $0xffffff9f,%edx
801061e3:	88 14 c5 a5 1e 11 80 	mov    %dl,-0x7feee15b(,%eax,8)
801061ea:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061ed:	0f b6 14 c5 a5 1e 11 	movzbl -0x7feee15b(,%eax,8),%edx
801061f4:	80 
801061f5:	83 ca 80             	or     $0xffffff80,%edx
801061f8:	88 14 c5 a5 1e 11 80 	mov    %dl,-0x7feee15b(,%eax,8)
801061ff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106202:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106205:	8b 14 95 98 b0 10 80 	mov    -0x7fef4f68(,%edx,4),%edx
8010620c:	c1 ea 10             	shr    $0x10,%edx
8010620f:	66 89 14 c5 a6 1e 11 	mov    %dx,-0x7feee15a(,%eax,8)
80106216:	80 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
80106217:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
8010621b:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
80106222:	0f 8e 34 ff ff ff    	jle    8010615c <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106228:	a1 98 b1 10 80       	mov    0x8010b198,%eax
8010622d:	66 a3 a0 20 11 80    	mov    %ax,0x801120a0
80106233:	66 c7 05 a2 20 11 80 	movw   $0x8,0x801120a2
8010623a:	08 00 
8010623c:	0f b6 05 a4 20 11 80 	movzbl 0x801120a4,%eax
80106243:	83 e0 e0             	and    $0xffffffe0,%eax
80106246:	a2 a4 20 11 80       	mov    %al,0x801120a4
8010624b:	0f b6 05 a4 20 11 80 	movzbl 0x801120a4,%eax
80106252:	83 e0 1f             	and    $0x1f,%eax
80106255:	a2 a4 20 11 80       	mov    %al,0x801120a4
8010625a:	0f b6 05 a5 20 11 80 	movzbl 0x801120a5,%eax
80106261:	83 c8 0f             	or     $0xf,%eax
80106264:	a2 a5 20 11 80       	mov    %al,0x801120a5
80106269:	0f b6 05 a5 20 11 80 	movzbl 0x801120a5,%eax
80106270:	83 e0 ef             	and    $0xffffffef,%eax
80106273:	a2 a5 20 11 80       	mov    %al,0x801120a5
80106278:	0f b6 05 a5 20 11 80 	movzbl 0x801120a5,%eax
8010627f:	83 c8 60             	or     $0x60,%eax
80106282:	a2 a5 20 11 80       	mov    %al,0x801120a5
80106287:	0f b6 05 a5 20 11 80 	movzbl 0x801120a5,%eax
8010628e:	83 c8 80             	or     $0xffffff80,%eax
80106291:	a2 a5 20 11 80       	mov    %al,0x801120a5
80106296:	a1 98 b1 10 80       	mov    0x8010b198,%eax
8010629b:	c1 e8 10             	shr    $0x10,%eax
8010629e:	66 a3 a6 20 11 80    	mov    %ax,0x801120a6
  
  initlock(&tickslock, "time");
801062a4:	c7 44 24 04 a4 84 10 	movl   $0x801084a4,0x4(%esp)
801062ab:	80 
801062ac:	c7 04 24 60 1e 11 80 	movl   $0x80111e60,(%esp)
801062b3:	e8 d6 e7 ff ff       	call   80104a8e <initlock>
}
801062b8:	c9                   	leave  
801062b9:	c3                   	ret    
...
801062bd:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
801062c0:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
801062c7:	00 
801062c8:	c7 04 24 a0 1e 11 80 	movl   $0x80111ea0,(%esp)
801062cf:	e8 3c fe ff ff       	call   80106110 <lidt>
}
801062d4:	c9                   	leave  
801062d5:	c3                   	ret    
...
801062dc:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
801062df:	8b 45 08             	mov    0x8(%ebp),%eax
801062e2:	8b 40 30             	mov    0x30(%eax),%eax
801062e5:	83 f8 40             	cmp    $0x40,%eax
801062e8:	75 3e                	jne    80106328 <trap+0x52>
    if(proc->killed)
801062ea:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801062f0:	8b 40 24             	mov    0x24(%eax),%eax
801062f3:	85 c0                	test   %eax,%eax
801062f5:	74 05                	je     801062fc <trap+0x26>
      exit();
801062f7:	e8 0e e1 ff ff       	call   8010440a <exit>
    proc->tf = tf;
801062fc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106302:	8b 55 08             	mov    0x8(%ebp),%edx
80106305:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
80106308:	e8 15 ee ff ff       	call   80105122 <syscall>
    if(proc->killed)
8010630d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106313:	8b 40 24             	mov    0x24(%eax),%eax
80106316:	85 c0                	test   %eax,%eax
80106318:	0f 84 34 02 00 00    	je     80106552 <trap+0x27c>
      exit();
8010631e:	e8 e7 e0 ff ff       	call   8010440a <exit>
    return;
80106323:	e9 2b 02 00 00       	jmp    80106553 <trap+0x27d>
  }

  switch(tf->trapno){
80106328:	8b 45 08             	mov    0x8(%ebp),%eax
8010632b:	8b 40 30             	mov    0x30(%eax),%eax
8010632e:	83 e8 20             	sub    $0x20,%eax
80106331:	83 f8 1f             	cmp    $0x1f,%eax
80106334:	0f 87 bc 00 00 00    	ja     801063f6 <trap+0x120>
8010633a:	8b 04 85 4c 85 10 80 	mov    -0x7fef7ab4(,%eax,4),%eax
80106341:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
80106343:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106349:	0f b6 00             	movzbl (%eax),%eax
8010634c:	84 c0                	test   %al,%al
8010634e:	75 31                	jne    80106381 <trap+0xab>
      acquire(&tickslock);
80106350:	c7 04 24 60 1e 11 80 	movl   $0x80111e60,(%esp)
80106357:	e8 53 e7 ff ff       	call   80104aaf <acquire>
      ticks++;
8010635c:	a1 a0 26 11 80       	mov    0x801126a0,%eax
80106361:	83 c0 01             	add    $0x1,%eax
80106364:	a3 a0 26 11 80       	mov    %eax,0x801126a0
      wakeup(&ticks);
80106369:	c7 04 24 a0 26 11 80 	movl   $0x801126a0,(%esp)
80106370:	e8 42 e5 ff ff       	call   801048b7 <wakeup>
      release(&tickslock);
80106375:	c7 04 24 60 1e 11 80 	movl   $0x80111e60,(%esp)
8010637c:	e8 8f e7 ff ff       	call   80104b10 <release>
    }
    lapiceoi();
80106381:	e8 4e cb ff ff       	call   80102ed4 <lapiceoi>
    break;
80106386:	e9 41 01 00 00       	jmp    801064cc <trap+0x1f6>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
8010638b:	e8 5f c3 ff ff       	call   801026ef <ideintr>
    lapiceoi();
80106390:	e8 3f cb ff ff       	call   80102ed4 <lapiceoi>
    break;
80106395:	e9 32 01 00 00       	jmp    801064cc <trap+0x1f6>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
8010639a:	e8 18 c9 ff ff       	call   80102cb7 <kbdintr>
    lapiceoi();
8010639f:	e8 30 cb ff ff       	call   80102ed4 <lapiceoi>
    break;
801063a4:	e9 23 01 00 00       	jmp    801064cc <trap+0x1f6>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
801063a9:	e8 9d 03 00 00       	call   8010674b <uartintr>
    lapiceoi();
801063ae:	e8 21 cb ff ff       	call   80102ed4 <lapiceoi>
    break;
801063b3:	e9 14 01 00 00       	jmp    801064cc <trap+0x1f6>
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801063b8:	8b 45 08             	mov    0x8(%ebp),%eax
801063bb:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
801063be:	8b 45 08             	mov    0x8(%ebp),%eax
801063c1:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801063c5:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
801063c8:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801063ce:	0f b6 00             	movzbl (%eax),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801063d1:	0f b6 c0             	movzbl %al,%eax
801063d4:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801063d8:	89 54 24 08          	mov    %edx,0x8(%esp)
801063dc:	89 44 24 04          	mov    %eax,0x4(%esp)
801063e0:	c7 04 24 ac 84 10 80 	movl   $0x801084ac,(%esp)
801063e7:	e8 ae 9f ff ff       	call   8010039a <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
801063ec:	e8 e3 ca ff ff       	call   80102ed4 <lapiceoi>
    break;
801063f1:	e9 d6 00 00 00       	jmp    801064cc <trap+0x1f6>
   
  //PAGEBREAK: 13
  default:
    if(proc == 0 || (tf->cs&3) == 0){
801063f6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801063fc:	85 c0                	test   %eax,%eax
801063fe:	74 11                	je     80106411 <trap+0x13b>
80106400:	8b 45 08             	mov    0x8(%ebp),%eax
80106403:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106407:	0f b7 c0             	movzwl %ax,%eax
8010640a:	83 e0 03             	and    $0x3,%eax
8010640d:	85 c0                	test   %eax,%eax
8010640f:	75 46                	jne    80106457 <trap+0x181>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106411:	e8 23 fd ff ff       	call   80106139 <rcr2>
80106416:	8b 55 08             	mov    0x8(%ebp),%edx
80106419:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
8010641c:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80106423:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106426:	0f b6 ca             	movzbl %dl,%ecx
80106429:	8b 55 08             	mov    0x8(%ebp),%edx
8010642c:	8b 52 30             	mov    0x30(%edx),%edx
8010642f:	89 44 24 10          	mov    %eax,0x10(%esp)
80106433:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80106437:	89 4c 24 08          	mov    %ecx,0x8(%esp)
8010643b:	89 54 24 04          	mov    %edx,0x4(%esp)
8010643f:	c7 04 24 d0 84 10 80 	movl   $0x801084d0,(%esp)
80106446:	e8 4f 9f ff ff       	call   8010039a <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
8010644b:	c7 04 24 02 85 10 80 	movl   $0x80108502,(%esp)
80106452:	e8 e3 a0 ff ff       	call   8010053a <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106457:	e8 dd fc ff ff       	call   80106139 <rcr2>
8010645c:	89 c2                	mov    %eax,%edx
8010645e:	8b 45 08             	mov    0x8(%ebp),%eax
80106461:	8b 78 38             	mov    0x38(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106464:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010646a:	0f b6 00             	movzbl (%eax),%eax
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010646d:	0f b6 f0             	movzbl %al,%esi
80106470:	8b 45 08             	mov    0x8(%ebp),%eax
80106473:	8b 58 34             	mov    0x34(%eax),%ebx
80106476:	8b 45 08             	mov    0x8(%ebp),%eax
80106479:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
8010647c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106482:	83 c0 6c             	add    $0x6c,%eax
...
80106491:	89 54 24 1c          	mov    %edx,0x1c(%esp)
80106495:	89 7c 24 18          	mov    %edi,0x18(%esp)
80106499:	89 74 24 14          	mov    %esi,0x14(%esp)
8010649d:	89 5c 24 10          	mov    %ebx,0x10(%esp)
801064a1:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801064a5:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801064a8:	89 54 24 08          	mov    %edx,0x8(%esp)
801064ac:	89 44 24 04          	mov    %eax,0x4(%esp)
801064b0:	c7 04 24 08 85 10 80 	movl   $0x80108508,(%esp)
801064b7:	e8 de 9e ff ff       	call   8010039a <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
801064bc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801064c2:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
801064c9:	eb 01                	jmp    801064cc <trap+0x1f6>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
801064d4:	74 24                	je     801064fa <trap+0x224>
801064d6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801064dc:	8b 40 24             	mov    0x24(%eax),%eax
801064df:	85 c0                	test   %eax,%eax
801064e1:	74 17                	je     801064fa <trap+0x224>
801064e3:	8b 45 08             	mov    0x8(%ebp),%eax
801064e6:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
801064ea:	0f b7 c0             	movzwl %ax,%eax
801064ed:	83 e0 03             	and    $0x3,%eax
801064f0:	83 f8 03             	cmp    $0x3,%eax
801064f3:	75 05                	jne    801064fa <trap+0x224>
    exit();
801064f5:	e8 10 df ff ff       	call   8010440a <exit>
...
80106502:	74 1e                	je     80106522 <trap+0x24c>
80106504:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010650a:	8b 40 0c             	mov    0xc(%eax),%eax
8010650d:	83 f8 04             	cmp    $0x4,%eax
80106510:	75 10                	jne    80106522 <trap+0x24c>
80106512:	8b 45 08             	mov    0x8(%ebp),%eax
80106515:	8b 40 30             	mov    0x30(%eax),%eax
80106518:	83 f8 20             	cmp    $0x20,%eax
8010651b:	75 05                	jne    80106522 <trap+0x24c>
    yield();
8010651d:	e8 5d e2 ff ff       	call   8010477f <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
80106522:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106528:	85 c0                	test   %eax,%eax
8010652a:	74 27                	je     80106553 <trap+0x27d>
8010652c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106532:	8b 40 24             	mov    0x24(%eax),%eax
80106535:	85 c0                	test   %eax,%eax
80106537:	74 1a                	je     80106553 <trap+0x27d>
80106539:	8b 45 08             	mov    0x8(%ebp),%eax
8010653c:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106540:	0f b7 c0             	movzwl %ax,%eax
80106543:	83 e0 03             	and    $0x3,%eax
80106546:	83 f8 03             	cmp    $0x3,%eax
80106549:	75 08                	jne    80106553 <trap+0x27d>
    exit();
8010654b:	e8 ba de ff ff       	call   8010440a <exit>
80106550:	eb 01                	jmp    80106553 <trap+0x27d>
      exit();
    proc->tf = tf;
    syscall();
    if(proc->killed)
...
80106553:	83 c4 3c             	add    $0x3c,%esp
80106556:	5b                   	pop    %ebx
80106557:	5e                   	pop    %esi
80106558:	5f                   	pop    %edi
80106559:	5d                   	pop    %ebp
...
8010655f:	83 ec 14             	sub    $0x14,%esp
80106562:	8b 45 08             	mov    0x8(%ebp),%eax
80106565:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106569:	0f b7 45 ec          	movzwl -0x14(%ebp),%eax
8010656d:	89 c2                	mov    %eax,%edx
8010656f:	ec                   	in     (%dx),%al
80106570:	88 45 ff             	mov    %al,-0x1(%ebp)
  return data;
80106573:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
80106577:	c9                   	leave  
80106578:	c3                   	ret    
...
8010657f:	8b 55 08             	mov    0x8(%ebp),%edx
80106582:	8b 45 0c             	mov    0xc(%ebp),%eax
80106585:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106589:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
8010658c:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106590:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
...
8010659a:	83 ec 28             	sub    $0x28,%esp
  char *p;

  // Turn off the FIFO
  outb(COM1+2, 0);
8010659d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801065a4:	00 
801065a5:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
801065ac:	e8 c8 ff ff ff       	call   80106579 <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
801065b1:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
801065b8:	00 
801065b9:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
801065c0:	e8 b4 ff ff ff       	call   80106579 <outb>
  outb(COM1+0, 115200/9600);
801065c5:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
801065cc:	00 
801065cd:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801065d4:	e8 a0 ff ff ff       	call   80106579 <outb>
  outb(COM1+1, 0);
801065d9:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801065e0:	00 
801065e1:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
801065e8:	e8 8c ff ff ff       	call   80106579 <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
801065ed:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
801065f4:	00 
801065f5:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
801065fc:	e8 78 ff ff ff       	call   80106579 <outb>
  outb(COM1+4, 0);
80106601:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106608:	00 
80106609:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80106610:	e8 64 ff ff ff       	call   80106579 <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
80106615:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
8010661c:	00 
8010661d:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106624:	e8 50 ff ff ff       	call   80106579 <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
80106629:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106630:	e8 27 ff ff ff       	call   8010655c <inb>
80106635:	3c ff                	cmp    $0xff,%al
80106637:	74 6c                	je     801066a5 <uartinit+0x10e>
    return;
  uart = 1;
80106639:	c7 05 4c b6 10 80 01 	movl   $0x1,0x8010b64c
80106640:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80106643:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
8010664a:	e8 0d ff ff ff       	call   8010655c <inb>
  inb(COM1+0);
8010664f:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106656:	e8 01 ff ff ff       	call   8010655c <inb>
  picenable(IRQ_COM1);
8010665b:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106662:	e8 1a d4 ff ff       	call   80103a81 <picenable>
  ioapicenable(IRQ_COM1, 0);
80106667:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010666e:	00 
8010666f:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106676:	e8 f7 c2 ff ff       	call   80102972 <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
8010667b:	c7 45 f4 cc 85 10 80 	movl   $0x801085cc,-0xc(%ebp)
80106682:	eb 15                	jmp    80106699 <uartinit+0x102>
    uartputc(*p);
80106684:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106687:	0f b6 00             	movzbl (%eax),%eax
8010668a:	0f be c0             	movsbl %al,%eax
8010668d:	89 04 24             	mov    %eax,(%esp)
80106690:	e8 13 00 00 00       	call   801066a8 <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
...
8010669c:	0f b6 00             	movzbl (%eax),%eax
8010669f:	84 c0                	test   %al,%al
801066a1:	75 e1                	jne    80106684 <uartinit+0xed>
801066a3:	eb 01                	jmp    801066a6 <uartinit+0x10f>
  outb(COM1+4, 0);
  outb(COM1+1, 0x01);    // Enable receive interrupts.
...
801066ab:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!uart)
801066ae:	a1 4c b6 10 80       	mov    0x8010b64c,%eax
801066b3:	85 c0                	test   %eax,%eax
801066b5:	74 4d                	je     80106704 <uartputc+0x5c>
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801066b7:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801066be:	eb 10                	jmp    801066d0 <uartputc+0x28>
    microdelay(10);
801066c0:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
801066c7:	e8 2d c8 ff ff       	call   80102ef9 <microdelay>
{
  int i;
...
801066d0:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
801066d4:	7f 16                	jg     801066ec <uartputc+0x44>
801066d6:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
801066dd:	e8 7a fe ff ff       	call   8010655c <inb>
801066e2:	0f b6 c0             	movzbl %al,%eax
801066e5:	83 e0 20             	and    $0x20,%eax
801066e8:	85 c0                	test   %eax,%eax
801066ea:	74 d4                	je     801066c0 <uartputc+0x18>
    microdelay(10);
  outb(COM1+0, c);
801066ec:	8b 45 08             	mov    0x8(%ebp),%eax
801066ef:	0f b6 c0             	movzbl %al,%eax
801066f2:	89 44 24 04          	mov    %eax,0x4(%esp)
801066f6:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801066fd:	e8 77 fe ff ff       	call   80106579 <outb>
80106702:	eb 01                	jmp    80106705 <uartputc+0x5d>
uartputc(int c)
{
  int i;
...
8010670a:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
8010670d:	a1 4c b6 10 80       	mov    0x8010b64c,%eax
80106712:	85 c0                	test   %eax,%eax
80106714:	75 07                	jne    8010671d <uartgetc+0x16>
    return -1;
80106716:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010671b:	eb 2c                	jmp    80106749 <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
8010671d:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106724:	e8 33 fe ff ff       	call   8010655c <inb>
80106729:	0f b6 c0             	movzbl %al,%eax
8010672c:	83 e0 01             	and    $0x1,%eax
8010672f:	85 c0                	test   %eax,%eax
80106731:	75 07                	jne    8010673a <uartgetc+0x33>
    return -1;
80106733:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106738:	eb 0f                	jmp    80106749 <uartgetc+0x42>
  return inb(COM1+0);
8010673a:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106741:	e8 16 fe ff ff       	call   8010655c <inb>
80106746:	0f b6 c0             	movzbl %al,%eax
}
80106749:	c9                   	leave  
8010674a:	c3                   	ret    
...
80106751:	c7 04 24 07 67 10 80 	movl   $0x80106707,(%esp)
80106758:	e8 4e a0 ff ff       	call   801007ab <consoleintr>
}
8010675d:	c9                   	leave  
8010675e:	c3                   	ret    
	...
...
80106762:	6a 00                	push   $0x0
  jmp alltraps
80106764:	e9 7b f9 ff ff       	jmp    801060e4 <alltraps>
...
80106769:	6a 00                	push   $0x0
  pushl $1
8010676b:	6a 01                	push   $0x1
  jmp alltraps
8010676d:	e9 72 f9 ff ff       	jmp    801060e4 <alltraps>
...
80106772:	6a 00                	push   $0x0
  pushl $2
80106774:	6a 02                	push   $0x2
  jmp alltraps
80106776:	e9 69 f9 ff ff       	jmp    801060e4 <alltraps>
...
8010677b:	6a 00                	push   $0x0
  pushl $3
8010677d:	6a 03                	push   $0x3
  jmp alltraps
8010677f:	e9 60 f9 ff ff       	jmp    801060e4 <alltraps>
...
80106784:	6a 00                	push   $0x0
  pushl $4
80106786:	6a 04                	push   $0x4
  jmp alltraps
80106788:	e9 57 f9 ff ff       	jmp    801060e4 <alltraps>
...
8010678d:	6a 00                	push   $0x0
  pushl $5
8010678f:	6a 05                	push   $0x5
  jmp alltraps
80106791:	e9 4e f9 ff ff       	jmp    801060e4 <alltraps>
...
80106796:	6a 00                	push   $0x0
  pushl $6
80106798:	6a 06                	push   $0x6
  jmp alltraps
8010679a:	e9 45 f9 ff ff       	jmp    801060e4 <alltraps>
...
8010679f:	6a 00                	push   $0x0
  pushl $7
801067a1:	6a 07                	push   $0x7
  jmp alltraps
801067a3:	e9 3c f9 ff ff       	jmp    801060e4 <alltraps>

801067a8 <vector8>:
.globl vector8
vector8:
  pushl $8
801067a8:	6a 08                	push   $0x8
  jmp alltraps
801067aa:	e9 35 f9 ff ff       	jmp    801060e4 <alltraps>
...
801067af:	6a 00                	push   $0x0
  pushl $9
801067b1:	6a 09                	push   $0x9
  jmp alltraps
801067b3:	e9 2c f9 ff ff       	jmp    801060e4 <alltraps>

801067b8 <vector10>:
.globl vector10
vector10:
  pushl $10
801067b8:	6a 0a                	push   $0xa
  jmp alltraps
801067ba:	e9 25 f9 ff ff       	jmp    801060e4 <alltraps>

801067bf <vector11>:
.globl vector11
vector11:
  pushl $11
801067bf:	6a 0b                	push   $0xb
  jmp alltraps
801067c1:	e9 1e f9 ff ff       	jmp    801060e4 <alltraps>

801067c6 <vector12>:
.globl vector12
vector12:
  pushl $12
801067c6:	6a 0c                	push   $0xc
  jmp alltraps
801067c8:	e9 17 f9 ff ff       	jmp    801060e4 <alltraps>

801067cd <vector13>:
.globl vector13
vector13:
  pushl $13
801067cd:	6a 0d                	push   $0xd
  jmp alltraps
801067cf:	e9 10 f9 ff ff       	jmp    801060e4 <alltraps>

801067d4 <vector14>:
.globl vector14
vector14:
  pushl $14
801067d4:	6a 0e                	push   $0xe
  jmp alltraps
801067d6:	e9 09 f9 ff ff       	jmp    801060e4 <alltraps>
...
801067db:	6a 00                	push   $0x0
  pushl $15
801067dd:	6a 0f                	push   $0xf
  jmp alltraps
801067df:	e9 00 f9 ff ff       	jmp    801060e4 <alltraps>
...
801067e4:	6a 00                	push   $0x0
  pushl $16
801067e6:	6a 10                	push   $0x10
  jmp alltraps
801067e8:	e9 f7 f8 ff ff       	jmp    801060e4 <alltraps>

801067ed <vector17>:
.globl vector17
vector17:
  pushl $17
801067ed:	6a 11                	push   $0x11
  jmp alltraps
801067ef:	e9 f0 f8 ff ff       	jmp    801060e4 <alltraps>
...
801067f4:	6a 00                	push   $0x0
  pushl $18
801067f6:	6a 12                	push   $0x12
  jmp alltraps
801067f8:	e9 e7 f8 ff ff       	jmp    801060e4 <alltraps>
...
801067fd:	6a 00                	push   $0x0
  pushl $19
801067ff:	6a 13                	push   $0x13
  jmp alltraps
80106801:	e9 de f8 ff ff       	jmp    801060e4 <alltraps>
...
80106806:	6a 00                	push   $0x0
  pushl $20
80106808:	6a 14                	push   $0x14
  jmp alltraps
8010680a:	e9 d5 f8 ff ff       	jmp    801060e4 <alltraps>
...
8010680f:	6a 00                	push   $0x0
  pushl $21
80106811:	6a 15                	push   $0x15
  jmp alltraps
80106813:	e9 cc f8 ff ff       	jmp    801060e4 <alltraps>
...
80106818:	6a 00                	push   $0x0
  pushl $22
8010681a:	6a 16                	push   $0x16
  jmp alltraps
8010681c:	e9 c3 f8 ff ff       	jmp    801060e4 <alltraps>
...
80106821:	6a 00                	push   $0x0
  pushl $23
80106823:	6a 17                	push   $0x17
  jmp alltraps
80106825:	e9 ba f8 ff ff       	jmp    801060e4 <alltraps>
...
8010682a:	6a 00                	push   $0x0
  pushl $24
8010682c:	6a 18                	push   $0x18
  jmp alltraps
8010682e:	e9 b1 f8 ff ff       	jmp    801060e4 <alltraps>
...
80106833:	6a 00                	push   $0x0
  pushl $25
80106835:	6a 19                	push   $0x19
  jmp alltraps
80106837:	e9 a8 f8 ff ff       	jmp    801060e4 <alltraps>
...
8010683c:	6a 00                	push   $0x0
  pushl $26
8010683e:	6a 1a                	push   $0x1a
  jmp alltraps
80106840:	e9 9f f8 ff ff       	jmp    801060e4 <alltraps>
...
80106845:	6a 00                	push   $0x0
  pushl $27
80106847:	6a 1b                	push   $0x1b
  jmp alltraps
80106849:	e9 96 f8 ff ff       	jmp    801060e4 <alltraps>
...
8010684e:	6a 00                	push   $0x0
  pushl $28
80106850:	6a 1c                	push   $0x1c
  jmp alltraps
80106852:	e9 8d f8 ff ff       	jmp    801060e4 <alltraps>
...
80106857:	6a 00                	push   $0x0
  pushl $29
80106859:	6a 1d                	push   $0x1d
  jmp alltraps
8010685b:	e9 84 f8 ff ff       	jmp    801060e4 <alltraps>
...
80106860:	6a 00                	push   $0x0
  pushl $30
80106862:	6a 1e                	push   $0x1e
  jmp alltraps
80106864:	e9 7b f8 ff ff       	jmp    801060e4 <alltraps>
...
80106869:	6a 00                	push   $0x0
  pushl $31
8010686b:	6a 1f                	push   $0x1f
  jmp alltraps
8010686d:	e9 72 f8 ff ff       	jmp    801060e4 <alltraps>
...
80106872:	6a 00                	push   $0x0
  pushl $32
80106874:	6a 20                	push   $0x20
  jmp alltraps
80106876:	e9 69 f8 ff ff       	jmp    801060e4 <alltraps>
...
8010687b:	6a 00                	push   $0x0
  pushl $33
8010687d:	6a 21                	push   $0x21
  jmp alltraps
8010687f:	e9 60 f8 ff ff       	jmp    801060e4 <alltraps>
...
80106884:	6a 00                	push   $0x0
  pushl $34
80106886:	6a 22                	push   $0x22
  jmp alltraps
80106888:	e9 57 f8 ff ff       	jmp    801060e4 <alltraps>
...
8010688d:	6a 00                	push   $0x0
  pushl $35
8010688f:	6a 23                	push   $0x23
  jmp alltraps
80106891:	e9 4e f8 ff ff       	jmp    801060e4 <alltraps>
...
80106896:	6a 00                	push   $0x0
  pushl $36
80106898:	6a 24                	push   $0x24
  jmp alltraps
8010689a:	e9 45 f8 ff ff       	jmp    801060e4 <alltraps>
...
8010689f:	6a 00                	push   $0x0
  pushl $37
801068a1:	6a 25                	push   $0x25
  jmp alltraps
801068a3:	e9 3c f8 ff ff       	jmp    801060e4 <alltraps>
...
801068a8:	6a 00                	push   $0x0
  pushl $38
801068aa:	6a 26                	push   $0x26
  jmp alltraps
801068ac:	e9 33 f8 ff ff       	jmp    801060e4 <alltraps>
...
801068b1:	6a 00                	push   $0x0
  pushl $39
801068b3:	6a 27                	push   $0x27
  jmp alltraps
801068b5:	e9 2a f8 ff ff       	jmp    801060e4 <alltraps>
...
801068ba:	6a 00                	push   $0x0
  pushl $40
801068bc:	6a 28                	push   $0x28
  jmp alltraps
801068be:	e9 21 f8 ff ff       	jmp    801060e4 <alltraps>
...
801068c3:	6a 00                	push   $0x0
  pushl $41
801068c5:	6a 29                	push   $0x29
  jmp alltraps
801068c7:	e9 18 f8 ff ff       	jmp    801060e4 <alltraps>
...
801068cc:	6a 00                	push   $0x0
  pushl $42
801068ce:	6a 2a                	push   $0x2a
  jmp alltraps
801068d0:	e9 0f f8 ff ff       	jmp    801060e4 <alltraps>
...
801068d5:	6a 00                	push   $0x0
  pushl $43
801068d7:	6a 2b                	push   $0x2b
  jmp alltraps
801068d9:	e9 06 f8 ff ff       	jmp    801060e4 <alltraps>
...
801068de:	6a 00                	push   $0x0
  pushl $44
801068e0:	6a 2c                	push   $0x2c
  jmp alltraps
801068e2:	e9 fd f7 ff ff       	jmp    801060e4 <alltraps>
...
801068e7:	6a 00                	push   $0x0
  pushl $45
801068e9:	6a 2d                	push   $0x2d
  jmp alltraps
801068eb:	e9 f4 f7 ff ff       	jmp    801060e4 <alltraps>
...
801068f0:	6a 00                	push   $0x0
  pushl $46
801068f2:	6a 2e                	push   $0x2e
  jmp alltraps
801068f4:	e9 eb f7 ff ff       	jmp    801060e4 <alltraps>
...
801068f9:	6a 00                	push   $0x0
  pushl $47
801068fb:	6a 2f                	push   $0x2f
  jmp alltraps
801068fd:	e9 e2 f7 ff ff       	jmp    801060e4 <alltraps>
...
80106902:	6a 00                	push   $0x0
  pushl $48
80106904:	6a 30                	push   $0x30
  jmp alltraps
80106906:	e9 d9 f7 ff ff       	jmp    801060e4 <alltraps>
...
8010690b:	6a 00                	push   $0x0
  pushl $49
8010690d:	6a 31                	push   $0x31
  jmp alltraps
8010690f:	e9 d0 f7 ff ff       	jmp    801060e4 <alltraps>
...
80106914:	6a 00                	push   $0x0
  pushl $50
80106916:	6a 32                	push   $0x32
  jmp alltraps
80106918:	e9 c7 f7 ff ff       	jmp    801060e4 <alltraps>
...
8010691d:	6a 00                	push   $0x0
  pushl $51
8010691f:	6a 33                	push   $0x33
  jmp alltraps
80106921:	e9 be f7 ff ff       	jmp    801060e4 <alltraps>
...
80106926:	6a 00                	push   $0x0
  pushl $52
80106928:	6a 34                	push   $0x34
  jmp alltraps
8010692a:	e9 b5 f7 ff ff       	jmp    801060e4 <alltraps>
...
8010692f:	6a 00                	push   $0x0
  pushl $53
80106931:	6a 35                	push   $0x35
  jmp alltraps
80106933:	e9 ac f7 ff ff       	jmp    801060e4 <alltraps>
...
80106938:	6a 00                	push   $0x0
  pushl $54
8010693a:	6a 36                	push   $0x36
  jmp alltraps
8010693c:	e9 a3 f7 ff ff       	jmp    801060e4 <alltraps>
...
80106941:	6a 00                	push   $0x0
  pushl $55
80106943:	6a 37                	push   $0x37
  jmp alltraps
80106945:	e9 9a f7 ff ff       	jmp    801060e4 <alltraps>
...
8010694a:	6a 00                	push   $0x0
  pushl $56
8010694c:	6a 38                	push   $0x38
  jmp alltraps
8010694e:	e9 91 f7 ff ff       	jmp    801060e4 <alltraps>
...
80106953:	6a 00                	push   $0x0
  pushl $57
80106955:	6a 39                	push   $0x39
  jmp alltraps
80106957:	e9 88 f7 ff ff       	jmp    801060e4 <alltraps>
...
8010695c:	6a 00                	push   $0x0
  pushl $58
8010695e:	6a 3a                	push   $0x3a
  jmp alltraps
80106960:	e9 7f f7 ff ff       	jmp    801060e4 <alltraps>
...
80106965:	6a 00                	push   $0x0
  pushl $59
80106967:	6a 3b                	push   $0x3b
  jmp alltraps
80106969:	e9 76 f7 ff ff       	jmp    801060e4 <alltraps>
...
8010696e:	6a 00                	push   $0x0
  pushl $60
80106970:	6a 3c                	push   $0x3c
  jmp alltraps
80106972:	e9 6d f7 ff ff       	jmp    801060e4 <alltraps>
...
80106977:	6a 00                	push   $0x0
  pushl $61
80106979:	6a 3d                	push   $0x3d
  jmp alltraps
8010697b:	e9 64 f7 ff ff       	jmp    801060e4 <alltraps>
...
80106980:	6a 00                	push   $0x0
  pushl $62
80106982:	6a 3e                	push   $0x3e
  jmp alltraps
80106984:	e9 5b f7 ff ff       	jmp    801060e4 <alltraps>
...
80106989:	6a 00                	push   $0x0
  pushl $63
8010698b:	6a 3f                	push   $0x3f
  jmp alltraps
8010698d:	e9 52 f7 ff ff       	jmp    801060e4 <alltraps>
...
80106992:	6a 00                	push   $0x0
  pushl $64
80106994:	6a 40                	push   $0x40
  jmp alltraps
80106996:	e9 49 f7 ff ff       	jmp    801060e4 <alltraps>
...
8010699b:	6a 00                	push   $0x0
  pushl $65
8010699d:	6a 41                	push   $0x41
  jmp alltraps
8010699f:	e9 40 f7 ff ff       	jmp    801060e4 <alltraps>
...
801069a4:	6a 00                	push   $0x0
  pushl $66
801069a6:	6a 42                	push   $0x42
  jmp alltraps
801069a8:	e9 37 f7 ff ff       	jmp    801060e4 <alltraps>
...
801069ad:	6a 00                	push   $0x0
  pushl $67
801069af:	6a 43                	push   $0x43
  jmp alltraps
801069b1:	e9 2e f7 ff ff       	jmp    801060e4 <alltraps>
...
801069b6:	6a 00                	push   $0x0
  pushl $68
801069b8:	6a 44                	push   $0x44
  jmp alltraps
801069ba:	e9 25 f7 ff ff       	jmp    801060e4 <alltraps>
...
801069bf:	6a 00                	push   $0x0
  pushl $69
801069c1:	6a 45                	push   $0x45
  jmp alltraps
801069c3:	e9 1c f7 ff ff       	jmp    801060e4 <alltraps>
...
801069c8:	6a 00                	push   $0x0
  pushl $70
801069ca:	6a 46                	push   $0x46
  jmp alltraps
801069cc:	e9 13 f7 ff ff       	jmp    801060e4 <alltraps>
...
801069d1:	6a 00                	push   $0x0
  pushl $71
801069d3:	6a 47                	push   $0x47
  jmp alltraps
801069d5:	e9 0a f7 ff ff       	jmp    801060e4 <alltraps>
...
801069da:	6a 00                	push   $0x0
  pushl $72
801069dc:	6a 48                	push   $0x48
  jmp alltraps
801069de:	e9 01 f7 ff ff       	jmp    801060e4 <alltraps>
...
801069e3:	6a 00                	push   $0x0
  pushl $73
801069e5:	6a 49                	push   $0x49
  jmp alltraps
801069e7:	e9 f8 f6 ff ff       	jmp    801060e4 <alltraps>
...
801069ec:	6a 00                	push   $0x0
  pushl $74
801069ee:	6a 4a                	push   $0x4a
  jmp alltraps
801069f0:	e9 ef f6 ff ff       	jmp    801060e4 <alltraps>
...
801069f5:	6a 00                	push   $0x0
  pushl $75
801069f7:	6a 4b                	push   $0x4b
  jmp alltraps
801069f9:	e9 e6 f6 ff ff       	jmp    801060e4 <alltraps>
...
801069fe:	6a 00                	push   $0x0
  pushl $76
80106a00:	6a 4c                	push   $0x4c
  jmp alltraps
80106a02:	e9 dd f6 ff ff       	jmp    801060e4 <alltraps>
...
80106a07:	6a 00                	push   $0x0
  pushl $77
80106a09:	6a 4d                	push   $0x4d
  jmp alltraps
80106a0b:	e9 d4 f6 ff ff       	jmp    801060e4 <alltraps>
...
80106a10:	6a 00                	push   $0x0
  pushl $78
80106a12:	6a 4e                	push   $0x4e
  jmp alltraps
80106a14:	e9 cb f6 ff ff       	jmp    801060e4 <alltraps>
...
80106a19:	6a 00                	push   $0x0
  pushl $79
80106a1b:	6a 4f                	push   $0x4f
  jmp alltraps
80106a1d:	e9 c2 f6 ff ff       	jmp    801060e4 <alltraps>
...
80106a22:	6a 00                	push   $0x0
  pushl $80
80106a24:	6a 50                	push   $0x50
  jmp alltraps
80106a26:	e9 b9 f6 ff ff       	jmp    801060e4 <alltraps>
...
80106a2b:	6a 00                	push   $0x0
  pushl $81
80106a2d:	6a 51                	push   $0x51
  jmp alltraps
80106a2f:	e9 b0 f6 ff ff       	jmp    801060e4 <alltraps>
...
80106a34:	6a 00                	push   $0x0
  pushl $82
80106a36:	6a 52                	push   $0x52
  jmp alltraps
80106a38:	e9 a7 f6 ff ff       	jmp    801060e4 <alltraps>
...
80106a3d:	6a 00                	push   $0x0
  pushl $83
80106a3f:	6a 53                	push   $0x53
  jmp alltraps
80106a41:	e9 9e f6 ff ff       	jmp    801060e4 <alltraps>
...
80106a46:	6a 00                	push   $0x0
  pushl $84
80106a48:	6a 54                	push   $0x54
  jmp alltraps
80106a4a:	e9 95 f6 ff ff       	jmp    801060e4 <alltraps>
...
80106a4f:	6a 00                	push   $0x0
  pushl $85
80106a51:	6a 55                	push   $0x55
  jmp alltraps
80106a53:	e9 8c f6 ff ff       	jmp    801060e4 <alltraps>
...
80106a58:	6a 00                	push   $0x0
  pushl $86
80106a5a:	6a 56                	push   $0x56
  jmp alltraps
80106a5c:	e9 83 f6 ff ff       	jmp    801060e4 <alltraps>
...
80106a61:	6a 00                	push   $0x0
  pushl $87
80106a63:	6a 57                	push   $0x57
  jmp alltraps
80106a65:	e9 7a f6 ff ff       	jmp    801060e4 <alltraps>
...
80106a6a:	6a 00                	push   $0x0
  pushl $88
80106a6c:	6a 58                	push   $0x58
  jmp alltraps
80106a6e:	e9 71 f6 ff ff       	jmp    801060e4 <alltraps>
...
80106a73:	6a 00                	push   $0x0
  pushl $89
80106a75:	6a 59                	push   $0x59
  jmp alltraps
80106a77:	e9 68 f6 ff ff       	jmp    801060e4 <alltraps>
...
80106a7c:	6a 00                	push   $0x0
  pushl $90
80106a7e:	6a 5a                	push   $0x5a
  jmp alltraps
80106a80:	e9 5f f6 ff ff       	jmp    801060e4 <alltraps>
...
80106a85:	6a 00                	push   $0x0
  pushl $91
80106a87:	6a 5b                	push   $0x5b
  jmp alltraps
80106a89:	e9 56 f6 ff ff       	jmp    801060e4 <alltraps>
...
80106a8e:	6a 00                	push   $0x0
  pushl $92
80106a90:	6a 5c                	push   $0x5c
  jmp alltraps
80106a92:	e9 4d f6 ff ff       	jmp    801060e4 <alltraps>
...
80106a97:	6a 00                	push   $0x0
  pushl $93
80106a99:	6a 5d                	push   $0x5d
  jmp alltraps
80106a9b:	e9 44 f6 ff ff       	jmp    801060e4 <alltraps>
...
80106aa0:	6a 00                	push   $0x0
  pushl $94
80106aa2:	6a 5e                	push   $0x5e
  jmp alltraps
80106aa4:	e9 3b f6 ff ff       	jmp    801060e4 <alltraps>
...
80106aa9:	6a 00                	push   $0x0
  pushl $95
80106aab:	6a 5f                	push   $0x5f
  jmp alltraps
80106aad:	e9 32 f6 ff ff       	jmp    801060e4 <alltraps>
...
80106ab2:	6a 00                	push   $0x0
  pushl $96
80106ab4:	6a 60                	push   $0x60
  jmp alltraps
80106ab6:	e9 29 f6 ff ff       	jmp    801060e4 <alltraps>
...
80106abb:	6a 00                	push   $0x0
  pushl $97
80106abd:	6a 61                	push   $0x61
  jmp alltraps
80106abf:	e9 20 f6 ff ff       	jmp    801060e4 <alltraps>
...
80106ac4:	6a 00                	push   $0x0
  pushl $98
80106ac6:	6a 62                	push   $0x62
  jmp alltraps
80106ac8:	e9 17 f6 ff ff       	jmp    801060e4 <alltraps>
...
80106acd:	6a 00                	push   $0x0
  pushl $99
80106acf:	6a 63                	push   $0x63
  jmp alltraps
80106ad1:	e9 0e f6 ff ff       	jmp    801060e4 <alltraps>
...
80106ad6:	6a 00                	push   $0x0
  pushl $100
80106ad8:	6a 64                	push   $0x64
  jmp alltraps
80106ada:	e9 05 f6 ff ff       	jmp    801060e4 <alltraps>
...
80106adf:	6a 00                	push   $0x0
  pushl $101
80106ae1:	6a 65                	push   $0x65
  jmp alltraps
80106ae3:	e9 fc f5 ff ff       	jmp    801060e4 <alltraps>
...
80106ae8:	6a 00                	push   $0x0
  pushl $102
80106aea:	6a 66                	push   $0x66
  jmp alltraps
80106aec:	e9 f3 f5 ff ff       	jmp    801060e4 <alltraps>
...
80106af1:	6a 00                	push   $0x0
  pushl $103
80106af3:	6a 67                	push   $0x67
  jmp alltraps
80106af5:	e9 ea f5 ff ff       	jmp    801060e4 <alltraps>
...
80106afa:	6a 00                	push   $0x0
  pushl $104
80106afc:	6a 68                	push   $0x68
  jmp alltraps
80106afe:	e9 e1 f5 ff ff       	jmp    801060e4 <alltraps>
...
80106b03:	6a 00                	push   $0x0
  pushl $105
80106b05:	6a 69                	push   $0x69
  jmp alltraps
80106b07:	e9 d8 f5 ff ff       	jmp    801060e4 <alltraps>
...
80106b0c:	6a 00                	push   $0x0
  pushl $106
80106b0e:	6a 6a                	push   $0x6a
  jmp alltraps
80106b10:	e9 cf f5 ff ff       	jmp    801060e4 <alltraps>
...
80106b15:	6a 00                	push   $0x0
  pushl $107
80106b17:	6a 6b                	push   $0x6b
  jmp alltraps
80106b19:	e9 c6 f5 ff ff       	jmp    801060e4 <alltraps>
...
80106b1e:	6a 00                	push   $0x0
  pushl $108
80106b20:	6a 6c                	push   $0x6c
  jmp alltraps
80106b22:	e9 bd f5 ff ff       	jmp    801060e4 <alltraps>
...
80106b27:	6a 00                	push   $0x0
  pushl $109
80106b29:	6a 6d                	push   $0x6d
  jmp alltraps
80106b2b:	e9 b4 f5 ff ff       	jmp    801060e4 <alltraps>
...
80106b30:	6a 00                	push   $0x0
  pushl $110
80106b32:	6a 6e                	push   $0x6e
  jmp alltraps
80106b34:	e9 ab f5 ff ff       	jmp    801060e4 <alltraps>
...
80106b39:	6a 00                	push   $0x0
  pushl $111
80106b3b:	6a 6f                	push   $0x6f
  jmp alltraps
80106b3d:	e9 a2 f5 ff ff       	jmp    801060e4 <alltraps>
...
80106b42:	6a 00                	push   $0x0
  pushl $112
80106b44:	6a 70                	push   $0x70
  jmp alltraps
80106b46:	e9 99 f5 ff ff       	jmp    801060e4 <alltraps>
...
80106b4b:	6a 00                	push   $0x0
  pushl $113
80106b4d:	6a 71                	push   $0x71
  jmp alltraps
80106b4f:	e9 90 f5 ff ff       	jmp    801060e4 <alltraps>
...
80106b54:	6a 00                	push   $0x0
  pushl $114
80106b56:	6a 72                	push   $0x72
  jmp alltraps
80106b58:	e9 87 f5 ff ff       	jmp    801060e4 <alltraps>
...
80106b5d:	6a 00                	push   $0x0
  pushl $115
80106b5f:	6a 73                	push   $0x73
  jmp alltraps
80106b61:	e9 7e f5 ff ff       	jmp    801060e4 <alltraps>
...
80106b66:	6a 00                	push   $0x0
  pushl $116
80106b68:	6a 74                	push   $0x74
  jmp alltraps
80106b6a:	e9 75 f5 ff ff       	jmp    801060e4 <alltraps>
...
80106b6f:	6a 00                	push   $0x0
  pushl $117
80106b71:	6a 75                	push   $0x75
  jmp alltraps
80106b73:	e9 6c f5 ff ff       	jmp    801060e4 <alltraps>
...
80106b78:	6a 00                	push   $0x0
  pushl $118
80106b7a:	6a 76                	push   $0x76
  jmp alltraps
80106b7c:	e9 63 f5 ff ff       	jmp    801060e4 <alltraps>
...
80106b81:	6a 00                	push   $0x0
  pushl $119
80106b83:	6a 77                	push   $0x77
  jmp alltraps
80106b85:	e9 5a f5 ff ff       	jmp    801060e4 <alltraps>
...
80106b8a:	6a 00                	push   $0x0
  pushl $120
80106b8c:	6a 78                	push   $0x78
  jmp alltraps
80106b8e:	e9 51 f5 ff ff       	jmp    801060e4 <alltraps>
...
80106b93:	6a 00                	push   $0x0
  pushl $121
80106b95:	6a 79                	push   $0x79
  jmp alltraps
80106b97:	e9 48 f5 ff ff       	jmp    801060e4 <alltraps>
...
80106b9c:	6a 00                	push   $0x0
  pushl $122
80106b9e:	6a 7a                	push   $0x7a
  jmp alltraps
80106ba0:	e9 3f f5 ff ff       	jmp    801060e4 <alltraps>
...
80106ba5:	6a 00                	push   $0x0
  pushl $123
80106ba7:	6a 7b                	push   $0x7b
  jmp alltraps
80106ba9:	e9 36 f5 ff ff       	jmp    801060e4 <alltraps>
...
80106bae:	6a 00                	push   $0x0
  pushl $124
80106bb0:	6a 7c                	push   $0x7c
  jmp alltraps
80106bb2:	e9 2d f5 ff ff       	jmp    801060e4 <alltraps>
...
80106bb7:	6a 00                	push   $0x0
  pushl $125
80106bb9:	6a 7d                	push   $0x7d
  jmp alltraps
80106bbb:	e9 24 f5 ff ff       	jmp    801060e4 <alltraps>
...
80106bc0:	6a 00                	push   $0x0
  pushl $126
80106bc2:	6a 7e                	push   $0x7e
  jmp alltraps
80106bc4:	e9 1b f5 ff ff       	jmp    801060e4 <alltraps>
...
80106bc9:	6a 00                	push   $0x0
  pushl $127
80106bcb:	6a 7f                	push   $0x7f
  jmp alltraps
80106bcd:	e9 12 f5 ff ff       	jmp    801060e4 <alltraps>
...
80106bd4:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106bd9:	e9 06 f5 ff ff       	jmp    801060e4 <alltraps>
...
80106bde:	6a 00                	push   $0x0
  pushl $129
80106be0:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80106be5:	e9 fa f4 ff ff       	jmp    801060e4 <alltraps>
...
80106bea:	6a 00                	push   $0x0
  pushl $130
80106bec:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106bf1:	e9 ee f4 ff ff       	jmp    801060e4 <alltraps>
...
80106bf6:	6a 00                	push   $0x0
  pushl $131
80106bf8:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106bfd:	e9 e2 f4 ff ff       	jmp    801060e4 <alltraps>
...
80106c02:	6a 00                	push   $0x0
  pushl $132
80106c04:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106c09:	e9 d6 f4 ff ff       	jmp    801060e4 <alltraps>
...
80106c0e:	6a 00                	push   $0x0
  pushl $133
80106c10:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80106c15:	e9 ca f4 ff ff       	jmp    801060e4 <alltraps>
...
80106c1a:	6a 00                	push   $0x0
  pushl $134
80106c1c:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106c21:	e9 be f4 ff ff       	jmp    801060e4 <alltraps>
...
80106c26:	6a 00                	push   $0x0
  pushl $135
80106c28:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106c2d:	e9 b2 f4 ff ff       	jmp    801060e4 <alltraps>
...
80106c32:	6a 00                	push   $0x0
  pushl $136
80106c34:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80106c39:	e9 a6 f4 ff ff       	jmp    801060e4 <alltraps>
...
80106c3e:	6a 00                	push   $0x0
  pushl $137
80106c40:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80106c45:	e9 9a f4 ff ff       	jmp    801060e4 <alltraps>
...
80106c4a:	6a 00                	push   $0x0
  pushl $138
80106c4c:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106c51:	e9 8e f4 ff ff       	jmp    801060e4 <alltraps>
...
80106c56:	6a 00                	push   $0x0
  pushl $139
80106c58:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106c5d:	e9 82 f4 ff ff       	jmp    801060e4 <alltraps>
...
80106c62:	6a 00                	push   $0x0
  pushl $140
80106c64:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80106c69:	e9 76 f4 ff ff       	jmp    801060e4 <alltraps>
...
80106c6e:	6a 00                	push   $0x0
  pushl $141
80106c70:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80106c75:	e9 6a f4 ff ff       	jmp    801060e4 <alltraps>
...
80106c7a:	6a 00                	push   $0x0
  pushl $142
80106c7c:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106c81:	e9 5e f4 ff ff       	jmp    801060e4 <alltraps>
...
80106c86:	6a 00                	push   $0x0
  pushl $143
80106c88:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106c8d:	e9 52 f4 ff ff       	jmp    801060e4 <alltraps>
...
80106c92:	6a 00                	push   $0x0
  pushl $144
80106c94:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80106c99:	e9 46 f4 ff ff       	jmp    801060e4 <alltraps>
...
80106c9e:	6a 00                	push   $0x0
  pushl $145
80106ca0:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80106ca5:	e9 3a f4 ff ff       	jmp    801060e4 <alltraps>
...
80106caa:	6a 00                	push   $0x0
  pushl $146
80106cac:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106cb1:	e9 2e f4 ff ff       	jmp    801060e4 <alltraps>
...
80106cb6:	6a 00                	push   $0x0
  pushl $147
80106cb8:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106cbd:	e9 22 f4 ff ff       	jmp    801060e4 <alltraps>
...
80106cc2:	6a 00                	push   $0x0
  pushl $148
80106cc4:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80106cc9:	e9 16 f4 ff ff       	jmp    801060e4 <alltraps>
...
80106cce:	6a 00                	push   $0x0
  pushl $149
80106cd0:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80106cd5:	e9 0a f4 ff ff       	jmp    801060e4 <alltraps>
...
80106cda:	6a 00                	push   $0x0
  pushl $150
80106cdc:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106ce1:	e9 fe f3 ff ff       	jmp    801060e4 <alltraps>
...
80106ce6:	6a 00                	push   $0x0
  pushl $151
80106ce8:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106ced:	e9 f2 f3 ff ff       	jmp    801060e4 <alltraps>
...
80106cf2:	6a 00                	push   $0x0
  pushl $152
80106cf4:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80106cf9:	e9 e6 f3 ff ff       	jmp    801060e4 <alltraps>
...
80106cfe:	6a 00                	push   $0x0
  pushl $153
80106d00:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80106d05:	e9 da f3 ff ff       	jmp    801060e4 <alltraps>
...
80106d0a:	6a 00                	push   $0x0
  pushl $154
80106d0c:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106d11:	e9 ce f3 ff ff       	jmp    801060e4 <alltraps>
...
80106d16:	6a 00                	push   $0x0
  pushl $155
80106d18:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106d1d:	e9 c2 f3 ff ff       	jmp    801060e4 <alltraps>
...
80106d22:	6a 00                	push   $0x0
  pushl $156
80106d24:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80106d29:	e9 b6 f3 ff ff       	jmp    801060e4 <alltraps>
...
80106d2e:	6a 00                	push   $0x0
  pushl $157
80106d30:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80106d35:	e9 aa f3 ff ff       	jmp    801060e4 <alltraps>
...
80106d3a:	6a 00                	push   $0x0
  pushl $158
80106d3c:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106d41:	e9 9e f3 ff ff       	jmp    801060e4 <alltraps>
...
80106d46:	6a 00                	push   $0x0
  pushl $159
80106d48:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106d4d:	e9 92 f3 ff ff       	jmp    801060e4 <alltraps>
...
80106d52:	6a 00                	push   $0x0
  pushl $160
80106d54:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80106d59:	e9 86 f3 ff ff       	jmp    801060e4 <alltraps>
...
80106d5e:	6a 00                	push   $0x0
  pushl $161
80106d60:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80106d65:	e9 7a f3 ff ff       	jmp    801060e4 <alltraps>
...
80106d6a:	6a 00                	push   $0x0
  pushl $162
80106d6c:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106d71:	e9 6e f3 ff ff       	jmp    801060e4 <alltraps>
...
80106d76:	6a 00                	push   $0x0
  pushl $163
80106d78:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106d7d:	e9 62 f3 ff ff       	jmp    801060e4 <alltraps>
...
80106d82:	6a 00                	push   $0x0
  pushl $164
80106d84:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80106d89:	e9 56 f3 ff ff       	jmp    801060e4 <alltraps>
...
80106d8e:	6a 00                	push   $0x0
  pushl $165
80106d90:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80106d95:	e9 4a f3 ff ff       	jmp    801060e4 <alltraps>
...
80106d9a:	6a 00                	push   $0x0
  pushl $166
80106d9c:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106da1:	e9 3e f3 ff ff       	jmp    801060e4 <alltraps>
...
80106da6:	6a 00                	push   $0x0
  pushl $167
80106da8:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106dad:	e9 32 f3 ff ff       	jmp    801060e4 <alltraps>
...
80106db2:	6a 00                	push   $0x0
  pushl $168
80106db4:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80106db9:	e9 26 f3 ff ff       	jmp    801060e4 <alltraps>
...
80106dbe:	6a 00                	push   $0x0
  pushl $169
80106dc0:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80106dc5:	e9 1a f3 ff ff       	jmp    801060e4 <alltraps>
...
80106dca:	6a 00                	push   $0x0
  pushl $170
80106dcc:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106dd1:	e9 0e f3 ff ff       	jmp    801060e4 <alltraps>
...
80106dd6:	6a 00                	push   $0x0
  pushl $171
80106dd8:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106ddd:	e9 02 f3 ff ff       	jmp    801060e4 <alltraps>
...
80106de2:	6a 00                	push   $0x0
  pushl $172
80106de4:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80106de9:	e9 f6 f2 ff ff       	jmp    801060e4 <alltraps>
...
80106dee:	6a 00                	push   $0x0
  pushl $173
80106df0:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80106df5:	e9 ea f2 ff ff       	jmp    801060e4 <alltraps>
...
80106dfa:	6a 00                	push   $0x0
  pushl $174
80106dfc:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106e01:	e9 de f2 ff ff       	jmp    801060e4 <alltraps>
...
80106e06:	6a 00                	push   $0x0
  pushl $175
80106e08:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106e0d:	e9 d2 f2 ff ff       	jmp    801060e4 <alltraps>
...
80106e12:	6a 00                	push   $0x0
  pushl $176
80106e14:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80106e19:	e9 c6 f2 ff ff       	jmp    801060e4 <alltraps>
...
80106e1e:	6a 00                	push   $0x0
  pushl $177
80106e20:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80106e25:	e9 ba f2 ff ff       	jmp    801060e4 <alltraps>
...
80106e2a:	6a 00                	push   $0x0
  pushl $178
80106e2c:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106e31:	e9 ae f2 ff ff       	jmp    801060e4 <alltraps>
...
80106e36:	6a 00                	push   $0x0
  pushl $179
80106e38:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106e3d:	e9 a2 f2 ff ff       	jmp    801060e4 <alltraps>
...
80106e42:	6a 00                	push   $0x0
  pushl $180
80106e44:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80106e49:	e9 96 f2 ff ff       	jmp    801060e4 <alltraps>
...
80106e4e:	6a 00                	push   $0x0
  pushl $181
80106e50:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80106e55:	e9 8a f2 ff ff       	jmp    801060e4 <alltraps>
...
80106e5a:	6a 00                	push   $0x0
  pushl $182
80106e5c:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106e61:	e9 7e f2 ff ff       	jmp    801060e4 <alltraps>
...
80106e66:	6a 00                	push   $0x0
  pushl $183
80106e68:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106e6d:	e9 72 f2 ff ff       	jmp    801060e4 <alltraps>
...
80106e72:	6a 00                	push   $0x0
  pushl $184
80106e74:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80106e79:	e9 66 f2 ff ff       	jmp    801060e4 <alltraps>
...
80106e7e:	6a 00                	push   $0x0
  pushl $185
80106e80:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80106e85:	e9 5a f2 ff ff       	jmp    801060e4 <alltraps>
...
80106e8a:	6a 00                	push   $0x0
  pushl $186
80106e8c:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106e91:	e9 4e f2 ff ff       	jmp    801060e4 <alltraps>
...
80106e96:	6a 00                	push   $0x0
  pushl $187
80106e98:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106e9d:	e9 42 f2 ff ff       	jmp    801060e4 <alltraps>
...
80106ea2:	6a 00                	push   $0x0
  pushl $188
80106ea4:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80106ea9:	e9 36 f2 ff ff       	jmp    801060e4 <alltraps>
...
80106eae:	6a 00                	push   $0x0
  pushl $189
80106eb0:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80106eb5:	e9 2a f2 ff ff       	jmp    801060e4 <alltraps>
...
80106eba:	6a 00                	push   $0x0
  pushl $190
80106ebc:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106ec1:	e9 1e f2 ff ff       	jmp    801060e4 <alltraps>
...
80106ec6:	6a 00                	push   $0x0
  pushl $191
80106ec8:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106ecd:	e9 12 f2 ff ff       	jmp    801060e4 <alltraps>
...
80106ed2:	6a 00                	push   $0x0
  pushl $192
80106ed4:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80106ed9:	e9 06 f2 ff ff       	jmp    801060e4 <alltraps>
...
80106ede:	6a 00                	push   $0x0
  pushl $193
80106ee0:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106ee5:	e9 fa f1 ff ff       	jmp    801060e4 <alltraps>
...
80106eea:	6a 00                	push   $0x0
  pushl $194
80106eec:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106ef1:	e9 ee f1 ff ff       	jmp    801060e4 <alltraps>
...
80106ef6:	6a 00                	push   $0x0
  pushl $195
80106ef8:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106efd:	e9 e2 f1 ff ff       	jmp    801060e4 <alltraps>
...
80106f02:	6a 00                	push   $0x0
  pushl $196
80106f04:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80106f09:	e9 d6 f1 ff ff       	jmp    801060e4 <alltraps>
...
80106f0e:	6a 00                	push   $0x0
  pushl $197
80106f10:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106f15:	e9 ca f1 ff ff       	jmp    801060e4 <alltraps>
...
80106f1a:	6a 00                	push   $0x0
  pushl $198
80106f1c:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106f21:	e9 be f1 ff ff       	jmp    801060e4 <alltraps>
...
80106f26:	6a 00                	push   $0x0
  pushl $199
80106f28:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106f2d:	e9 b2 f1 ff ff       	jmp    801060e4 <alltraps>
...
80106f32:	6a 00                	push   $0x0
  pushl $200
80106f34:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80106f39:	e9 a6 f1 ff ff       	jmp    801060e4 <alltraps>
...
80106f3e:	6a 00                	push   $0x0
  pushl $201
80106f40:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106f45:	e9 9a f1 ff ff       	jmp    801060e4 <alltraps>
...
80106f4a:	6a 00                	push   $0x0
  pushl $202
80106f4c:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106f51:	e9 8e f1 ff ff       	jmp    801060e4 <alltraps>
...
80106f56:	6a 00                	push   $0x0
  pushl $203
80106f58:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106f5d:	e9 82 f1 ff ff       	jmp    801060e4 <alltraps>
...
80106f62:	6a 00                	push   $0x0
  pushl $204
80106f64:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80106f69:	e9 76 f1 ff ff       	jmp    801060e4 <alltraps>
...
80106f6e:	6a 00                	push   $0x0
  pushl $205
80106f70:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106f75:	e9 6a f1 ff ff       	jmp    801060e4 <alltraps>
...
80106f7a:	6a 00                	push   $0x0
  pushl $206
80106f7c:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106f81:	e9 5e f1 ff ff       	jmp    801060e4 <alltraps>
...
80106f86:	6a 00                	push   $0x0
  pushl $207
80106f88:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106f8d:	e9 52 f1 ff ff       	jmp    801060e4 <alltraps>
...
80106f92:	6a 00                	push   $0x0
  pushl $208
80106f94:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80106f99:	e9 46 f1 ff ff       	jmp    801060e4 <alltraps>
...
80106f9e:	6a 00                	push   $0x0
  pushl $209
80106fa0:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106fa5:	e9 3a f1 ff ff       	jmp    801060e4 <alltraps>
...
80106faa:	6a 00                	push   $0x0
  pushl $210
80106fac:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106fb1:	e9 2e f1 ff ff       	jmp    801060e4 <alltraps>
...
80106fb6:	6a 00                	push   $0x0
  pushl $211
80106fb8:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106fbd:	e9 22 f1 ff ff       	jmp    801060e4 <alltraps>
...
80106fc2:	6a 00                	push   $0x0
  pushl $212
80106fc4:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106fc9:	e9 16 f1 ff ff       	jmp    801060e4 <alltraps>
...
80106fce:	6a 00                	push   $0x0
  pushl $213
80106fd0:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106fd5:	e9 0a f1 ff ff       	jmp    801060e4 <alltraps>
...
80106fda:	6a 00                	push   $0x0
  pushl $214
80106fdc:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106fe1:	e9 fe f0 ff ff       	jmp    801060e4 <alltraps>
...
80106fe6:	6a 00                	push   $0x0
  pushl $215
80106fe8:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106fed:	e9 f2 f0 ff ff       	jmp    801060e4 <alltraps>
...
80106ff2:	6a 00                	push   $0x0
  pushl $216
80106ff4:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106ff9:	e9 e6 f0 ff ff       	jmp    801060e4 <alltraps>
...
80106ffe:	6a 00                	push   $0x0
  pushl $217
80107000:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80107005:	e9 da f0 ff ff       	jmp    801060e4 <alltraps>
...
8010700a:	6a 00                	push   $0x0
  pushl $218
8010700c:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80107011:	e9 ce f0 ff ff       	jmp    801060e4 <alltraps>
...
80107016:	6a 00                	push   $0x0
  pushl $219
80107018:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
8010701d:	e9 c2 f0 ff ff       	jmp    801060e4 <alltraps>
...
80107022:	6a 00                	push   $0x0
  pushl $220
80107024:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107029:	e9 b6 f0 ff ff       	jmp    801060e4 <alltraps>
...
8010702e:	6a 00                	push   $0x0
  pushl $221
80107030:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107035:	e9 aa f0 ff ff       	jmp    801060e4 <alltraps>
...
8010703a:	6a 00                	push   $0x0
  pushl $222
8010703c:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80107041:	e9 9e f0 ff ff       	jmp    801060e4 <alltraps>
...
80107046:	6a 00                	push   $0x0
  pushl $223
80107048:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
8010704d:	e9 92 f0 ff ff       	jmp    801060e4 <alltraps>
...
80107052:	6a 00                	push   $0x0
  pushl $224
80107054:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107059:	e9 86 f0 ff ff       	jmp    801060e4 <alltraps>
...
8010705e:	6a 00                	push   $0x0
  pushl $225
80107060:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80107065:	e9 7a f0 ff ff       	jmp    801060e4 <alltraps>
...
8010706a:	6a 00                	push   $0x0
  pushl $226
8010706c:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80107071:	e9 6e f0 ff ff       	jmp    801060e4 <alltraps>
...
80107076:	6a 00                	push   $0x0
  pushl $227
80107078:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
8010707d:	e9 62 f0 ff ff       	jmp    801060e4 <alltraps>
...
80107082:	6a 00                	push   $0x0
  pushl $228
80107084:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107089:	e9 56 f0 ff ff       	jmp    801060e4 <alltraps>
...
8010708e:	6a 00                	push   $0x0
  pushl $229
80107090:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80107095:	e9 4a f0 ff ff       	jmp    801060e4 <alltraps>
...
8010709a:	6a 00                	push   $0x0
  pushl $230
8010709c:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801070a1:	e9 3e f0 ff ff       	jmp    801060e4 <alltraps>
...
801070a6:	6a 00                	push   $0x0
  pushl $231
801070a8:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801070ad:	e9 32 f0 ff ff       	jmp    801060e4 <alltraps>
...
801070b2:	6a 00                	push   $0x0
  pushl $232
801070b4:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801070b9:	e9 26 f0 ff ff       	jmp    801060e4 <alltraps>
...
801070be:	6a 00                	push   $0x0
  pushl $233
801070c0:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801070c5:	e9 1a f0 ff ff       	jmp    801060e4 <alltraps>
...
801070ca:	6a 00                	push   $0x0
  pushl $234
801070cc:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801070d1:	e9 0e f0 ff ff       	jmp    801060e4 <alltraps>
...
801070d6:	6a 00                	push   $0x0
  pushl $235
801070d8:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801070dd:	e9 02 f0 ff ff       	jmp    801060e4 <alltraps>
...
801070e2:	6a 00                	push   $0x0
  pushl $236
801070e4:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801070e9:	e9 f6 ef ff ff       	jmp    801060e4 <alltraps>
...
801070ee:	6a 00                	push   $0x0
  pushl $237
801070f0:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801070f5:	e9 ea ef ff ff       	jmp    801060e4 <alltraps>
...
801070fa:	6a 00                	push   $0x0
  pushl $238
801070fc:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80107101:	e9 de ef ff ff       	jmp    801060e4 <alltraps>
...
80107106:	6a 00                	push   $0x0
  pushl $239
80107108:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
8010710d:	e9 d2 ef ff ff       	jmp    801060e4 <alltraps>
...
80107112:	6a 00                	push   $0x0
  pushl $240
80107114:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107119:	e9 c6 ef ff ff       	jmp    801060e4 <alltraps>
...
8010711e:	6a 00                	push   $0x0
  pushl $241
80107120:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107125:	e9 ba ef ff ff       	jmp    801060e4 <alltraps>
...
8010712a:	6a 00                	push   $0x0
  pushl $242
8010712c:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107131:	e9 ae ef ff ff       	jmp    801060e4 <alltraps>
...
80107136:	6a 00                	push   $0x0
  pushl $243
80107138:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
8010713d:	e9 a2 ef ff ff       	jmp    801060e4 <alltraps>
...
80107142:	6a 00                	push   $0x0
  pushl $244
80107144:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107149:	e9 96 ef ff ff       	jmp    801060e4 <alltraps>
...
8010714e:	6a 00                	push   $0x0
  pushl $245
80107150:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80107155:	e9 8a ef ff ff       	jmp    801060e4 <alltraps>
...
8010715a:	6a 00                	push   $0x0
  pushl $246
8010715c:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80107161:	e9 7e ef ff ff       	jmp    801060e4 <alltraps>
...
80107166:	6a 00                	push   $0x0
  pushl $247
80107168:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
8010716d:	e9 72 ef ff ff       	jmp    801060e4 <alltraps>
...
80107172:	6a 00                	push   $0x0
  pushl $248
80107174:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107179:	e9 66 ef ff ff       	jmp    801060e4 <alltraps>
...
8010717e:	6a 00                	push   $0x0
  pushl $249
80107180:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80107185:	e9 5a ef ff ff       	jmp    801060e4 <alltraps>
...
8010718a:	6a 00                	push   $0x0
  pushl $250
8010718c:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107191:	e9 4e ef ff ff       	jmp    801060e4 <alltraps>
...
80107196:	6a 00                	push   $0x0
  pushl $251
80107198:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
8010719d:	e9 42 ef ff ff       	jmp    801060e4 <alltraps>
...
801071a2:	6a 00                	push   $0x0
  pushl $252
801071a4:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801071a9:	e9 36 ef ff ff       	jmp    801060e4 <alltraps>
...
801071ae:	6a 00                	push   $0x0
  pushl $253
801071b0:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801071b5:	e9 2a ef ff ff       	jmp    801060e4 <alltraps>
...
801071ba:	6a 00                	push   $0x0
  pushl $254
801071bc:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801071c1:	e9 1e ef ff ff       	jmp    801060e4 <alltraps>
...
801071c6:	6a 00                	push   $0x0
  pushl $255
801071c8:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801071cd:	e9 12 ef ff ff       	jmp    801060e4 <alltraps>
	...
...
801071d7:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
801071da:	8b 45 0c             	mov    0xc(%ebp),%eax
801071dd:	83 e8 01             	sub    $0x1,%eax
801071e0:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801071e4:	8b 45 08             	mov    0x8(%ebp),%eax
801071e7:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
801071eb:	8b 45 08             	mov    0x8(%ebp),%eax
801071ee:	c1 e8 10             	shr    $0x10,%eax
801071f1:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
801071f5:	8d 45 fa             	lea    -0x6(%ebp),%eax
801071f8:	0f 01 10             	lgdtl  (%eax)
}
801071fb:	c9                   	leave  
801071fc:	c3                   	ret    
...
80107206:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
8010720a:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
8010720e:	0f 00 d8             	ltr    %ax
}
80107211:	c9                   	leave  
80107212:	c3                   	ret    
...
80107239:	2d 00 00 00 80       	sub    $0x80000000,%eax
8010723e:	5d                   	pop    %ebp
8010723f:	c3                   	ret    
...
80107246:	2d 00 00 00 80       	sub    $0x80000000,%eax
8010724b:	5d                   	pop    %ebp
8010724c:	c3                   	ret    
...
80107250:	53                   	push   %ebx
80107251:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
80107254:	e8 1f bc ff ff       	call   80102e78 <cpunum>
80107259:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
8010725f:	05 20 f9 10 80       	add    $0x8010f920,%eax
80107264:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80107267:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010726a:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
80107270:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107273:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
80107279:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010727c:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
80107280:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107283:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107287:	83 e2 f0             	and    $0xfffffff0,%edx
8010728a:	83 ca 0a             	or     $0xa,%edx
8010728d:	88 50 7d             	mov    %dl,0x7d(%eax)
80107290:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107293:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107297:	83 ca 10             	or     $0x10,%edx
8010729a:	88 50 7d             	mov    %dl,0x7d(%eax)
8010729d:	8b 45 f4             	mov    -0xc(%ebp),%eax
801072a0:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
801072a4:	83 e2 9f             	and    $0xffffff9f,%edx
801072a7:	88 50 7d             	mov    %dl,0x7d(%eax)
801072aa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801072ad:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
801072b1:	83 ca 80             	or     $0xffffff80,%edx
801072b4:	88 50 7d             	mov    %dl,0x7d(%eax)
801072b7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801072ba:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
801072be:	83 ca 0f             	or     $0xf,%edx
801072c1:	88 50 7e             	mov    %dl,0x7e(%eax)
801072c4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801072c7:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
801072cb:	83 e2 ef             	and    $0xffffffef,%edx
801072ce:	88 50 7e             	mov    %dl,0x7e(%eax)
801072d1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801072d4:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
801072d8:	83 e2 df             	and    $0xffffffdf,%edx
801072db:	88 50 7e             	mov    %dl,0x7e(%eax)
801072de:	8b 45 f4             	mov    -0xc(%ebp),%eax
801072e1:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
801072e5:	83 ca 40             	or     $0x40,%edx
801072e8:	88 50 7e             	mov    %dl,0x7e(%eax)
801072eb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801072ee:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
801072f2:	83 ca 80             	or     $0xffffff80,%edx
801072f5:	88 50 7e             	mov    %dl,0x7e(%eax)
801072f8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801072fb:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801072ff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107302:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
80107309:	ff ff 
8010730b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010730e:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
80107315:	00 00 
80107317:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010731a:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
80107321:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107324:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
8010732b:	83 e2 f0             	and    $0xfffffff0,%edx
8010732e:	83 ca 02             	or     $0x2,%edx
80107331:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107337:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010733a:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107341:	83 ca 10             	or     $0x10,%edx
80107344:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
8010734a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010734d:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107354:	83 e2 9f             	and    $0xffffff9f,%edx
80107357:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
8010735d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107360:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107367:	83 ca 80             	or     $0xffffff80,%edx
8010736a:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107370:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107373:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
8010737a:	83 ca 0f             	or     $0xf,%edx
8010737d:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107383:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107386:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
8010738d:	83 e2 ef             	and    $0xffffffef,%edx
80107390:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107396:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107399:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
801073a0:	83 e2 df             	and    $0xffffffdf,%edx
801073a3:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
801073a9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801073ac:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
801073b3:	83 ca 40             	or     $0x40,%edx
801073b6:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
801073bc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801073bf:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
801073c6:	83 ca 80             	or     $0xffffff80,%edx
801073c9:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
801073cf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801073d2:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801073d9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801073dc:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
801073e3:	ff ff 
801073e5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801073e8:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
801073ef:	00 00 
801073f1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801073f4:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
801073fb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801073fe:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107405:	83 e2 f0             	and    $0xfffffff0,%edx
80107408:	83 ca 0a             	or     $0xa,%edx
8010740b:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107411:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107414:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
8010741b:	83 ca 10             	or     $0x10,%edx
8010741e:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107424:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107427:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
8010742e:	83 ca 60             	or     $0x60,%edx
80107431:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107437:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010743a:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107441:	83 ca 80             	or     $0xffffff80,%edx
80107444:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
8010744a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010744d:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107454:	83 ca 0f             	or     $0xf,%edx
80107457:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
8010745d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107460:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107467:	83 e2 ef             	and    $0xffffffef,%edx
8010746a:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107470:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107473:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
8010747a:	83 e2 df             	and    $0xffffffdf,%edx
8010747d:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107483:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107486:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
8010748d:	83 ca 40             	or     $0x40,%edx
80107490:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107496:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107499:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
801074a0:	83 ca 80             	or     $0xffffff80,%edx
801074a3:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
801074a9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801074ac:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801074b3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801074b6:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
801074bd:	ff ff 
801074bf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801074c2:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
801074c9:	00 00 
801074cb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801074ce:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
801074d5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801074d8:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
801074df:	83 e2 f0             	and    $0xfffffff0,%edx
801074e2:	83 ca 02             	or     $0x2,%edx
801074e5:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
801074eb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801074ee:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
801074f5:	83 ca 10             	or     $0x10,%edx
801074f8:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
801074fe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107501:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107508:	83 ca 60             	or     $0x60,%edx
8010750b:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107511:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107514:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
8010751b:	83 ca 80             	or     $0xffffff80,%edx
8010751e:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107524:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107527:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
8010752e:	83 ca 0f             	or     $0xf,%edx
80107531:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107537:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010753a:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107541:	83 e2 ef             	and    $0xffffffef,%edx
80107544:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
8010754a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010754d:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107554:	83 e2 df             	and    $0xffffffdf,%edx
80107557:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
8010755d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107560:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107567:	83 ca 40             	or     $0x40,%edx
8010756a:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107570:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107573:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
8010757a:	83 ca 80             	or     $0xffffff80,%edx
8010757d:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107583:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107586:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
8010758d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107590:	05 b4 00 00 00       	add    $0xb4,%eax
80107595:	89 c3                	mov    %eax,%ebx
80107597:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010759a:	05 b4 00 00 00       	add    $0xb4,%eax
8010759f:	c1 e8 10             	shr    $0x10,%eax
801075a2:	89 c1                	mov    %eax,%ecx
801075a4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075a7:	05 b4 00 00 00       	add    $0xb4,%eax
801075ac:	c1 e8 18             	shr    $0x18,%eax
801075af:	89 c2                	mov    %eax,%edx
801075b1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075b4:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
801075bb:	00 00 
801075bd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075c0:	66 89 98 8a 00 00 00 	mov    %bx,0x8a(%eax)
801075c7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075ca:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
801075d0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075d3:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
801075da:	83 e1 f0             	and    $0xfffffff0,%ecx
801075dd:	83 c9 02             	or     $0x2,%ecx
801075e0:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
801075e6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075e9:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
801075f0:	83 c9 10             	or     $0x10,%ecx
801075f3:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
801075f9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075fc:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107603:	83 e1 9f             	and    $0xffffff9f,%ecx
80107606:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
8010760c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010760f:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107616:	83 c9 80             	or     $0xffffff80,%ecx
80107619:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
8010761f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107622:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107629:	83 e1 f0             	and    $0xfffffff0,%ecx
8010762c:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107632:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107635:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
8010763c:	83 e1 ef             	and    $0xffffffef,%ecx
8010763f:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107645:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107648:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
8010764f:	83 e1 df             	and    $0xffffffdf,%ecx
80107652:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107658:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010765b:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107662:	83 c9 40             	or     $0x40,%ecx
80107665:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010766b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010766e:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107675:	83 c9 80             	or     $0xffffff80,%ecx
80107678:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010767e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107681:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
80107687:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010768a:	83 c0 70             	add    $0x70,%eax
8010768d:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
80107694:	00 
80107695:	89 04 24             	mov    %eax,(%esp)
80107698:	e8 37 fb ff ff       	call   801071d4 <lgdt>
  loadgs(SEG_KCPU << 3);
8010769d:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
801076a4:	e8 6a fb ff ff       	call   80107213 <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
801076a9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076ac:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
801076b2:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
801076b9:	00 00 00 00 
}
801076bd:	83 c4 24             	add    $0x24,%esp
801076c0:	5b                   	pop    %ebx
801076c1:	5d                   	pop    %ebp
801076c2:	c3                   	ret    
...
801076c6:	83 ec 28             	sub    $0x28,%esp
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
801076c9:	8b 45 0c             	mov    0xc(%ebp),%eax
801076cc:	c1 e8 16             	shr    $0x16,%eax
801076cf:	c1 e0 02             	shl    $0x2,%eax
801076d2:	03 45 08             	add    0x8(%ebp),%eax
801076d5:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(*pde & PTE_P){
801076d8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801076db:	8b 00                	mov    (%eax),%eax
801076dd:	83 e0 01             	and    $0x1,%eax
801076e0:	84 c0                	test   %al,%al
801076e2:	74 17                	je     801076fb <walkpgdir+0x38>
    pgtab = (pte_t*)p2v(PTE_ADDR(*pde));
801076e4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801076e7:	8b 00                	mov    (%eax),%eax
801076e9:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801076ee:	89 04 24             	mov    %eax,(%esp)
801076f1:	e8 4a fb ff ff       	call   80107240 <p2v>
801076f6:	89 45 f4             	mov    %eax,-0xc(%ebp)
801076f9:	eb 4b                	jmp    80107746 <walkpgdir+0x83>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
801076fb:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801076ff:	74 0e                	je     8010770f <walkpgdir+0x4c>
80107701:	e8 f8 b3 ff ff       	call   80102afe <kalloc>
80107706:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107709:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010770d:	75 07                	jne    80107716 <walkpgdir+0x53>
      return 0;
8010770f:	b8 00 00 00 00       	mov    $0x0,%eax
80107714:	eb 41                	jmp    80107757 <walkpgdir+0x94>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
80107716:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010771d:	00 
8010771e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107725:	00 
80107726:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107729:	89 04 24             	mov    %eax,(%esp)
8010772c:	e8 cd d5 ff ff       	call   80104cfe <memset>
...
80107737:	e8 f7 fa ff ff       	call   80107233 <v2p>
8010773c:	89 c2                	mov    %eax,%edx
8010773e:	83 ca 07             	or     $0x7,%edx
80107741:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107744:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
80107746:	8b 45 0c             	mov    0xc(%ebp),%eax
80107749:	c1 e8 0c             	shr    $0xc,%eax
8010774c:	25 ff 03 00 00       	and    $0x3ff,%eax
80107751:	c1 e0 02             	shl    $0x2,%eax
80107754:	03 45 f4             	add    -0xc(%ebp),%eax
}
80107757:	c9                   	leave  
80107758:	c3                   	ret    
...
80107767:	89 45 ec             	mov    %eax,-0x14(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
8010776a:	8b 45 0c             	mov    0xc(%ebp),%eax
8010776d:	03 45 10             	add    0x10(%ebp),%eax
80107770:	83 e8 01             	sub    $0x1,%eax
80107773:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107778:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
8010777b:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80107782:	00 
80107783:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107786:	89 44 24 04          	mov    %eax,0x4(%esp)
8010778a:	8b 45 08             	mov    0x8(%ebp),%eax
8010778d:	89 04 24             	mov    %eax,(%esp)
80107790:	e8 2e ff ff ff       	call   801076c3 <walkpgdir>
80107795:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107798:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010779c:	75 07                	jne    801077a5 <mappages+0x4c>
      return -1;
8010779e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801077a3:	eb 46                	jmp    801077eb <mappages+0x92>
    if(*pte & PTE_P)
801077a5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077a8:	8b 00                	mov    (%eax),%eax
801077aa:	83 e0 01             	and    $0x1,%eax
801077ad:	84 c0                	test   %al,%al
801077af:	74 0c                	je     801077bd <mappages+0x64>
      panic("remap");
801077b1:	c7 04 24 d4 85 10 80 	movl   $0x801085d4,(%esp)
801077b8:	e8 7d 8d ff ff       	call   8010053a <panic>
    *pte = pa | perm | PTE_P;
801077bd:	8b 45 18             	mov    0x18(%ebp),%eax
801077c0:	0b 45 14             	or     0x14(%ebp),%eax
801077c3:	89 c2                	mov    %eax,%edx
801077c5:	83 ca 01             	or     $0x1,%edx
801077c8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077cb:	89 10                	mov    %edx,(%eax)
    if(a == last)
801077cd:	8b 45 ec             	mov    -0x14(%ebp),%eax
801077d0:	3b 45 f0             	cmp    -0x10(%ebp),%eax
801077d3:	74 10                	je     801077e5 <mappages+0x8c>
      break;
    a += PGSIZE;
801077d5:	81 45 ec 00 10 00 00 	addl   $0x1000,-0x14(%ebp)
    pa += PGSIZE;
801077dc:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
801077e3:	eb 96                	jmp    8010777b <mappages+0x22>
      return -1;
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
...
801077e5:	90                   	nop
  ...
  return 0;
801077e6:	b8 00 00 00 00       	mov    $0x0,%eax
}
801077eb:	c9                   	leave  
801077ec:	c3                   	ret    
...
801077f1:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
801077f4:	e8 05 b3 ff ff       	call   80102afe <kalloc>
801077f9:	89 45 f0             	mov    %eax,-0x10(%ebp)
801077fc:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107800:	75 0a                	jne    8010780c <setupkvm+0x1f>
    return 0;
80107802:	b8 00 00 00 00       	mov    $0x0,%eax
80107807:	e9 99 00 00 00       	jmp    801078a5 <setupkvm+0xb8>
  memset(pgdir, 0, PGSIZE);
8010780c:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107813:	00 
80107814:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010781b:	00 
8010781c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010781f:	89 04 24             	mov    %eax,(%esp)
80107822:	e8 d7 d4 ff ff       	call   80104cfe <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
80107827:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
8010782e:	e8 0d fa ff ff       	call   80107240 <p2v>
80107833:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
80107838:	76 0c                	jbe    80107846 <setupkvm+0x59>
    panic("PHYSTOP too high");
8010783a:	c7 04 24 da 85 10 80 	movl   $0x801085da,(%esp)
80107841:	e8 f4 8c ff ff       	call   8010053a <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107846:	c7 45 f4 a0 b4 10 80 	movl   $0x8010b4a0,-0xc(%ebp)
8010784d:	eb 49                	jmp    80107898 <setupkvm+0xab>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
8010784f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107852:	8b 48 0c             	mov    0xc(%eax),%ecx
80107855:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107858:	8b 50 04             	mov    0x4(%eax),%edx
8010785b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010785e:	8b 58 08             	mov    0x8(%eax),%ebx
80107861:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107864:	8b 40 04             	mov    0x4(%eax),%eax
80107867:	29 c3                	sub    %eax,%ebx
80107869:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010786c:	8b 00                	mov    (%eax),%eax
8010786e:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80107872:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107876:	89 5c 24 08          	mov    %ebx,0x8(%esp)
8010787a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010787e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107881:	89 04 24             	mov    %eax,(%esp)
80107884:	e8 d0 fe ff ff       	call   80107759 <mappages>
80107889:	85 c0                	test   %eax,%eax
8010788b:	79 07                	jns    80107894 <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
8010788d:	b8 00 00 00 00       	mov    $0x0,%eax
80107892:	eb 11                	jmp    801078a5 <setupkvm+0xb8>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107894:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80107898:	b8 e0 b4 10 80       	mov    $0x8010b4e0,%eax
8010789d:	39 45 f4             	cmp    %eax,-0xc(%ebp)
801078a0:	72 ad                	jb     8010784f <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
801078a5:	83 c4 34             	add    $0x34,%esp
801078a8:	5b                   	pop    %ebx
801078a9:	5d                   	pop    %ebp
801078aa:	c3                   	ret    
...
801078ae:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
801078b1:	e8 37 ff ff ff       	call   801077ed <setupkvm>
801078b6:	a3 f8 26 11 80       	mov    %eax,0x801126f8
  switchkvm();
801078bb:	e8 02 00 00 00       	call   801078c2 <switchkvm>
}
801078c0:	c9                   	leave  
801078c1:	c3                   	ret    
...
801078c5:	83 ec 04             	sub    $0x4,%esp
  lcr3(v2p(kpgdir));   // switch to the kernel page table
801078c8:	a1 f8 26 11 80       	mov    0x801126f8,%eax
801078cd:	89 04 24             	mov    %eax,(%esp)
801078d0:	e8 5e f9 ff ff       	call   80107233 <v2p>
801078d5:	89 04 24             	mov    %eax,(%esp)
801078d8:	e8 4b f9 ff ff       	call   80107228 <lcr3>
}
801078dd:	c9                   	leave  
801078de:	c3                   	ret    
...
801078e3:	83 ec 14             	sub    $0x14,%esp
  pushcli();
801078e6:	e8 0d d3 ff ff       	call   80104bf8 <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
801078eb:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801078f1:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801078f8:	83 c2 08             	add    $0x8,%edx
801078fb:	89 d3                	mov    %edx,%ebx
801078fd:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107904:	83 c2 08             	add    $0x8,%edx
80107907:	c1 ea 10             	shr    $0x10,%edx
8010790a:	89 d1                	mov    %edx,%ecx
8010790c:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107913:	83 c2 08             	add    $0x8,%edx
80107916:	c1 ea 18             	shr    $0x18,%edx
80107919:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
80107920:	67 00 
80107922:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
80107929:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
8010792f:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107936:	83 e1 f0             	and    $0xfffffff0,%ecx
80107939:	83 c9 09             	or     $0x9,%ecx
8010793c:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107942:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107949:	83 c9 10             	or     $0x10,%ecx
8010794c:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107952:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107959:	83 e1 9f             	and    $0xffffff9f,%ecx
8010795c:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107962:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107969:	83 c9 80             	or     $0xffffff80,%ecx
8010796c:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107972:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107979:	83 e1 f0             	and    $0xfffffff0,%ecx
8010797c:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107982:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107989:	83 e1 ef             	and    $0xffffffef,%ecx
8010798c:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107992:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107999:	83 e1 df             	and    $0xffffffdf,%ecx
8010799c:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801079a2:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801079a9:	83 c9 40             	or     $0x40,%ecx
801079ac:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801079b2:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801079b9:	83 e1 7f             	and    $0x7f,%ecx
801079bc:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801079c2:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
801079c8:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801079ce:	0f b6 90 a5 00 00 00 	movzbl 0xa5(%eax),%edx
801079d5:	83 e2 ef             	and    $0xffffffef,%edx
801079d8:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
801079de:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801079e4:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
801079ea:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801079f0:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
801079f7:	8b 52 08             	mov    0x8(%edx),%edx
801079fa:	81 c2 00 10 00 00    	add    $0x1000,%edx
80107a00:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
80107a03:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
80107a0a:	e8 ee f7 ff ff       	call   801071fd <ltr>
  if(p->pgdir == 0)
80107a0f:	8b 45 08             	mov    0x8(%ebp),%eax
80107a12:	8b 40 04             	mov    0x4(%eax),%eax
80107a15:	85 c0                	test   %eax,%eax
80107a17:	75 0c                	jne    80107a25 <switchuvm+0x146>
    panic("switchuvm: no pgdir");
80107a19:	c7 04 24 eb 85 10 80 	movl   $0x801085eb,(%esp)
80107a20:	e8 15 8b ff ff       	call   8010053a <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
80107a25:	8b 45 08             	mov    0x8(%ebp),%eax
80107a28:	8b 40 04             	mov    0x4(%eax),%eax
80107a2b:	89 04 24             	mov    %eax,(%esp)
80107a2e:	e8 00 f8 ff ff       	call   80107233 <v2p>
80107a33:	89 04 24             	mov    %eax,(%esp)
80107a36:	e8 ed f7 ff ff       	call   80107228 <lcr3>
  popcli();
80107a3b:	e8 00 d2 ff ff       	call   80104c40 <popcli>
}
80107a40:	83 c4 14             	add    $0x14,%esp
80107a43:	5b                   	pop    %ebx
80107a44:	5d                   	pop    %ebp
80107a45:	c3                   	ret    
...
80107a49:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
80107a4c:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
80107a53:	76 0c                	jbe    80107a61 <inituvm+0x1b>
    panic("inituvm: more than a page");
80107a55:	c7 04 24 ff 85 10 80 	movl   $0x801085ff,(%esp)
80107a5c:	e8 d9 8a ff ff       	call   8010053a <panic>
  mem = kalloc();
80107a61:	e8 98 b0 ff ff       	call   80102afe <kalloc>
80107a66:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(mem, 0, PGSIZE);
80107a69:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107a70:	00 
80107a71:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107a78:	00 
80107a79:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a7c:	89 04 24             	mov    %eax,(%esp)
80107a7f:	e8 7a d2 ff ff       	call   80104cfe <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
80107a84:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a87:	89 04 24             	mov    %eax,(%esp)
80107a8a:	e8 a4 f7 ff ff       	call   80107233 <v2p>
80107a8f:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80107a96:	00 
80107a97:	89 44 24 0c          	mov    %eax,0xc(%esp)
80107a9b:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107aa2:	00 
80107aa3:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107aaa:	00 
80107aab:	8b 45 08             	mov    0x8(%ebp),%eax
80107aae:	89 04 24             	mov    %eax,(%esp)
80107ab1:	e8 a3 fc ff ff       	call   80107759 <mappages>
  memmove(mem, init, sz);
80107ab6:	8b 45 10             	mov    0x10(%ebp),%eax
80107ab9:	89 44 24 08          	mov    %eax,0x8(%esp)
80107abd:	8b 45 0c             	mov    0xc(%ebp),%eax
80107ac0:	89 44 24 04          	mov    %eax,0x4(%esp)
80107ac4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ac7:	89 04 24             	mov    %eax,(%esp)
80107aca:	e8 02 d3 ff ff       	call   80104dd1 <memmove>
}
80107acf:	c9                   	leave  
80107ad0:	c3                   	ret    
...
80107ad5:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
80107ad8:	8b 45 0c             	mov    0xc(%ebp),%eax
80107adb:	25 ff 0f 00 00       	and    $0xfff,%eax
80107ae0:	85 c0                	test   %eax,%eax
80107ae2:	74 0c                	je     80107af0 <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
80107ae4:	c7 04 24 1c 86 10 80 	movl   $0x8010861c,(%esp)
80107aeb:	e8 4a 8a ff ff       	call   8010053a <panic>
  for(i = 0; i < sz; i += PGSIZE){
80107af0:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
80107af7:	e9 ae 00 00 00       	jmp    80107baa <loaduvm+0xd9>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80107afc:	8b 45 e8             	mov    -0x18(%ebp),%eax
80107aff:	8b 55 0c             	mov    0xc(%ebp),%edx
80107b02:	8d 04 02             	lea    (%edx,%eax,1),%eax
80107b05:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80107b0c:	00 
80107b0d:	89 44 24 04          	mov    %eax,0x4(%esp)
80107b11:	8b 45 08             	mov    0x8(%ebp),%eax
80107b14:	89 04 24             	mov    %eax,(%esp)
80107b17:	e8 a7 fb ff ff       	call   801076c3 <walkpgdir>
80107b1c:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107b1f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80107b23:	75 0c                	jne    80107b31 <loaduvm+0x60>
      panic("loaduvm: address should exist");
80107b25:	c7 04 24 3f 86 10 80 	movl   $0x8010863f,(%esp)
80107b2c:	e8 09 8a ff ff       	call   8010053a <panic>
    pa = PTE_ADDR(*pte);
80107b31:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b34:	8b 00                	mov    (%eax),%eax
80107b36:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107b3b:	89 45 ec             	mov    %eax,-0x14(%ebp)
    if(sz - i < PGSIZE)
80107b3e:	8b 45 e8             	mov    -0x18(%ebp),%eax
80107b41:	8b 55 18             	mov    0x18(%ebp),%edx
80107b44:	89 d1                	mov    %edx,%ecx
80107b46:	29 c1                	sub    %eax,%ecx
80107b48:	89 c8                	mov    %ecx,%eax
80107b4a:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80107b4f:	77 11                	ja     80107b62 <loaduvm+0x91>
      n = sz - i;
80107b51:	8b 45 e8             	mov    -0x18(%ebp),%eax
80107b54:	8b 55 18             	mov    0x18(%ebp),%edx
80107b57:	89 d1                	mov    %edx,%ecx
80107b59:	29 c1                	sub    %eax,%ecx
80107b5b:	89 c8                	mov    %ecx,%eax
80107b5d:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107b60:	eb 07                	jmp    80107b69 <loaduvm+0x98>
    else
      n = PGSIZE;
80107b62:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
80107b69:	8b 45 e8             	mov    -0x18(%ebp),%eax
80107b6c:	8b 55 14             	mov    0x14(%ebp),%edx
80107b6f:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
80107b72:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107b75:	89 04 24             	mov    %eax,(%esp)
80107b78:	e8 c3 f6 ff ff       	call   80107240 <p2v>
80107b7d:	8b 55 f0             	mov    -0x10(%ebp),%edx
80107b80:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107b84:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80107b88:	89 44 24 04          	mov    %eax,0x4(%esp)
80107b8c:	8b 45 10             	mov    0x10(%ebp),%eax
80107b8f:	89 04 24             	mov    %eax,(%esp)
80107b92:	e8 d1 a1 ff ff       	call   80101d68 <readi>
80107b97:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80107b9a:	74 07                	je     80107ba3 <loaduvm+0xd2>
      return -1;
80107b9c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107ba1:	eb 18                	jmp    80107bbb <loaduvm+0xea>
  uint i, pa, n;
  pte_t *pte;
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
80107ba3:	81 45 e8 00 10 00 00 	addl   $0x1000,-0x18(%ebp)
80107baa:	8b 45 e8             	mov    -0x18(%ebp),%eax
80107bad:	3b 45 18             	cmp    0x18(%ebp),%eax
80107bb0:	0f 82 46 ff ff ff    	jb     80107afc <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
  ...
  return 0;
80107bb6:	b8 00 00 00 00       	mov    $0x0,%eax
}
80107bbb:	83 c4 24             	add    $0x24,%esp
80107bbe:	5b                   	pop    %ebx
80107bbf:	5d                   	pop    %ebp
80107bc0:	c3                   	ret    
...
80107bc4:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
80107bcc:	79 0a                	jns    80107bd8 <allocuvm+0x17>
    return 0;
80107bce:	b8 00 00 00 00       	mov    $0x0,%eax
80107bd3:	e9 c1 00 00 00       	jmp    80107c99 <allocuvm+0xd8>
  if(newsz < oldsz)
80107bd8:	8b 45 10             	mov    0x10(%ebp),%eax
80107bdb:	3b 45 0c             	cmp    0xc(%ebp),%eax
80107bde:	73 08                	jae    80107be8 <allocuvm+0x27>
    return oldsz;
80107be0:	8b 45 0c             	mov    0xc(%ebp),%eax
80107be3:	e9 b1 00 00 00       	jmp    80107c99 <allocuvm+0xd8>

  a = PGROUNDUP(oldsz);
80107be8:	8b 45 0c             	mov    0xc(%ebp),%eax
80107beb:	05 ff 0f 00 00       	add    $0xfff,%eax
80107bf0:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107bf5:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
80107bf8:	e9 8d 00 00 00       	jmp    80107c8a <allocuvm+0xc9>
    mem = kalloc();
80107bfd:	e8 fc ae ff ff       	call   80102afe <kalloc>
80107c02:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80107c05:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107c09:	75 2c                	jne    80107c37 <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
80107c0b:	c7 04 24 5d 86 10 80 	movl   $0x8010865d,(%esp)
80107c12:	e8 83 87 ff ff       	call   8010039a <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80107c17:	8b 45 0c             	mov    0xc(%ebp),%eax
80107c1a:	89 44 24 08          	mov    %eax,0x8(%esp)
80107c1e:	8b 45 10             	mov    0x10(%ebp),%eax
80107c21:	89 44 24 04          	mov    %eax,0x4(%esp)
80107c25:	8b 45 08             	mov    0x8(%ebp),%eax
80107c28:	89 04 24             	mov    %eax,(%esp)
80107c2b:	e8 6b 00 00 00       	call   80107c9b <deallocuvm>
      return 0;
80107c30:	b8 00 00 00 00       	mov    $0x0,%eax
80107c35:	eb 62                	jmp    80107c99 <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
80107c37:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107c3e:	00 
80107c3f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107c46:	00 
80107c47:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107c4a:	89 04 24             	mov    %eax,(%esp)
80107c4d:	e8 ac d0 ff ff       	call   80104cfe <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
80107c52:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107c55:	89 04 24             	mov    %eax,(%esp)
80107c58:	e8 d6 f5 ff ff       	call   80107233 <v2p>
80107c5d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80107c60:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80107c67:	00 
80107c68:	89 44 24 0c          	mov    %eax,0xc(%esp)
80107c6c:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107c73:	00 
80107c74:	89 54 24 04          	mov    %edx,0x4(%esp)
80107c78:	8b 45 08             	mov    0x8(%ebp),%eax
80107c7b:	89 04 24             	mov    %eax,(%esp)
80107c7e:	e8 d6 fa ff ff       	call   80107759 <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
...
80107c8d:	3b 45 10             	cmp    0x10(%ebp),%eax
80107c90:	0f 82 67 ff ff ff    	jb     80107bfd <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
  ...
  return newsz;
80107c96:	8b 45 10             	mov    0x10(%ebp),%eax
}
80107c99:	c9                   	leave  
80107c9a:	c3                   	ret    
...
80107ca4:	3b 45 0c             	cmp    0xc(%ebp),%eax
80107ca7:	72 08                	jb     80107cb1 <deallocuvm+0x16>
    return oldsz;
80107ca9:	8b 45 0c             	mov    0xc(%ebp),%eax
80107cac:	e9 a4 00 00 00       	jmp    80107d55 <deallocuvm+0xba>

  a = PGROUNDUP(newsz);
80107cb1:	8b 45 10             	mov    0x10(%ebp),%eax
80107cb4:	05 ff 0f 00 00       	add    $0xfff,%eax
80107cb9:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107cbe:	89 45 ec             	mov    %eax,-0x14(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80107cc1:	e9 80 00 00 00       	jmp    80107d46 <deallocuvm+0xab>
    pte = walkpgdir(pgdir, (char*)a, 0);
80107cc6:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107cc9:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80107cd0:	00 
80107cd1:	89 44 24 04          	mov    %eax,0x4(%esp)
80107cd5:	8b 45 08             	mov    0x8(%ebp),%eax
80107cd8:	89 04 24             	mov    %eax,(%esp)
80107cdb:	e8 e3 f9 ff ff       	call   801076c3 <walkpgdir>
80107ce0:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(!pte)
80107ce3:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
80107ce7:	75 09                	jne    80107cf2 <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
80107ce9:	81 45 ec 00 f0 3f 00 	addl   $0x3ff000,-0x14(%ebp)
80107cf0:	eb 4d                	jmp    80107d3f <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
80107cf2:	8b 45 e8             	mov    -0x18(%ebp),%eax
80107cf5:	8b 00                	mov    (%eax),%eax
80107cf7:	83 e0 01             	and    $0x1,%eax
80107cfa:	84 c0                	test   %al,%al
80107cfc:	74 41                	je     80107d3f <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
...
80107d0f:	75 0c                	jne    80107d1d <deallocuvm+0x82>
        panic("kfree");
80107d11:	c7 04 24 75 86 10 80 	movl   $0x80108675,(%esp)
80107d18:	e8 1d 88 ff ff       	call   8010053a <panic>
      char *v = p2v(pa);
80107d1d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107d20:	89 04 24             	mov    %eax,(%esp)
80107d23:	e8 18 f5 ff ff       	call   80107240 <p2v>
80107d28:	89 45 f4             	mov    %eax,-0xc(%ebp)
      kfree(v);
80107d2b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d2e:	89 04 24             	mov    %eax,(%esp)
80107d31:	e8 2f ad ff ff       	call   80102a65 <kfree>
      *pte = 0;
80107d36:	8b 45 e8             	mov    -0x18(%ebp),%eax
80107d39:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
80107d3f:	81 45 ec 00 10 00 00 	addl   $0x1000,-0x14(%ebp)
80107d46:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107d49:	3b 45 0c             	cmp    0xc(%ebp),%eax
80107d4c:	0f 82 74 ff ff ff    	jb     80107cc6 <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
...
80107d5a:	83 ec 28             	sub    $0x28,%esp
  ...
  if(pgdir == 0)
80107d5d:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80107d61:	75 0c                	jne    80107d6f <freevm+0x18>
    panic("freevm: no pgdir");
80107d63:	c7 04 24 7b 86 10 80 	movl   $0x8010867b,(%esp)
80107d6a:	e8 cb 87 ff ff       	call   8010053a <panic>
  deallocuvm(pgdir, KERNBASE, 0);
80107d6f:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80107d76:	00 
80107d77:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
80107d7e:	80 
80107d7f:	8b 45 08             	mov    0x8(%ebp),%eax
80107d82:	89 04 24             	mov    %eax,(%esp)
80107d85:	e8 11 ff ff ff       	call   80107c9b <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
80107d8a:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
80107d91:	eb 3c                	jmp    80107dcf <freevm+0x78>
    if(pgdir[i] & PTE_P){
80107d93:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107d96:	c1 e0 02             	shl    $0x2,%eax
80107d99:	03 45 08             	add    0x8(%ebp),%eax
80107d9c:	8b 00                	mov    (%eax),%eax
80107d9e:	83 e0 01             	and    $0x1,%eax
80107da1:	84 c0                	test   %al,%al
80107da3:	74 26                	je     80107dcb <freevm+0x74>
      char * v = p2v(PTE_ADDR(pgdir[i]));
80107da5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107da8:	c1 e0 02             	shl    $0x2,%eax
80107dab:	03 45 08             	add    0x8(%ebp),%eax
80107dae:	8b 00                	mov    (%eax),%eax
80107db0:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107db5:	89 04 24             	mov    %eax,(%esp)
80107db8:	e8 83 f4 ff ff       	call   80107240 <p2v>
80107dbd:	89 45 f4             	mov    %eax,-0xc(%ebp)
      kfree(v);
80107dc0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dc3:	89 04 24             	mov    %eax,(%esp)
80107dc6:	e8 9a ac ff ff       	call   80102a65 <kfree>
  uint i;
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80107dcb:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
80107dcf:	81 7d f0 ff 03 00 00 	cmpl   $0x3ff,-0x10(%ebp)
80107dd6:	76 bb                	jbe    80107d93 <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
80107dde:	e8 82 ac ff ff       	call   80102a65 <kfree>
}
80107de3:	c9                   	leave  
80107de4:	c3                   	ret    
...
80107de8:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
80107deb:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80107df2:	00 
...
80107e00:	e8 be f8 ff ff       	call   801076c3 <walkpgdir>
80107e05:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
80107e08:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80107e0c:	75 0c                	jne    80107e1a <clearpteu+0x35>
    panic("clearpteu");
80107e0e:	c7 04 24 8c 86 10 80 	movl   $0x8010868c,(%esp)
80107e15:	e8 20 87 ff ff       	call   8010053a <panic>
  *pte &= ~PTE_U;
80107e1a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e1d:	8b 00                	mov    (%eax),%eax
80107e1f:	89 c2                	mov    %eax,%edx
80107e21:	83 e2 fb             	and    $0xfffffffb,%edx
80107e24:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e27:	89 10                	mov    %edx,(%eax)
}
80107e29:	c9                   	leave  
80107e2a:	c3                   	ret    
...
80107e2f:	83 ec 44             	sub    $0x44,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80107e32:	e8 b6 f9 ff ff       	call   801077ed <setupkvm>
80107e37:	89 45 e0             	mov    %eax,-0x20(%ebp)
80107e3a:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80107e3e:	75 0a                	jne    80107e4a <copyuvm+0x1f>
    return 0;
80107e40:	b8 00 00 00 00       	mov    $0x0,%eax
80107e45:	e9 fd 00 00 00       	jmp    80107f47 <copyuvm+0x11c>
  for(i = 0; i < sz; i += PGSIZE){
80107e4a:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
80107e51:	e9 cc 00 00 00       	jmp    80107f22 <copyuvm+0xf7>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80107e56:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107e59:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80107e60:	00 
80107e61:	89 44 24 04          	mov    %eax,0x4(%esp)
80107e65:	8b 45 08             	mov    0x8(%ebp),%eax
80107e68:	89 04 24             	mov    %eax,(%esp)
80107e6b:	e8 53 f8 ff ff       	call   801076c3 <walkpgdir>
80107e70:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80107e73:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
80107e77:	75 0c                	jne    80107e85 <copyuvm+0x5a>
      panic("copyuvm: pte should exist");
80107e79:	c7 04 24 96 86 10 80 	movl   $0x80108696,(%esp)
80107e80:	e8 b5 86 ff ff       	call   8010053a <panic>
    if(!(*pte & PTE_P))
80107e85:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80107e88:	8b 00                	mov    (%eax),%eax
80107e8a:	83 e0 01             	and    $0x1,%eax
80107e8d:	85 c0                	test   %eax,%eax
80107e8f:	75 0c                	jne    80107e9d <copyuvm+0x72>
      panic("copyuvm: page not present");
80107e91:	c7 04 24 b0 86 10 80 	movl   $0x801086b0,(%esp)
80107e98:	e8 9d 86 ff ff       	call   8010053a <panic>
    pa = PTE_ADDR(*pte);
80107e9d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
...
80107eaf:	25 ff 0f 00 00       	and    $0xfff,%eax
80107eb4:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if((mem = kalloc()) == 0)
80107eb7:	e8 42 ac ff ff       	call   80102afe <kalloc>
80107ebc:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107ebf:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80107ec3:	74 6e                	je     80107f33 <copyuvm+0x108>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
80107ec5:	8b 45 e8             	mov    -0x18(%ebp),%eax
80107ec8:	89 04 24             	mov    %eax,(%esp)
80107ecb:	e8 70 f3 ff ff       	call   80107240 <p2v>
80107ed0:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107ed7:	00 
80107ed8:	89 44 24 04          	mov    %eax,0x4(%esp)
80107edc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107edf:	89 04 24             	mov    %eax,(%esp)
80107ee2:	e8 ea ce ff ff       	call   80104dd1 <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
80107ee7:	8b 5d f0             	mov    -0x10(%ebp),%ebx
80107eea:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107eed:	89 04 24             	mov    %eax,(%esp)
80107ef0:	e8 3e f3 ff ff       	call   80107233 <v2p>
80107ef5:	8b 55 ec             	mov    -0x14(%ebp),%edx
80107ef8:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80107efc:	89 44 24 0c          	mov    %eax,0xc(%esp)
80107f00:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107f07:	00 
80107f08:	89 54 24 04          	mov    %edx,0x4(%esp)
80107f0c:	8b 45 e0             	mov    -0x20(%ebp),%eax
80107f0f:	89 04 24             	mov    %eax,(%esp)
80107f12:	e8 42 f8 ff ff       	call   80107759 <mappages>
80107f17:	85 c0                	test   %eax,%eax
80107f19:	78 1b                	js     80107f36 <copyuvm+0x10b>
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80107f1b:	81 45 ec 00 10 00 00 	addl   $0x1000,-0x14(%ebp)
80107f22:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107f25:	3b 45 0c             	cmp    0xc(%ebp),%eax
80107f28:	0f 82 28 ff ff ff    	jb     80107e56 <copyuvm+0x2b>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
  ...
  return d;
80107f2e:	8b 45 e0             	mov    -0x20(%ebp),%eax
80107f31:	eb 14                	jmp    80107f47 <copyuvm+0x11c>
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
      goto bad;
80107f33:	90                   	nop
80107f34:	eb 01                	jmp    80107f37 <copyuvm+0x10c>
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
80107f36:	90                   	nop
...
bad:
  freevm(d);
80107f37:	8b 45 e0             	mov    -0x20(%ebp),%eax
80107f3a:	89 04 24             	mov    %eax,(%esp)
80107f3d:	e8 15 fe ff ff       	call   80107d57 <freevm>
  return 0;
80107f42:	b8 00 00 00 00       	mov    $0x0,%eax
}
80107f47:	83 c4 44             	add    $0x44,%esp
80107f4a:	5b                   	pop    %ebx
80107f4b:	5d                   	pop    %ebp
80107f4c:	c3                   	ret    
...
80107f50:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
...
80107f68:	e8 56 f7 ff ff       	call   801076c3 <walkpgdir>
...
80107f7a:	75 07                	jne    80107f83 <uva2ka+0x36>
    return 0;
80107f7c:	b8 00 00 00 00       	mov    $0x0,%eax
80107f81:	eb 25                	jmp    80107fa8 <uva2ka+0x5b>
  if((*pte & PTE_U) == 0)
80107f83:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f86:	8b 00                	mov    (%eax),%eax
80107f88:	83 e0 04             	and    $0x4,%eax
80107f8b:	85 c0                	test   %eax,%eax
80107f8d:	75 07                	jne    80107f96 <uva2ka+0x49>
    return 0;
80107f8f:	b8 00 00 00 00       	mov    $0x0,%eax
80107f94:	eb 12                	jmp    80107fa8 <uva2ka+0x5b>
...
80107fa3:	e8 98 f2 ff ff       	call   80107240 <p2v>
}
80107fa8:	c9                   	leave  
80107fa9:	c3                   	ret    
...
80107fb3:	89 45 e8             	mov    %eax,-0x18(%ebp)
  while(len > 0){
80107fb6:	e9 8b 00 00 00       	jmp    80108046 <copyout+0x9c>
    va0 = (uint)PGROUNDDOWN(va);
80107fbb:	8b 45 0c             	mov    0xc(%ebp),%eax
80107fbe:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107fc3:	89 45 f4             	mov    %eax,-0xc(%ebp)
    pa0 = uva2ka(pgdir, (char*)va0);
80107fc6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fc9:	89 44 24 04          	mov    %eax,0x4(%esp)
80107fcd:	8b 45 08             	mov    0x8(%ebp),%eax
80107fd0:	89 04 24             	mov    %eax,(%esp)
80107fd3:	e8 75 ff ff ff       	call   80107f4d <uva2ka>
80107fd8:	89 45 ec             	mov    %eax,-0x14(%ebp)
    if(pa0 == 0)
80107fdb:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107fdf:	75 07                	jne    80107fe8 <copyout+0x3e>
      return -1;
80107fe1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107fe6:	eb 6d                	jmp    80108055 <copyout+0xab>
    n = PGSIZE - (va - va0);
80107fe8:	8b 45 0c             	mov    0xc(%ebp),%eax
80107feb:	8b 55 f4             	mov    -0xc(%ebp),%edx
80107fee:	89 d1                	mov    %edx,%ecx
80107ff0:	29 c1                	sub    %eax,%ecx
80107ff2:	89 c8                	mov    %ecx,%eax
...
80108002:	76 06                	jbe    8010800a <copyout+0x60>
      n = len;
80108004:	8b 45 14             	mov    0x14(%ebp),%eax
80108007:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
8010800a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010800d:	8b 55 0c             	mov    0xc(%ebp),%edx
80108010:	89 d1                	mov    %edx,%ecx
80108012:	29 c1                	sub    %eax,%ecx
80108014:	89 c8                	mov    %ecx,%eax
80108016:	03 45 ec             	add    -0x14(%ebp),%eax
80108019:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010801c:	89 54 24 08          	mov    %edx,0x8(%esp)
80108020:	8b 55 e8             	mov    -0x18(%ebp),%edx
80108023:	89 54 24 04          	mov    %edx,0x4(%esp)
80108027:	89 04 24             	mov    %eax,(%esp)
8010802a:	e8 a2 cd ff ff       	call   80104dd1 <memmove>
    len -= n;
8010802f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108032:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
80108035:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108038:	01 45 e8             	add    %eax,-0x18(%ebp)
    va = va0 + PGSIZE;
8010803b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010803e:	05 00 10 00 00       	add    $0x1000,%eax
80108043:	89 45 0c             	mov    %eax,0xc(%ebp)
{
  char *buf, *pa0;
  uint n, va0;
  ...
  buf = (char*)p;
  while(len > 0){
80108046:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
8010804a:	0f 85 6b ff ff ff    	jne    80107fbb <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
